...
Route::middleware(['freshInstall'])->group(function () {
  ...
  Route::middleware('auth', 'valid.user')->group(function () {
    ...
    Route::prefix('sadmin')->middleware('role:super_admin|sales')->group(function () {
      ...
      Route::get('redirect-links/sales-report', [RedirectLinkController::class, 'salesReport'])->name('redirect-links.sales-report');
    ...
    Route::prefix('sadmin')->middleware('role:super_admin|admin|sales')->group(function () {
      ...
      Route::post('/ai_settings', [SettingController::class, 'aiSettingUpdate'])->name('ai.setting.update')->withoutMiddleware('xss');
