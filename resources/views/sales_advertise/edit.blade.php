  ...
  <div class="container-fluid">
    <div class="d-flex flex-column">
      <div class="col-12">
        ...
        <div class="card">
          <div class="card-body">
            <form action="{{ route('sadmin.sales.advertise.update', $salesUser->id) }}" method="POST"
              enctype="multipart/form-data" id="advertiseForm">
              @csrf
              @method('PUT')
              ...
              <div id="advertiseFields" style="{{ ($setting->is_enabled ?? false) ? '' : 'display:none;' }}">
                ...
                <div class="mb-4">
                  ...
                  <select name="duration" id="duration" class="form-select w-auto">
                    @for($i = 1; $i <= 5; $i++)
                      <option value="{{ $i }}" {{ ($setting->duration ?? 3) == $i ? 'selected' : '' }}>
