...
<head>
  ...
  <style>
    /* App3: ensure page scrollbar is on viewport edge and header doesn't create its own scroll */
    body.app3-layout {
      padding-top: 5rem; /* account for nav height (h-20 = 5rem) */
      overflow-x: hidden;
    }
...
<body class="bg-gradient-to-br from-primary-50/50 to-secondary-50/50 min-h-screen app3-layout">
  <!-- Navigation -->
