  ...
  <div class="row" id="media-assets">
    ...
    <div class="col-lg-12 mb-7">
      <div class="mb-3">
        ...
        <span data-bs-toggle="tooltip" data-placement="top" data-bs-original-title="{{ __('messages.tooltip.cover_selection') }}">
        ...
        <div id="predefinedImages" class="mb-4" style="{{ isset($whatsappStore) && !empty($whatsappStore->cover_url) && str_contains($whatsappStore->cover_url, 'cover_images') ? '' : 'display: none;' }}">
          ...
          <input type="hidden" name="selected_cover_image" id="selectedCoverImage" value="{{ isset($whatsappStore) && !empty($whatsappStore->cover_url) && str_contains($whatsappStore->cover_url, 'cover_images') ? $whatsappStore->cover_url : '' }}">
        </div>
        ...
        <div id="customUpload" style="{{ isset($whatsappStore) && !empty($whatsappStore->cover_url) && !str_contains($whatsappStore->cover_url, 'cover_images') ? '' : 'display: none;' }}">
          <div class="d-block">
            <div class="images-picker" style="width: 100%; max-width: 600px;">
              <div class="image previewImage" id="coverPreview" style="background-image: url('{{ !empty($whatsappStore->cover_url) ? $whatsappStore->cover_url : '' }}'); width: 100%; height: 200px; background-size: contain; background-position: center;">
              </div>
              <span class="picker-edit rounded-circle text-gray-500 fs-small" data-bs-toggle="tooltip" data-placement="top" data-bs-original-title="{{ __('messages.tooltip.cover') }}">
                <label>
                  ...
                  <input type="file" id="coverImg" name="cover_img" class="d-none" accept="image/*" data-preview-id="whatsappStoreCoverPreview" />
                </label>
              </span>
            </div>
    ...
    <div class="col-lg-8 mb-7">
      ...
      <span data-bs-toggle="tooltip" data-placement="top" data-bs-original-title="{{ __('messages.whatsapp_stores.enter_youtube_video_link') }}">
        <i class="fas fa-question-circle ml-1 general-question-mark"></i>
      </span>
    ...
    <div class="d-flex">
      {{ Form::submit(__('messages.common.save'), ['class' => 'btn btn-primary me-3', 'id' => 'whatsappStoreSaveBtn']) }}
...
<div id="floatingSaveBar" class="floating-save-bar d-none">
  <div class="d-flex align-items-center gap-3">
    ...
    <button type="button" class="btn btn-light btn-sm fw-bold" onclick="$(&#39;#whatsappStoreSaveBtn&#39;).trigger(&#39;click&#39;)">{{ __('messages.common.save') }}</button>
  </div>
</div>
