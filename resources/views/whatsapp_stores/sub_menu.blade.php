  ...
  <div class="setting-tab mb-sm-7 mb-5">
    <ul class="nav nav-tabs-1 flex-nowrap text-nowrap flex-sm-column d-sm-flex d-block">
      <div class="d-sm-flex flex-sm-column overflow-auto">
        ...
        <li class="nav-item nav-item-1 position-relative">
          @if (isset($whatsappStore))
            <a class="nav-link-1 nav-link p-3 {{ isset($partName) && $partName == 'media-assets' ? 'active' : '' }}"
              href="{{ route('whatsapp.stores.edit', ['whatsappStore' => $whatsappStore->id, 'part' => 'media-assets']) }}">
              <i class="fa-solid fa-images me-2 icon-color-bs-purple"></i>
              {{ __('messages.images') }}
            </a>
          @else
