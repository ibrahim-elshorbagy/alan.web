        ...
        <form id="editProductCategoryForm">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="name"
              placeholder="{{ __('messages.whatsapp_stores.category_placeholder') }}" id="editProductCategoryName"
              required>
          </div>
          <div class="mb-3 mt-5" io-image-input="true">
            <label for="editProductCategoryPreview"
            ...
            <div class="d-block">
              ...
              <div data-image-paste data-input-id="image" data-preview-id="editProductCategoryPreview"
