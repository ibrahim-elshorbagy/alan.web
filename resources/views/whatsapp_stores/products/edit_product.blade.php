          ...
          <div class="row">
            ...
            <div class="col-md-6 mt-5">
              <div class="form-group">
                ...
                <select name="category_id" class="form-control wpStoreCategory" required data-control="select2"
                  data-dropdown-parent="#editWpStoreProductModal">
            ...
            <div class="col-md-6 mt-5">
              <div class="form-group">
                ...
                <select name="currency_id" class="form-control wpStoreCategory" required data-control="select2"
                  data-dropdown-parent="#editWpStoreProductModal">
            ...
            <div class="col-md-6 mt-5">
              <div class="form-group">
                ...
                <input type="number" class="form-control product-total-stock" name="total_stock"
                  id="editProductTotalStock" placeholder="{{ __('messages.whatsapp_stores.enter_total_stock') }}"
                  required>
              </div>
            </div>
            <div class="col-md-6 mt-5">
            ...
            <div class="col-md-12 mt-5">
              <div class="form-group">
                ...
                <div class="d-flex align-items-center mb-2">
                  <a href="javascript:void(0)" id="generateAiWpProductDescriptionBtnEdit"
                    ...
                    <div class="image-picker">
                      ...
                      <span class="picker-edit rounded-circle text-gray-500 fs-small" data-bs-toggle="tooltip"
                        ...
                        <label>
                          ...
                          <input type="file" id="editProductIcon" name="images[]" class="image-upload d-none"
