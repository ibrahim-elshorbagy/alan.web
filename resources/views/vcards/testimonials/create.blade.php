        ...
        <div class="row">
          ...
          <div class="col-sm-12 mb-5">
            ...
            <div class="mb-3" io-image-input="true">
              <label for="testimonialPreview" class="form-label required">{{ __('messages.vcard.image') . ':' }}</label>
              ...
              <div class="d-block">
                ...
                <div data-image-paste data-file-input-id="testimonialImg" data-preview-id="testimonialPreview"
