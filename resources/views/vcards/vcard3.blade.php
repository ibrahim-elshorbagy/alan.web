  ...
  <div class="container">
    <div class="vcard-three main-content w-100 mx-auto overflow-hidden">
      ...
      <div class="vcard-three__profile-details py-3 px-3">
        ...
        <div class="mt-5">
          <span class="profile-description"> I am a heart surgeon. I have 10 year experience in surgery,I am a heart
            surgeon. I have 10 year experience in surgery,I am a heart surgeon. I have 10 year experience in surgery,I
            am a heart surgeon. I have 10 year experience in surgery,I am a heart surgeon. I have 10 year experience in
            ...
            <div class="col-sm-6 col-12">
              <div class="card event-card p-2 h-100 border-0 flex-sm-row flex-column align-items-center">
                ...
                <div class="event-detail ms-sm-3 mt-sm-0 mt-4">
                  ...
                  <h5 class="event-name text-center mb-0 text-white">sly.watson@gmail.com</h5>
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-12">
      ...
      <div class="vcard-three__contact py-4 position-relative">
        <img src="{{ asset('assets/img/vcard3/vcard3-shape3.png') }}" alt="shape"
          class="position-absolute start-0 bottom-0" loading="lazy" />
        <div class="container">
