        ...
        <div class="row">
          ...
          <div class="col-sm-12 mb-5">
            ...
            <div class="mb-3" io-image-input="true">
              <label for="blogImgId" class="form-label">{{ __('messages.vcard.blog_icon') . ':' }}</label>
              <div class="d-block">
                <div class="image-picker">
                  ...
                  <span class="picker-edit rounded-circle text-gray-500 fs-small" data-bs-toggle="tooltip"
                    ...
                    <label>
                      ...
                      <input type="file" id="editBlogIcon" name="blog_icon" class="image-upload d-none"
                        accept="image/*" data-preview-id="editBlogPreview" /> </label>
                  </span>
                </div>
                <!-- Image Paste Component -->
                <div data-image-paste data-file-input-id="editBlogIcon" data-preview-id="editBlogPreview"
