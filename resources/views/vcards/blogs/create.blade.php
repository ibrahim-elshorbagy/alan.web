                ...
                <div class="image-picker">
                  ...
                  <span class="picker-edit rounded-circle text-gray-500 fs-small" data-bs-toggle="tooltip"
                    ...
                    <label>
                      ...
                      <input type="file" id="blogIcon" name="blog_icon" class="image-upload d-none" accept="image/*"
                        data-preview-id="createBlogPreview" /> </label>
                  </span>
                </div>
                <!-- Image Paste Component -->
                <div data-image-paste data-file-input-id="blogIcon" data-preview-id="blogPreview"
