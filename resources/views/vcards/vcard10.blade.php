      ...
      <div class="vcard-ten__profile position-relative shadow mx-sm-5 mx-4 ">
        <div class=" d-flex flex-sm-row flex-column justify-content-center align-items-center">
          ...
          <div class="mx-4 mt-sm-0 mt-3">
            ...
            <span class="profile-designation text-center d-block">a freelancer UI/UX Designer</span>
          </div>

        </div>
        <div class="d-flex align-items-center mb-5">
          <span class="pt-5 profile-description"> I am a heart surgeon. I have 10 year experience in surgery,I am a
            ...
            <div class="col-sm-6 col-12">
              <div class="card event-card p-3 h-100 border-0 flex-sm-row flex-column align-items-center shadow">
                ...
                <div class="event-detail ms-sm-3 mt-sm-0 mt-4">
                  ...
                  <h5 class="event-name text-center mb-0">watson@gmail.com</h5>
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-12">
              <div class="card event-card p-3 h-100 border-0 flex-sm-row flex-column align-items-center shadow">
                ...
                <div class="event-detail ms-sm-3 mt-sm-0 mt-4">
                  ...
                  <h5 class="event-name text-center mb-0">+91 95864 12484</h5>
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-12">
              <div class="card event-card p-3 h-100 border-0 flex-sm-row flex-column align-items-center shadow">
                ...
                <div class="event-detail ms-sm-3 mt-sm-0 mt-4">
                  ...
                  <h5 class="event-name text-center mb-0">4 December 1998</h5>
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-12">
