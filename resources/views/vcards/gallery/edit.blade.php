        ...
        <div class="row">
          ...
          <div class="col-sm-12">
            ...
            {{ Form::select('type', \App\Models\Gallery::TYPE, \App\Models\Gallery::TYPE_IMAGE, [
                ...
                'data-dropdown-parent' => '#editGalleryModal',
                'id' => 'editTypeId',
            ]) }}
          </div>
                ...
                <div class="image-picker">
                  ...
                  <span class="picker-edit rounded-circle text-gray-500 fs-small" data-bs-toggle="tooltip"
                    ...
                    <label>
                      ...
                      <input type="file" id="editImage" name="image" class="image-upload d-none" accept="image/*"
                        data-preview-id="editGalleryPreview" /> </label>
                  </span>
                </div>
                <!-- Image Paste Component -->
                <div data-image-paste data-file-input-id="editImage" data-preview-id="editGalleryPreview"
          ...
          <div class="form-group mt-2 d-flex flex-wrap">
            <div class="mt-2 user__upload-btn w-auto me-sm-4 me-2">
              <label class="btn btn-primary">
                ...
                <input id="editGalleryUploadFile" class="d-none" accept=".xlsx, .xls, .csv, .pdf"
                  name="gallery_upload_file" type="file">
              </label>
            </div>
        ...
        <div class="col-lg-12 mb-7 d-none video_upload_button">
          <div class="form-group mt-2 d-flex flex-wrap">
            <div class="mt-2 user__upload-btn w-auto me-sm-4 me-2">
              <label class="btn btn-primary">
                {{ __('messages.common.upload_file') }}
                <input id="editVideoUploadFile" class="d-none"
                  accept=".mpeg, .ogg, .mp4, .webm, .3gp, .mov, .flv, .avi, .wmv, .ts" name="video_file" type="file">
              </label>
            </div>
        ...
        <div class="col-lg-12 mb-7 d-none audio_upload_button">
          <div class="form-group mt-2 d-flex flex-wrap">
            <div class="mt-2 user__upload-btn w-auto me-sm-4 me-2">
              <label class="btn btn-primary">
                {{ __('messages.common.upload_file') }}
                <input id="editAudioUploadFile" class="d-none"
                  accept=".pcm, .wav, .aiff, .mp3, .aac, .ogg, .wma, .m4a, .flac, .alac" name="audio_file"
                  type="file">
              </label>
            </div>
