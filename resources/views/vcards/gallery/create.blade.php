        ...
        <div class="row">
          ...
          <div class="col-sm-12">
            ...
            {{ Form::select('type', $gallriesType, null, [
                ...
                'required',
                'data-dropdown-parent' => '#addGalleryModal',
                ...
                <div class="image-picker">
                  ...
                  <span class="picker-edit rounded-circle text-gray-500 fs-small" data-bs-toggle="tooltip"
                    ...
                    <label>
                      ...
                      <input type="file" id="addImage" name="image" class="image-upload d-none" accept="image/*"
                        data-preview-id="createGalleryPreview" /> </label>
                  </span>
                </div>
                <!-- Image Paste Component -->
                <div data-image-paste data-file-input-id="addImage" data-preview-id="addGalleryPreview"
          ...
          <div class="form-group mt-2 d-flex flex-wrap">
            <div class="mt-2 user__upload-btn w-auto me-sm-4 me-2">
              <label class="btn btn-primary">
                ...
                <input id="galleryUploadFile" class="d-none" accept=".xlsx, .xls, .csv, .pdf" name="gallery_upload_file"
                  type="file">
              </label>
            </div>
        ...
        <div class="col-lg-12 mb-7 d-none video_upload_button">
          <div class="form-group mt-2 d-flex flex-wrap">
            <div class="mt-2 user__upload-btn w-auto me-sm-4 me-2">
              <label class="btn btn-primary">
                {{ __('messages.common.upload_file') }}
                <input id="videoUploadFile" class="d-none"
        ...
        <div class="col-lg-12 mb-7 d-none audio_upload_button">
          <div class="form-group mt-2 d-flex flex-wrap">
            <div class="mt-2 user__upload-btn w-auto me-sm-4 me-2">
              <label class="btn btn-primary">
                {{ __('messages.common.upload_file') }}
                <input id="audioUploadFile" class="d-none"
