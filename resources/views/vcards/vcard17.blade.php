      ...
      <div class="profile-section px-30">
        ...
        <div class="card align-items-center mb-3 pb-3">
          <div class="card-img d-flex justify-content-center align-items-center">
            <img src="{{ asset('assets/img/vcard17/profile-img.png') }}" class="img-fluid h-100 object-fit-cover"
              loading="lazy" />
          </div>
            ...
            <div class="col-sm-6 mb-sm-5 mb-40 px-3">
              <div class="contact-box mb-sm-2">
                ...
                <div class="contact-desc">
                  ...
                  <a href="mailto:jackie@gmail.com" class="text-primary fs-14 fw-5">jackie@gmail.com</a>
                </div>
              </div>
            </div>
            <div class="col-sm-6 mb-sm-5 mb-40 px-3">
            ...
            <div class="mb-20">
              <div class="row">
                ...
                <div class="col-md-3 col-sm-6 mb-2 ps-sm-1">
                  <div
                    class="hour-input d-flex justify-content-center align-items-center"style="background-color: #f3fbff;">
                    <span class="text-primary fw-5">8:10 - 20:00</span>
                  </div>
                </div>
                <div class="col-md-3 col-sm-6 mb-2 pe-sm-1">
              ...
              <div class="service-card d-flex flex-row">
                <div class="card-img d-flex justify-content-center align-items-center me-sm-4 me-3">
                  <svg xmlns="http://www.w3.org/2000/svg" width="36" height="28" viewBox="0 0 36 28"
                    ...
                    <defs>
                      <linearGradient id="paint0_linear_37_155" x1="0" y1="8.49225" x2="18.5061"
                        y2="38.712" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#F6A932"></stop>
                        <stop offset="1" stop-color="#FF5A0E"></stop>
                      </linearGradient>
                      <linearGradient id="paint1_linear_37_155" x1="-0.00109673" y1="0.000305176" x2="2.61256"
                        y2="13.0586" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#F6A932"></stop>
                        <stop offset="1" stop-color="#FF5A0E"></stop>
                      </linearGradient>
                      <linearGradient id="paint2_linear_37_155" x1="20.8636" y1="19.9855" x2="22.1777"
              ...
              <div class="service-card d-flex flex-row">
                <div class="card-img d-flex justify-content-center align-items-center me-sm-4 me-3">
                  <svg width="28" height="28" viewBox="0 0 28 28" fill="none"
                    ...
                    <defs>
                      <linearGradient id="paint0_linear_37_170" x1="11.9997" y1="7.99908" x2="32.0887"
                        y2="22.2203" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#F6A932"></stop>
                        <stop offset="1" stop-color="#FF5A0E"></stop>
                      </linearGradient>
                      <linearGradient id="paint1_linear_37_170" x1="0.00222015" y1="15.9992" x2="12.2132"
                        y2="25.0021" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#F6A932"></stop>
                        <stop offset="1" stop-color="#FF5A0E"></stop>
                      </linearGradient>
                      <linearGradient id="paint2_linear_37_170" x1="12.0099" y1="-0.000244141" x2="16.6101"
                        y2="10.839" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#F6A932"></stop>
                        <stop offset="1" stop-color="#FF5A0E"></stop>
                      </linearGradient>
                      <linearGradient id="paint3_linear_37_170" x1="-0.000152588" y1="-0.000244141" x2="12.7219"
                        y2="7.12889" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#F6A932"></stop>
                        <stop offset="1" stop-color="#FF5A0E"></stop>
                      </linearGradient>
                      <linearGradient id="paint4_linear_37_170" x1="5.71838" y1="1.92468" x2="12.7682"
                        y2="4.53814" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#F6A932"></stop>
                        <stop offset="1" stop-color="#FF5A0E"></stop>
                      </linearGradient>
                      <linearGradient id="paint5_linear_37_170" x1="21.9985" y1="21.9988" x2="27.5793"
                        y2="26.969" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#F6A932"></stop>
                        <stop offset="1" stop-color="#FF5A0E"></stop>
                      </linearGradient>
        ...
        <div class="product-slider pt-2">
          <div>
            <div class="card product-card">
              <div class="card-img">
                <img src="{{ asset('assets/img/vcard17/product-img1.png') }}" class="w-100 object-fit-cover"
                  loading="lazy" />
              </div>
          ...
          <div>
            <div class="card product-card">
              <div class="card-img">
                <img src="{{ asset('assets/img/vcard17/product-img2.png') }}" class="w-100 object-fit-cover"
                  loading="lazy" />
              </div>
              <div class="bg-primary-light card-body">
                <div class="d-flex justify-content-between">
          ...
          <div>
            <div class="card product-card">
              <div class="card-img">
                <img src="{{ asset('assets/img/vcard17/product-img3.png') }}" class="w-100 object-fit-cover"
                  loading="lazy" />
              </div>
              <div class="bg-primary-light card-body">
                <div class="d-flex justify-content-between">
        ...
        <div class="blog-slider pt-3 mt-3">
          <div class="">
            <div class="blog-card blog-1 card">
              <div class="overlay">
                <img src="{{ asset('assets/img/vcard17/blog-img.png') }}" alt="profile" class="h-100 w-100 "
                  loading="lazy" />
              </div>
      ...
      <div class="testimonial-section">
        ...
        <div class="bg">
          <div class="testimonial-bg">
            <img src="{{ asset('assets/img/vcard17/testimonial-bg.png') }}" class="w-100 h-100 object-fit-cover"
              loading="lazy" />
          </div>
          ...
          <div class="px-30">
            <div class="qr-code mt-3 mx-auto position-relative">
              <div class="qr-profile-img">
                <img src="{{ asset('assets/img/vcard17/qr-profile-img.png') }}" class="w-100 h-100 object-fit-cover"
                  loading="lazy" />
              </div>
              <div class="qr-code-img mx-auto">
                <img src="{{ asset('assets/img/vcard17/qr-code.png') }}" class="w-100 h-100 object-fit-cover"
                  loading="lazy" />
              </div>
              <div class="text-center">
