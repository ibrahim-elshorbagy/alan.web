    ...
    <div class="main-content mx-auto w-100 overflow-hidden bg-green">
            ...
            <ul class="text-decoration-none">
              <li class="dropdown1 dropdown lang-list">
                ...
                <ul class="dropdown-menu start-0 lang-hover-list top-100 mt-0">
                  ...
                  <li>
                    <img src="{{ asset('assets/img/vcard1/france.png') }}" width="25px" height="20px" class="me-3"
                      loading="lazy"><a href="#">Franch</a>
                  </li>
                  <li>
                    <img src="{{ asset('assets/img/vcard1/arabic.svg') }}" width="25px" height="20px" class="me-3"
                      loading="lazy"><a href="#">Arabic</a>
                  </li>
                  <li>
                    <img src="{{ asset('assets/img/vcard1/german.png') }}" width="25px" height="20px" class="me-3"
                      loading="lazy"><a href="#">German</a>
                  </li>
                  <li>
      ...
      <div class="profile-section pb-60 px-30">
        <div class="card d-flex flex-sm-row-reverse align-items-sm-end align-items-center mb-30">
          <div class="card-img">
            <img src="{{ asset('assets/img/vcard22/qr-profile-img.png') }}" class="w-100 h-100 object-fit-cover"
              loading="lazy" />
          </div>
          ...
          <div class="col-sm-6 mb-40">
            <div class="contact-box d-flex align-items-center">
              ...
              <div class="contact-desc">
                <a href="mailto:jackie@gmail.com" class="text-white fw-5">jackie@gmail.com</a>
              </div>
            </div>
          </div>
          <div class="col-sm-6 mb-40">
        ...
        <div class="services">
          <div class="row">
            <div class="col-sm-6 mb-sm-0 mb-40">
              <div class="service-card h-100">
                <div class="card-img mx-auto d-flex justify-content-center align-items-center mb-20">
                  <img src="{{ asset('assets/img/vcard22/service-img1.png') }}" class="h-100" loading="lazy" />
                </div>
            ...
            <div class="col-sm-6">
              <div class="service-card h-100">
                <div class="card-img mx-auto d-flex justify-content-center align-items-center mb-20">
                  <img src="{{ asset('assets/img/vcard22/service-img2.png') }}" class="h-100" loading="lazy" />
                </div>
                <div class="card-body text-center p-0">
      ...
      <div class="appointment-section mb-5 px-30">
        ...
        <div class="appointment">
          <div class="mb-30">
            <label for="date" class="appoint-date text-white fs-18 mb-1">Date:</label>
            <div class="row">
              <div class="col-12">
        ...
        <div class="gallery-slider pt-3 mt-3">
          <div>
            <div class="gallery-img">
              <img src="{{ asset('assets/img/vcard22/gallery-img2.png') }}" class="w-100 h-100 object-fit-cover"
                loading="lazy" />
          ...
          <div>
            <div class="gallery-img">
              <img src="{{ asset('assets/img/vcard22/gallery-img3.png') }}" class="w-100 h-100 object-fit-cover"
                loading="lazy" />
            </div>
          </div>
          <div>
            <div class="gallery-img">
              <img src="{{ asset('assets/img/vcard22/gallery-img1.png') }}" class="w-100 h-100 object-fit-cover"
                loading="lazy" />
            </div>
          </div>
        </div>
      ...
      <div class="product-section mb-5 px-3">
        ...
        <div class="product-slider">
          <div class="">
            <div class="product-card card">
              <div class="product-img card-img">
                <img src="{{ asset('assets/img/vcard22/product-img1.png') }}" class="w-100 h-100 object-fit-cover"
                  loading="lazy" />
              </div>
          ...
          <div class="">
            <div class="product-card card">
              <div class="product-img card-img">
                <img src="{{ asset('assets/img/vcard22/product-img2.png') }}" class="w-100 h-100 object-fit-cover"
                  loading="lazy" />
              </div>
              <div class="product-desc card-body p-3">
                <div class="d-flex justify-content-between align-items-center mb-2">
                  ...
                  <div class="d-flex justify-content-between align-items-end">
                    <div class="d-flex flex-wrap align-items-center">
                      <div class="testimonial-profile-img mt-3">
                        <img src="{{ asset('assets/img/vcard22/testimonial-profile-img.png') }}"
      ...
      <div class="blog-section mb-5 px-3">
        ...
        <div class="blog-slider">
          <div class="">
            <div class="blog-card card">
              <div class="card-img mb-3">
                <img src="{{ asset('assets/img/vcard22/blog-img1.png') }}" class="w-100 h-100 object-fit-cover"
                  loading="lazy" />
              </div>
              <div class="card-body p-0">
          ...
          <div class="">
            <div class="blog-card card">
              <div class="card-img mb-3">
                <img src="{{ asset('assets/img/vcard22/blog-img2.png') }}" class="w-100 h-100 object-fit-cover"
                  loading="lazy" />
              </div>
              <div class="card-body p-0">
      ...
      <div class="qr-code-section mb-5 px-30">
        ...
        <div class="qr-code d-flex justify-content-center align-items-center flex-wrap mb-30">
          ...
          <div class="qr-code-img">
            <img src="{{ asset('assets/img/vcard22/qr-code-img.png') }}" class="w-100 h-100 object-fit-cover"
              loading="lazy" />
          </div>
        </div>
      </div>
      ...
      <div class="add-to-contact-section mb-5">
        <div class="text-center">
          <button class="add-contact-btn rounded-2 btn btn-primary"><i class="fas fa-download fa-address-book"></i>
