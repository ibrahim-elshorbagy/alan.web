  ...
  <div class="row ps-lg-0 ps-5 align-items-center">
    <div class=" col-lg-3 col-sm-5 col-7 ps-lg-0 ps-sm-4 ps-3">
      <a href="{{ route('vcard11.index') }}" class="fs-14 text-white  home"><i
          class="fa-solid fa-house me-sm-3 mx-2"></i></a> <span class="fs-14 text-white home">@yield('page_name')</span>
    </div>
    <div class=" col-lg-9  col-sm-7 col-5 text-end d-flex justify-content-end align-items-center">
      <a href="{{ route('vcard11.contact') }}" class="fs-14 text-white me-5 contact d-sm-inline-block d-none"><i
          class="far fa-envelope mx-2"></i> Get in Touch</a>
      <div class="dropdown">
        <button class="dropbtn btn btn-primary d-lg-none d-block fs-14"><i class="fa-solid fa-language "></i></button>
        <button class="dropbtn btn btn-primary d-lg-block d-none fs-14"><i
            class="fa-solid fa-language mx-2"></i>Language<i class="ps-1 fa-solid fa-sort-down"></i>
        </button>
      ...
      <div class="sharedropdown">
        <button class="sharedropbtn btn btn-primary d-lg-inline-block d-none fs-14 ms-sm-4 "><i
            class="fas fa-share-alt mx-2"></i>{{ __('messages.vcard.share') }}</button>
        ...
        <div id="shareDropdown" class="sharedropdown-content">
          <div class="icons d-flex justify-content-between">
            <div
              class="share-icon border-gradient border-gradient-orange d-flex justify-content-center align-items-center">
              <a href="#!"><i
    ...
    <header class=" p-4">
      <div class="hero-img position-relative br-15 mb-5">
        ...
        <div class=" d-flex icon-box position-absolute">
          <div
            class="social-icon  me-3 border-gradient border-gradient-orange d-flex justify-content-center align-items-center">
            <a href="#!"><i
                class="fa-brands fa-facebook-f d-flex justify-content-center align-items-center"></i></a>
          </div>
      ...
      <div class="">
        <div class="nav-tabs nav flex-column nav-pills me-3" id="v-pills-tab1" role="tablist"
          ...
          <a href="{{ route('vcard11.portfolio-single-2') }}" class="nav-link"><i
              class="fa-solid fa-images mx-2"></i> Terms & Conditions</a>
      ...
      <div class="row justify-content-center mt-4">
        <div class="col-12 text-center">
          <a href="#!" download="" class="btn btn-primary"><i class="fas fa-download"></i> Download
            vCard</a>
        </div>
      </div>
    </header>
...
<header class="main-header p-4 d-lg-block d-none">
  ...
  <div class="d-flex icon-box justify-content-center">
    <div
      class="social-icon me-3 border-gradient border-gradient-orange d-flex justify-content-center align-items-center">
      <a href="#"><i class="fa-brands fa-facebook-f d-flex justify-content-center align-items-center"></i></a>
    </div>
    <div class="social-icon me-3 d-flex justify-content-center align-items-center">
      <a href="#"><i class="fa-brands fa-instagram d-flex justify-content-center align-items-center"></i></a>
    </div>
    <div class="social-icon me-3 d-flex justify-content-center align-items-center">
      <a href="#"><i class="fa-brands fa-twitter d-flex justify-content-center align-items-center"></i></a>
    </div>
    <div class="social-icon me-3 d-flex justify-content-center align-items-center">
      <a href="#"> <i class="fa-brands fa-pinterest-p d-flex justify-content-center align-items-center"></i>
      </a>
    </div>
  </div>
  <div class="">
