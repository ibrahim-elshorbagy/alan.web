...
@section('content')
  <div class="tab-content p-sm-4 p-3" id="v-pills-tabContent">
    <div class="blog-tab tab-pane fade show active" id="v-pills-blog" role="tabpanel" aria-labelledby="v-pills-blog-tab">
      <!-- start blog-section -->
        ...
        <div class="row">
          <div class="col-lg-8">
            ...
            <div class="blog-post mb-4">
              ...
              <div class="mb-4">
                <div class="post">
                  <img src="{{ asset('assets/img/vcard11/blog-post4.jpeg') }}" class="w-100 h-100 object-fit-cover">
                </div>
              </div>
              <div class="blog-post-desc ">
                <p class="fs-14 text-white mb-4">
