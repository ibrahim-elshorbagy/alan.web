                ...
                <div id="carouselExampleIndicators1" class="carousel slide" data-bs-ride="carousel">
                  ...
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img src="{{ asset('assets/img/vcard11/blog-post1.jpeg') }}" class="w-100 h-100 object-fit-cover">
                      <div class="search" onclick="openModalBox2();currentSlide(1)">
                        <a href="#!" class="search d-flex justify-content-center align-items-center ">
                          <i
                            class="fas fa-magnifying-glass d-flex justify-content-center align-items-center text-white fs-6"></i>
                        </a>
                      </div>
                    </div>
                    <div class="carousel-item">
                      <img src="{{ asset('assets/img/vcard11/blog-post2.jpeg') }}" class="w-100 h-100 object-fit-cover">
                    ...
                    <div class="carousel-item">
                      <img src="{{ asset('assets/img/vcard11/blog-post3.jpeg') }}" class="w-100 h-100 object-fit-cover">
            ...
            <div class="comment-section p-4 mb-4">
              ...
              <div class="comment d-flex">
                <div class="comment-img d-sm-block d-none">
                  <img src="{{ asset('assets/img/vcard11/comment.jpeg') }}" class="w-100 h-100 object-fit-cover">
                </div>
                <div class="comment-desc p-4 ms-sm-4 position-relative">
                  ...
                  <div class="d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <a class="btn btn-primary fs-12 mt-sm-4 mt-3" href="#"><i class="fas fa-reply mx-2"></i>
                      Reply</a>
                  </div>
                </div>
              </div>
            ...
            <div class="leave-comment-section mb-4">
              ...
              <form>
                ...
                <div class="form-group mb-4 text-area">
                  ...
                  <textarea name="comments" id="comments" class="text-area form-control pt-2 fs-12 text-white" rows="5"
          ...
          <div class="col-lg-4">
            <div class="blog-right-section">
              ...
              <div class="last-post-section mb-4">
                ...
                <div class="last-posts d-flex ">
                  <a href="#!" class="post d-block">
                    <img src="{{ asset('assets/img/vcard11/last-post1.jpeg') }}" class="w-100 h-100 object-fit-cover">
                  </a>
                  <div class="last-post-desc ps-3">
                    <a href="#!" class="fs-14 text-white">Vivamus dapibus rutrum</a>
                    <span class="d-flex align-items-center fs-12 text-white"><i class="fas fa-calendar mx-2"></i> 27 Mar
                      2021 </span>
                  </div>
                </div>
                <div class="last-posts d-flex ">
                  <a href="#!" class="post d-block">
                    <img src="{{ asset('assets/img/vcard11/last-post2.jpeg') }}" class="w-100 h-100 object-fit-cover">
                  </a>
                  <div class="last-post-desc ps-3">
                    <a href="#!" class="fs-14 text-white">Integer sagittis</a>
                    <span class="d-flex align-items-center fs-12 text-white"><i class="fas fa-calendar mx-2"></i> 12 May
                      2021 </span>
                  </div>
                </div>
                <div class="last-posts d-flex ">
                  <a href="#!" class="post d-block">
                    <img src="{{ asset('assets/img/vcard11/last-post3.jpeg') }}" class="w-100 h-100 object-fit-cover">
                  </a>
                  <div class="last-post-desc ps-3">
                    <a href="#!" class="fs-14 text-white">Snowy Mountains Trip</a>
                    <span class="d-flex align-items-center fs-12 text-white"><i class="fas fa-calendar mx-2"></i> 22 Feb
                      2021 </span>
                  </div>
                </div>
              </div>
              ...
              <div class="subscribe-section">
                ...
                <form>
                  <input class="email fs-12 mb-3" name="email" placeholder="Your Email" spellcheck="false"
                    type="text" required />
