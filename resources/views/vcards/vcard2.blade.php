  ...
  <div class="container">
    <div class="vcard-two main-content w-100 mx-auto overflow-hidden">
      ...
      <div class="vcard-two__profile-details py-3 px-3">
        ...
        <br>
        <span class="profile-description d-flex pt-4"> I am a heart surgeon. I have 10 year experience in surgery,I am a
          heart surgeon. I have 10 year experience in surgery,I am a heart surgeon. I have 10 year experience in
          surgery,I am a heart surgeon. I have 10 year experience in surgery,I am a heart surgeon. I have 10 year
          experience in surgery,I am a heart surgeon. I have 10 year experience in surgery</span>
      ...
      <div class="vcard-two__service my-3 py-3 position-relative">
        ...
        <img src="{{ asset('assets/img/vcard2/shape2.png') }}" class="banner-shape-two position-absolute end-0"
          alt="shape" loading="lazy" />
        <img src="{{ asset('assets/img/vcard2/shape3.png') }}" class="banner-shape-three position-absolute start-0"
          alt="shape" loading="lazy" />
            ...
            <div class="col-12 p-2">
              <div class="card testimonial-card flex-sm-row flex-column-reverse p-3 border-0 align-items-center w-100">
                ...
                <div class="testimonial-profile mb-sm-0 mb-3 ms-sm-auto">
                  <img src="{{ asset('assets/img/vcard2/vcard-testimonial.png') }}" alt="profile"
                ...
                <div class="row">
                  <div class="col-sm-6 col-12 mb-sm-0 mb-4">
                    <div class="qr-profile d-flex justify-content-center">
                      <img src="{{ asset('assets/img/vcard2/vcard2-profile.png') }}" class="rounded-circle"
                        alt="qr-profile" loading="lazy" />
                    </div>
                    <button type="button" class="qr-code-btn text-white mt-4 d-sm-block d-none mx-auto">Download My
                      QR Code</button>
                  </div>
                  <div class="col-sm-6 col-12">
      ...
      <div class="vcard-two__contact py-4 position-relative">
        <img src="{{ asset('assets/img/vcard2/shape6.png') }}"
          class="position-absolute start-0 bottom-0 d-sm-block d-none" alt="shape" loading="lazy" />
