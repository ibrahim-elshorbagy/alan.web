      ...
      <div class="main-bg p-0">
        ...
        <div class="mb-5">
          <div class="profile-img">
            <img src="{{ asset('assets/img/newgirl.png') }}" width="150px" class="pro-img me-sm-4 rounded-circle mb-4"
              loading="lazy" />
            <div>
          ...
          <div class="d-flex align-items-center ">
            <span class="pt-2 px-2 profile-description"> I am a heart surgeon. I have 10 year experience in surgery,I am
                ...
                <div class="card text-center testi-shadow w-100">
                  ...
                  <div class="card-body p-0">
                    <div class="row d-flex justify-content-between align-items-end">
                      <div class="col-lg-6">
                        <div class="d-flex align-items-center">
                          <img src="{{ asset('assets/img/t1.png') }}" class="me-3 testi-logo rounded-circle"
                            loading="lazy" />
                          <div>
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="text-center">
                <img src="{{ asset('assets/img/newgirl.png') }}" width="125px" class="qr-logo rounded-circle"
                  loading="lazy" />
                <div class="mt-4">
              ...
              <div class="col-sm-6">
                <div class="row">
                  ...
                  <div class="col-12 mb-3 input-group">
                    ...
                    <input type="text" class="form-control contact-input border-start-0" id="inputAddress"
              ...
              <div class="col-sm-6">
                <div class="row">
                  <div class="col-12 mb-3">
                    ...
                    <textarea class="form-control contact-input" id="exampleFormControlTextarea1" rows="7"
