            ...
            <div class="profile-img py-3">
              <div class="mb-4">
                <div class="d-flex align-items-center mb-4">
                  <div>
                    <img src="{{ asset('assets/img/vcard7/profilegirl.png') }}" class="img-fluid rounded-circle"
                      loading="lazy" />
                  </div>
                  <div class="ms-3">
                ...
                <div class="d-flex align-items-center mb-5">
                  <span class="pt-2  profile-description"> I am a heart surgeon. I have 10 year experience in surgery,I
                    am a heart surgeon. I have 10 year experience in surgery,I am a heart surgeon. I have 10 year
                    experience in surgery,I am a heart surgeon. I have 10 year experience in surgery,I am a heart
                ...
                <div class="card shadow-testi w-100 border-0">
                  <div class="card-body p-0">
                    <div class="d-flex align-items-center testimonial-box">
                      <img src="{{ asset('assets/img/vcard7/testilogo.png') }}" class="testi-logo rounded-circle"
                        loading="lazy" />
                      <div class="my-2">
              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="row">
                    ...
                    <div class="col-12 mb-3 input-group">
                      <span class="input-group-text contact-icon border-end-0 bg-transparent" id="basic-addon1"><i
