        ...
        <div class="col-sm-6 mt-sm-0 mt-5">
            <div class="card">
                <div class="card-body" style="height:650px">
                    ...
                    <!-- Product Storage -->
                    <h5 class="card-title mt-5 mb-1">{{ __('messages.vcards') }}</h5>
                    ...
                    <h5 class="card-title mt-1 mb-1">{{ __('messages.common.whatsapp_store') }}</h5>
                    <div class="overflow-auto">
                        <!-- Table for storage details -->
                        <table class="table w-100 table-borderless" style="white-space: nowrap">
                            <tr>
                                <td class="ps-0">{{ __('messages.whatsapp_stores.products') }}</td>
                                <td class="pe-0" style="width:120px;">{{ number_format($productWhatsappStoreStorageMB, 2) }} {{ __('messages.mb') }}</td>
                                <td class="pe-0" style="width:120px;">{{ number_format(($productWhatsappStoreStorageMB / $storageLimit) * 100, 2) }}%</td>
                            </tr>
                            <tr>
                                <td class="ps-0">{{ __('messages.product_category') }}</td>
                                <td class="pe-0" style="width:120px;">{{ number_format($productCategoriesWhatsappStoreStorageMB, 2) }} {{ __('messages.mb') }}</td>
                                <td class="pe-0" style="width:120px;">{{ number_format(($productCategoriesWhatsappStoreStorageMB / $storageLimit) * 100, 2) }}%</td>
                            </tr>
                            <tr>
                                <td class="ps-0">{{ __('messages.profile_and_cover') }}</td>
                                <td class="pe-0" style="width:120px;">{{ number_format($profileWhatsappStoreStorageMB, 2) }} {{ __('messages.mb') }}</td>
                                <td class="pe-0" style="width:120px;">{{ number_format(($profileWhatsappStoreStorageMB / $storageLimit) * 100, 2) }}%</td>
                            </tr>
                        </table>
                    ...
                    <h5 class="card-title mt-1 mb-1">{{ __('messages.user.setting') }}</h5>
                    <div class="overflow-auto">
                        <table class="table w-100 table-borderless" style="white-space: nowrap">
                            <tr>
