<style>
  ...
  /* Make secret key input left-to-right so the copy icon doesn't overlap digits and
       so scanners can easily capture the QR/secret on RTL pages */
  #secret_key {
        ...
        <div class="modal-body pt-2 mb-2 pb-3">
          <div class="d-flex align-items-center gap-3 p-3 qusetion-heading mb-4">
            <div class="question-icon-box rounded-circle d-flex justify-content-center align-items-center">
              <svg xmlns="http://www.w3.org/2000/svg" class="text-blue-600" fill="none" viewBox="0 0 24 24"
          ...
          <div class="d-flex gap-2 count-list">
            <div class="fw-bold count-cricle d-flex justify-content-center align-items-center rounded-circle">
              1
            </div>
            <div>
              <p class="mb-2">
          ...
          <div class="row modal-body-row">
            <div class="col-sm-6 mb-2">
              ...
              <div class="qr-code-box d-flex justify-content-center align-items-center">
                <div class="qr-code-img h-100 w-100 mx-auto generate-qr-code-img" id="generateQrCodeImg">
            ...
            <div class="col-sm-6 mb-2">
              <div class="mb-4">
                ...
                <div class="position-relative">
                  <svg xmlns="http://www.w3.org/2000/svg" class="position-absolute password-icon-hide-show copy-icon"
        ...
        <div class="modal-footer pt-0 @if (getLogInUser()->language == 'ar') gap-2 @endif">
          <div class="d-flex align-items-center gap-3">
            ...
            <button type="submit" class="btn btn-primary m-0 px-3 py-2 fs-12" id="enableTwoFactor">
              <svg xmlns="http://www.w3.org/2000/svg" class="text-white me-1" fill="none" viewBox="0 0 24 24"
      ...
      <form id="ManageTwoFactorAuthentication">
        ...
        <div class="modal-body pt-2 pb-3">
          ...
          <div class="card-box p-4 pb-34 mb-40">
            ...
            <div class="position-relative">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" class="lock-icon" fill="none" viewBox="0 0 24 24"
                stroke="currentColor" height="20" width="20">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
        ...
        <div class="modal-footer pt-0 @if (getLogInUser()->language == 'ar') gap-2 @endif">
          <div class="d-flex align-items-center gap-4">
            <button type="button" class="btn fs-12 btn-secondary m-0 px-3 py-2" id="enableTwoFactor"
              data-bs-dismiss="modal" aria-label="Close">{{ __('messages.common.cancel') }}</button>
            <button class="btn btn-primary fs-12 my-0 me-0 px-3 py-2" type="submit"> <svg
                xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 mr-1.5" fill="none" viewBox="0 0 24 24"
