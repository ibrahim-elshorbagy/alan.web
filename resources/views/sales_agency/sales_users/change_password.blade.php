<div class="modal fade" id="agencyChangeUserPasswordModal" tabindex="-1" aria-modal="true" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content" @if (getLogInUser()->language == 'ar' || getLogInUser()->language == 'fa') dir="rtl" @endif>
      <div class="modal-header">
        ...
        <button type="button"
          class="btn-close @if (getLogInUser()->language == 'ar' || getLogInUser()->language == 'fa') m-0 @endif"
          data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      {{ Form::open(['id' => 'agencyChangeUserPasswordForm']) }}
      @csrf
      @method('PUT')
      <div class="modal-body">
        <div class="alert alert-danger d-none" id="agencyEditUserPasswordValidationErrorsBox"></div>
        <div class="mb-5">
          {{ Form::hidden('user_id', null, ['id' => 'agencyChangePasswordUserId']) }}
      ...
      <div
        class="modal-footer pt-0 @if (getLogInUser()->language == 'ar' || getLogInUser()->language == 'fa') gap-3 @endif">
        {{ Form::button(__('messages.common.save'), ['class' => 'btn btn-primary m-0', 'id' => 'AgencyUserPasswordChangeBtn']) }}
