<div class="row">
  ...
  <div class="col-lg-6">
    ...
    <input type="tel" name="contact" id="contact" class="form-control modern-input @if (
      getLanguageByKey(checkFrontLanguageSession()) == 'Arabic' ||
      getLanguageByKey(checkFrontLanguageSession()) == 'Persian'
    ) text-end @else text-start @endif" placeholder="962 XXX XXXX"
      value="{{ isset($user) ? $user->contact : old('contact') }}" pattern="^(962)[1-9]\d{8}$"
