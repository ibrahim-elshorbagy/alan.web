            ...
            <div class="row">
              ...
              <div class="col-md-6 col-12 @if ($planText == 'Current Expired Plan') mx-auto @endif">
                <div class="card h-100 p-5 me-2 shadow rounded">
                  <div class="card-header py-0 px-0">
                    <h3 class="align-items-start flex-column p-sm-5 p-0">
                      <span class="fw-bolder text-primary fs-1 mb-1 me-0">{{ __('messages.plan.new_plan') }}</span>
                  ...
                  <div class="px-5 pb-5">
                    ...
                    <div class="d-flex align-items-center  py-2">
                      ...
                      <span class="fs-5 w-50 text-muted fw-bold mt-1">
                        @php
                          if ($customField) {
                              $amountTopay = $customField->custom_vcard_price - $cpData['remainingBalance'];
                          } else {
                  ...
                  <div class="row {{ $newPlan['amountToPay'] <= 0 ? 'd-none' : '' }}">
                    @if (isset($paymentTypes[1]))
                      <div class="col-lg-3 p-2">
                        <div class="mb-xxl-0 mb-4 border-radius p-4" id="stripePayment">
                              ...
                              <div class="d-flex gap-3 justify-content-between">
                                ...
                                <div>
                                  <input
                                    ...
                                    type="radio" name="payment_mode" id="stripePayment" value="stripe_payment">
                    ...
                    @if (isset($paymentTypes[2]))
                      <div class="col-lg-3 p-2">
                        <div class="mb-xxl-0 mb-4 border-radius p-4" id="paypalPayment">
                          <div class="selected-box ">
                            <label class="form-check input-padding">
                              <div class="d-flex gap-3 justify-content-between">
                                <div class=" mb-3">
                                ...
                                <div>
                                  <input
                                    class="form-check-input capture @if (getLogInUser()->language == 'ar' || getLogInUser()->language == 'fa') input-margin @endif"
                                    type="radio" name="payment_mode" id="paypalPayment" value="paypal_payment">
                                </div>
                              </div>
                    ...
                    @if (isset($paymentTypes[3]))
                      <div class="col-lg-3 p-2">
                        <div class="mb-xxl-0 mb-4 border-radius p-4" id="razorpayPayment">
                          <div class="selected-box ">
                            <label class="form-check input-padding">
                              <div class="d-flex gap-3 justify-content-between">
                                <div class=" mb-3">
                                  <svg width="60" height="60" viewBox="0 0 100 100" fill="none"
                                    ...
                                    <g clip-path="url(#clip0_31_5)">
                                      ...
                                      <path
                                        ...
                                        fill="#6571FF" />
                                      <path d="M28.4391 49.22L25 62H42.0272L51 32L28.4391 49.22Z" fill="#6571FF" />
                                    </g>
                                    <defs>
                                ...
                                <div>
                                  <input
                                    class="form-check-input capture @if (getLogInUser()->language == 'ar' || getLogInUser()->language == 'fa') input-margin @endif"
                                    type="radio" name="payment_mode" id="razorpayPayment" value="razorpay_payment">
                                </div>
                              </div>
                    ...
                    @if (isset($paymentTypes[5]))
                      <div class="col-lg-3 p-2">
                        <div class="mb-xxl-0 mb-4 border-radius p-4" id="paystackPayment">
                          <div class="selected-box ">
                            <label class="form-check input-padding">
                              <div class="d-flex gap-3 justify-content-between">
                                <div class=" mb-3">
                                  <svg class="paystack-custom-icon mt-2 mb-2" width="90" height="17"
                                    viewBox="0 0 90 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                ...
                                <div>
                                  <input
                                    class="form-check-input capture @if (getLogInUser()->language == 'ar' || getLogInUser()->language == 'fa') input-margin @endif "
                                    type="radio" name="payment_mode" id="paystackPayment" value="paystack_payment">
                                </div>
                              </div>
                    ...
                    @if (isset($paymentTypes[6]))
                      <div class="col-lg-3 p-2">
                        <div class="mb-xxl-0 mb-4 border-radius p-4" id="phonePePayment">
                          <div class="selected-box ">
                            <label class="form-check input-padding">
                              <div class="d-flex gap-3 justify-content-between">
                                <div class=" mb-3">
                                ...
                                <div>
                                  <input
                                    class="form-check-input capture @if (getLogInUser()->language == 'ar' || getLogInUser()->language == 'fa') input-margin @endif"
                                    type="radio" name="payment_mode" id="phonePePayment" value="phone_pe_payment">
                                </div>
                              </div>
                    ...
                    @if (isset($paymentTypes[7]))
                      <div class="col-lg-3 p-2">
                        <div class="mb-xxl-0 mb-4 border-radius p-4" id="flutterwavePayment">
                          <div class="selected-box ">
                            <label class="form-check input-padding">
                              <div class="d-flex gap-3 justify-content-between">
                                <div class=" mb-3">
                                  <svg class="custom-icon mt-2 mb-2" width="17" height="17" viewBox="0 0 17 17"
                                ...
                                <div>
                                  <input
                                    class="form-check-input capture @if (getLogInUser()->language == 'ar' || getLogInUser()->language == 'fa') input-margin @endif"
                                    type="radio" name="payment_mode" id="flutterwavePayment"
                    ...
                    @if (isset($paymentTypes[9]))
                      <div class="col-lg-3 p-2">
                        <div class="mb-xxl-0 mb-4 border-radius p-4" id="payfastPayment">
                          <div class="selected-box ">
                            <label class="form-check input-padding">
                              <div class="d-flex gap-3 justify-content-between">
                                <div class=" mb-3">
                                  <img src="{{ asset('images/payfast-logo.svg') }}" class="mt-2 mb-2" height="45"
                                    width="90" alt="image">
                                </div>
                                <div>
                                  <input
                                    class="form-check-input capture @if (getLogInUser()->language == 'ar' || getLogInUser()->language == 'fa') input-margin @endif"
                                    type="radio" name="payment_mode" id="payfastPayment" value="payfast_payment">
                                </div>
                              </div>
                    ...
                    @if (isset($paymentTypes[11]))
                      <div class="col-lg-3 p-2">
                        <div class="mb-xxl-0 mb-4 border-radius p-4" id="iyzicoPayment">
                          <div class="selected-box ">
                            <label class="form-check input-padding">
                              <div class="d-flex gap-3 justify-content-between">
                                <div class=" mb-3">
                                ...
                                <div>
                                  <input
                                    class="form-check-input capture @if (getLogInUser()->language == 'ar' || getLogInUser()->language == 'fa') input-margin @endif"
                                    type="radio" name="payment_mode" id="iyzicoPayment" value="iyzico_payment">
                                </div>
                              </div>
                    ...
                    @if (moduleExists('MercadoPago') && isset($paymentTypes[8]))
                      <div class="col-lg-3 p-2">
                        <div class="mb-xxl-0 mb-4 border-radius p-4" id="mercadoPagoPayment">
                          <div class="selected-box ">
                            <label class="form-check input-padding">
                              <div class="d-flex gap-3 justify-content-between">
                                <div class=" mb-3">
                                  <svg xmlns="http://www.w3.org/2000/svg" class="custom-icon mt-2 mb-2"
                                    viewBox="0 0 640 512">
                                    <path
                                ...
                                <div>
                                  <input
                                    class="form-check-input capture @if (getLogInUser()->language == 'ar' || getLogInUser()->language == 'fa') input-margin @endif"
                                    type="radio" name="payment_mode" id="mercadoPagoPayment"
                    ...
                    @if (isset($paymentTypes[4]))
                      <div class="col-lg-3 p-2">
                        <div class="mb-xxl-0 mb-4 border-radius p-4" id="manuallyPayment">
                          <div class="selected-box ">
                            <label class="form-check input-padding">
                              <div class="d-flex gap-3 justify-content-between">
                                <div class=" mb-3">
                                ...
                                <div>
                                  <input
                                    class="form-check-input capture @if (getLogInUser()->language == 'ar' || getLogInUser()->language == 'fa') input-margin @endif"
                                    type="radio" name="payment_mode" id="manualPayment" value="manual_payment">
                                </div>
                              </div>
                    ...
                    {{-- @if (isset($paymentTypes[10]))
                                            <div class="col-lg-3 p-2">
                                                <div class="mb-xxl-0 mb-4 border-radius p-4" id="sslcommerzPayment">
                                                    <div class="selected-box ">
                                                        <label class="form-check input-padding">
                                                            <div class="d-flex gap-3 justify-content-between">
                                                                <div class=" mb-3">
                  ...
                  <div class="flex-column mt-5 plan-controls">
                    <div class="mt-5 me-3 w-sm-50 {{ $newPlan['amountToPay'] <= 0 ? 'd-none' : '' }}">
                      <div class="mb-3 coupon-code-form d-none">
                        <label class="form-label fs-6 text-muted mb-0">
                          {{ __('messages.coupon_code.have_a_coupon_code') }}
                        </label>
                        <div class="input-group" dir="auto">
                          {{ Form::text('coupon_code', null, [
                              'class' => 'form-control',
                              'id' => 'paymentCouponCode',
                              'placeholder' => __('messages.coupon_code.enter_coupon_code'),
                              'style' =>
                                  'border-start-start-radius: var(--bs-border-radius) !important; border-end-start-radius: var(--bs-border-radius) !important; border-start-end-radius: 0 !important; border-end-end-radius: 0 !important;',
                          ]) }}
                          <span class="btn input-group-text bg-primary text-light disabled apply-coupon-code-btn"
                            ...
                            style="border-start-start-radius: 0 !important; border-end-start-radius: 0 !important; border-start-end-radius: var(--bs-border-radius) !important; border-end-end-radius: var(--bs-border-radius) !important;">
                            {{ __('messages.common.apply') }}
                          </span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="mt-5 switch-plan-btn  proceed-to-payment  d-none">
                      <button type="button" class="btn btn-primary rounded-pill mx-auto d-block makePayment"
                        data-id="{{ $subscriptionsPricingPlan->id }}" data-plan-price="{{ $subcriptionPrice }}">
                    ...
                    <div class="mt-5 RazorPayPayment proceed-to-payment d-none">
                      <button type="button" class="btn btn-primary rounded-pill mx-auto d-block paymentByRazorPay"
                        data-id="{{ $subscriptionsPricingPlan->id }}" data-plan-price="{{ $subcriptionPrice }}">
                        {{ __('messages.subscription.pay_or_switch_plan') }}</button>
                    </div>
                    <div class="mt-5 paystackPayment proceed-to-payment d-none">
                      <button type="button" class="btn btn-primary rounded-pill mx-auto d-block paymentBypaystack"
                        data-id="{{ $subscriptionsPricingPlan->id }}" data-plan-price="{{ $subcriptionPrice }}">
                        {{ __('messages.subscription.pay_or_switch_plan') }}</button>
                    </div>
                    <div class="mt-5 flutterwavePayment proceed-to-payment d-none">
                      <button type="button" class="btn btn-primary rounded-pill mx-auto d-block paymentByflutterwave"
                        data-id="{{ $subscriptionsPricingPlan->id }}" data-plan-price="{{ $subcriptionPrice }}">
                        {{ __('messages.subscription.pay_or_switch_plan') }}</button>
                    </div>
                    <div class="mt-5 phonepePayment proceed-to-payment d-none">
                      <button type="button" class="btn btn-primary rounded-pill mx-auto d-block paymentByPhonepe"
                        data-id="{{ $subscriptionsPricingPlan->id }}" data-plan-price="{{ $subcriptionPrice }}">
                        {{ __('messages.subscription.pay_or_switch_plan') }}</button>
                    </div>
                    <div class="mt-5 mercadoPagoPayment proceed-to-payment d-none">
                      <button type="button" class="btn btn-primary rounded-pill mx-auto d-block paymentByMercadoPago"
                        data-id="{{ $subscriptionsPricingPlan->id }}" data-plan-price="{{ $subcriptionPrice }}">
                        {{ __('messages.subscription.pay_or_switch_plan') }}</button>
                    </div>
                    <div class="mt-5 payfastPayment proceed-to-payment d-none">
                      <button type="button" class="btn btn-primary rounded-pill mx-auto d-block paymentByPayfast"
                        data-id="{{ $subscriptionsPricingPlan->id }}" data-plan-price="{{ $subcriptionPrice }}">
                        {{ __('messages.subscription.pay_or_switch_plan') }}</button>
                    </div>
                    ...
                    <div class="mt-5 iyzicoPayment proceed-to-payment d-none">
                      <button type="button" class="btn btn-primary rounded-pill mx-auto d-block paymentByIyzico"
                        data-id="{{ $subscriptionsPricingPlan->id }}" data-plan-price="{{ $subcriptionPrice }}">
                        {{ __('messages.subscription.pay_or_switch_plan') }}</button>
                    </div>
                ...
                <div class="">
                  <div class="mt-5 plan-controls">
                    ...
                    <form class="manuallyPaymentForm" type="post" enctype="multipart/form-data">
                      <div class=" d-none manuallyPayAttachment" io-image-input="true">
                        <div class="row">
                          <div class="row g-3 align-items-stretch">
                            <!-- Attachment Section -->
                            <div class="col-12 col-md-4 col-lg-3">
                              <label for="exampleInputImage" class="form-label">
                                {{ __('messages.mail.attachment') }} :-
                              </label>
                              <div class="image-picker d-flex flex-column align-items-center align-items-md-start">
                                ...
                                <span class="picker-edit rounded-circle text-gray-500 fs-small" data-bs-toggle="tooltip"
                                  data-placement="top" data-bs-original-title="Choose Attachment">
                                  <label>
                                    ...
                                    <input type="file" id="manual_payment_attachment" name="attachment"
                                      ...
                                      data-preview-id="subscription_manual_payment_attachment" />
                                  </label>
                                </span>
                              </div>
                            </div>
                            ...
                            <div class="col-12 col-md-8 col-lg-9">
                              <label for="notesTextarea" class="form-label">
                                {{ __('messages.mail.notes') }} :-
                              </label>
                              {{ Form::textarea('notes', null, [
                                  'id' => 'notesTextarea',
                                  'class' => 'form-control',
                                  'placeholder' => __('messages.form.add_your_note'),
                                  'rows' => '6',
                              ]) }}
                            </div>
                        </div>
                          ...
                          <div class="col-lg-12">
                            <div class="mt-5 ManuallyPayment proceed-to-payment d-none">
                              <button type="submit" class="btn btn-primary rounded-pill mx-auto d-block manuallyPay">
