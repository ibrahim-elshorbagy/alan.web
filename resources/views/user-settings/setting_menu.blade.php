<div id="mySidebar" class="me-5 sidebar d-lg-block d-xl-block">
  ...
  <ul class="d-flex nav nav-tabs mb-5 pb-1 overflow-auto flex-nowrap text-nowrap flex-column setting-tab" id="myTab"
    ...
    <li class=" nav-item position-relative">
      <a class="nav-link me-0 p-0 gap-2 {{ isset($sectionName) && $sectionName == 'general' ? 'active' : '' }}"
        href="{{ route('user.setting.index', ['section' => 'general']) }}"> <i
    ...
    <li class=" nav-item position-relative" role="presentation">
      <a class="nav-link me-0 p-0 gap-2 {{ isset($sectionName) && $sectionName == 'payment_method' ? 'active' : '' }}"
        href="{{ route('user.setting.index', ['section' => 'payment_method']) }}" data-turbo="false"><i
      ...
      <li class=" nav-item position-relative" role="presentation">
        <a class="nav-link me-0 p-0 gap-2 {{ isset($sectionName) && $sectionName == 'custom_domain' ? 'active' : '' }}"
          href="{{ route('user.setting.index', ['section' => 'custom_domain']) }}" data-turbo="false"><i
            class="fa-solid fa-globe icon-color-bs-green"></i>
