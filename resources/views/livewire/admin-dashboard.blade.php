    ...
    <div class="col-12 mb-4">
      <div class="row dashboard-card-row d-flex align-items-stretch">
        ...
        <div class="col-xxl-3 col-xl-4 col-sm-6 dashboard-card d-flex">
          <div class="dashboard-card-bg my-3 w-100">
            <div class="dashboard-card-content">
              <h5 class="mb-2 fw-bold fs-14">{{ __('messages.total_redirect_links') }}</h5>
              <p class="mb-2 fw-medium card-detail">{{ $totalRedirectLinks }}</p>
              <div class="add-card text-center">
                <a href="{{ route('client.redirect-links.index') }}"
                  class="btn btn-light fw-bold rounded-pill px-3 py-1 bg-white">+
                  {{ __('messages.add_redirect_link') }}</a>
              </div>
            </div>
          </div>
        </div>
