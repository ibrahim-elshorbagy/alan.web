    ...
    <tr>
        ...
        <td style="width: 50%; vertical-align: top; padding-right: 10px; border:0px solid #fff;border-right:1px solid lightgrey">
            ...
            <table style="width: 100%; border: none; border-collapse: collapse;">
                <tr>
                    <td style="border: none; text-align: right; word-break: break-word;font-size:16px;"><span>{{ __('messages.common.name') }}:</span></td>
                    <td style="border: none; text-align: right; word-break: break-word;font-size:16px;color:gray;">{{ $nfcOrder->name ?? 'N/A' }}</td>
                </tr>
                <tr>
                    <td style="border: none; text-align: right;font-size:16px;"><span>{{ __('messages.common.email') }}:</span></td>
                    <td style="border: none; text-align: right; word-break: break-word;font-size:16px;color:gray;">{{ $nfcOrder->email ?? 'N/A' }}</td>
                </tr>
                <tr>
                    <td style="border: none; text-align: right;font-size:16px;"><span>{{ __('messages.common.phone') }}:</span></td>
                    <td style="border: none; text-align: right;font-size:16px;color:gray;">{{ $nfcOrder->region_code ? '+' . $nfcOrder->region_code . ' ' : '' }}{{ $nfcOrder->phone }}</td>
                </tr>
                <tr>
                    <td style="border: none; text-align: right;font-size:16px;"><span>{{ __('messages.user.address') }}:</span></td>
                    <td style="border: none; text-align: right; word-break: break-word;font-size:16px;color:gray;">{{ $nfcOrder->address ?? 'N/A' }}</td>
                </tr>
            </table>
        </td>
        ...
        <td style="width: 50%; vertical-align: top; padding-left: 10px;border:0px solid #fff">
            ...
            <table style="width: 100%; border: none; border-collapse: collapse;">
                <tr>
                    <td style="border: none; text-align: right;font-size:16px;"><span>{{ __('messages.nfc.paid_amount') }}:</span></td>
                    <td style="border: none; text-align: right;font-size:16px;color:gray;">{{ $nfcOrder->nfcTransaction->amount ?? '0' }}</td>
                </tr>
                <tr>
                    <td style="border: none; text-align: right;font-size:16px;"><span>{{ __('messages.nfc.paid_on') }}:</span></td>
                    <td style="border: none; text-align: right;font-size:16px;color:gray;">{{ $nfcOrder->created_at->format('d/m/Y') }}</td>
                </tr>
                <tr>
                    <td style="border: none; text-align: right;font-size:16px;"><span>{{ __('messages.payment_type') }}:</span></td>
                    <td style="border: none; text-align: right;font-size:16px;color:gray;"> {{ $nfcOrder->nfcTransaction
                        ? ucfirst(\App\Models\NfcOrders::PAYMENT_TYPE_ARR[$nfcOrder->nfcTransaction->type] ?? 'N/A')
                        : __('messages.placeholder.payment_failed') }}</td>
                </tr>
                <tr>
                    <td style="border: none; text-align: right;font-size:16px;"><span>{{ __('messages.nfc.transaction_id') }}:</span></td>
                    <td style="border: none; text-align: right; word-break: break-word;font-size:16px;color:gray;">{{ $nfcOrder->nfcTransaction->transaction_id ?? 'N/A' }}</td>
                </tr>
            </table>
        </td>
    </tr>
      ...
      <table style="width:100%; border-collapse:collapse; margin-top:10px;">
        <thead>
          <tr style="background:#f0f4fa;">
            <th align="right" style="padding:14px 28px; font-weight:700; font-size:15px; color:#153563; border:none;">{{ __('messages.nfc.item') }}</th>
