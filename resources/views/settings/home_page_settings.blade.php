      ...
      <div class="w-100">
        ...
        <div class="card-body border-top p-3">
          ...
          <div class="row mb-5 mt-10">
                ...
                <div class="row">
                  <div class=" col-sm-6 col-12">
                    <div class="form-group mb-3">
                      ...
                      <label class="form-check form-switch form-check-solid form-switch-sm d-flex cursor-pointer">
                        <input type="checkbox" name="is_front_page" class="form-check-input" value="1"
                  ...
                  <div class="col-sm-6 col-12">
                    <div class="form-group mb-3">
                      ...
                      <label class="form-check form-switch form-check-solid form-switch-sm d-flex cursor-pointer">
                        <input type="checkbox" name="is_cookie_banner" class="form-check-input" value="1"
                  ...
                  <div class="col-sm-6 col-12">
                    <div class="form-group mb-3">
                      ...
                      <label class="form-check form-switch form-switch-sm cursor-pointer">
                        <input type="checkbox" name="register_enable" class="form-check-input" value="1"
                          {{ $setting['register_enable'] == '1' ? 'checked' : '' }} id="registerEnable">
                        <span class="form-check-label text-gray-600"
                  ...
                  <div class="col-sm-6 col-12">
                    <div class="form-group mb-3">
                      ...
                      <label class="form-check form-switch form-switch-sm cursor-pointer">
                        <input type="checkbox" name="user_verified_email" class="form-check-input" value="1"
                          {{ $setting['user_verified_email'] == '1' ? 'checked' : '' }} id="userVerfiedEnable">
                        <span class="form-check-label text-gray-600"
                  ...
                  <div class="col-sm-6 col-12">
                    <div class="form-group mb-3">
                      ...
                      <label class="form-check form-switch form-switch-sm cursor-pointer">
                        <input type="checkbox" name="captcha_enable" class="form-check-input" value="1"
                          {{ $setting['captcha_enable'] == '1' ? 'checked' : '' }} id="">
                        <span class="form-check-label text-gray-600"
                  ...
                  <div class="col-sm-6 col-12">
                    <div class="form-group mb-3">
                      ...
                      <label class="form-check form-switch form-switch-sm cursor-pointer">
                        <input type="checkbox" name="register_mail" class="form-check-input" value="1"
                          {{ $setting['register_mail'] == '1' ? 'checked' : '' }} id="">
                        <span class="form-check-label text-gray-600"
                  ...
                  <div class="col-sm-6 col-12">
                    <div class="form-group mb-3">
                      ...
                      <label class="form-check form-switch form-switch-sm cursor-pointer">
                        <input type="checkbox" name="phone_number_required" class="form-check-input" value="1"
                          {{ $setting['phone_number_required'] == '1' ? 'checked' : '' }} id="">
                        <span class="form-check-label text-gray-600"
                  ...
                  <div class="col-sm-6 col-12">
                    <div class="form-group mb-3">
                      ...
                      <label class="form-check form-switch form-switch-sm cursor-pointer">
                        <input type="checkbox" name="show_referral_code" class="form-check-input" value="1"
                          {{ $setting['show_referral_code'] == '1' ? 'checked' : '' }} id="">
                        <span class="form-check-label text-gray-600"
            ...
            <div class="row row-gap-24px mt-5">
              <div class="">
                <div class="row">
                  <div class="col">
                          ...
                          <span class="picker-edit rounded-circle text-gray-500 fs-small" data-bs-toggle="tooltip"
                            ...
                            <label>
                              ...
                              <input type="file" id="appLogo" name="app_logo" class="image-upload d-none"
                                accept="image/*" data-preview-id="appLogoPreview" />
                            </label>
                          </span>
                        </div>
                      </div>
                          ...
                          <span class="picker-edit rounded-circle text-gray-500 fs-small" data-bs-toggle="tooltip"
                            ...
                            <label>
                              ...
                              <input type="file" id="favicon" name="favicon" class="image-upload d-none"
                                accept="image/*" data-preview-id="faviconPreview" />
                            </label>
                          </span>
                        </div>
                      </div>
                  ...
                  <div class="col mb-3">
                    <div class="mb-3 form-group" io-image-input="true">
                      ...
                      <div class="d-block">
                        <div class="image-picker">
                          <div class="image previewImage" id="reigisterPreview"
                          ...
                          <span class="picker-edit rounded-circle text-gray-500 fs-small" data-bs-toggle="tooltip"
                            ...
                            <label>
                              ...
                              <input type="file" id="registerImage" name="register_image"
                                class="image-upload d-none" accept="image/*" data-preview-id="reigisterPreview" />
                            </label>
                          </span>
                        </div>
                      </div>
                  ...
                  <div class="col-6">
                    <div class="mb-3" io-image-input="true">
                      ...
                      <div class="d-block">
                        <div class="image-picker">
                          <div class="image previewImage" id="appDashboardLogoPreview"
                          ...
                          <span class="picker-edit rounded-circle text-gray-500 fs-small" data-bs-toggle="tooltip"
                            ...
                            <label>
                              ...
                              <input type="file" id="dashboardLogo" name="dashboard_logo"
                                ...
                                data-preview-id="appDashboardLogoPreview" />
                            </label>
                          </span>
                        </div>
                      </div>
