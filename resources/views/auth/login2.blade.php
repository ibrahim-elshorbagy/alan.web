      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
          <div class="col-11 col-sm-9 col-md-6 col-lg-5 col-xl-4">
            ...
            <div class="bg-white p-4 p-sm-5 modern-login-card"
              ...
              <form method="POST" action="{{ route('login') }}">
                ...
                <div
                  class="pt-2 mb-4 d-flex flex-column flex-sm-row justify-content-sm-between align-items-start align-items-sm-center gap-0">
                  <label class="modern-checkbox d-flex align-items-center m-0 order-1"
                    ...
                    <span class="form-check-label @if (getLanguageByKey(checkFrontLanguageSession()) == 'Arabic' ||
                            getLanguageByKey(checkFrontLanguageSession()) == 'Persian') me-2 @endif"
                ...
                <div class="mb-4 mb-md-5">
                  <button type="submit" class="btn w-100 text-white fw-bold border-0 modern-login-btn"
                ...
                @if (getSuperAdminSettingValue('register_enable') ||
                        (config('app.google_client_id') && config('app.google_client_secret') && config('app.google_redirect')) ||
                        (config('app.facebook_app_id') && config('app.facebook_app_secret') && config('app.facebook_redirect')))
                ...
                @if (getSuperAdminSettingValue('register_enable'))
                  <div class="text-center mb-4 p-3"
                    ...
                    <a href="{{ route('register') }}" class="modern-link"
                ...
                <div class="d-flex flex-column flex-md-row gap-3 @if (!getSuperAdminSettingValue('register_enable')) pt-3 @endif">
                  @if (config('app.google_client_id') && config('app.google_client_secret') && config('app.google_redirect'))
                    <a href="{{ route('social.login', 'google') }}"
                      class="btn google-btn py-3 d-flex align-items-center justify-content-center border shadow-sm text-dark flex-fill modern-social-btn"
                      ...
                      <span
                        style="font-size: 15px; font-weight: 600;">{{ __('messages.placeholder.login_via_google') }}</span>
                    </a>
                  @endif
