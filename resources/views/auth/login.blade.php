...
@section('content')
  <div class="login-section bg-white overflow-hidden position-relative h-100">
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-12 p-0 d-flex flex-column justify-content-center login-section"
            ...
            <div class="row element">
              ...
              <form method="POST" action="{{ route('login') }}">
                ...
                <div class="mb-sm-7 mb-4 form-check element">
                  <input type="checkbox" class="form-check-input form-solid" id="remember" name="remember"
                    @if (\Cookie::has('remember')) checked @endif>
                  ...
                  <div class="col-6">
                    @if (config('app.google_client_id') && config('app.google_client_secret') && config('app.google_redirect'))
                      <a href="{{ route('social.login', 'google') }}"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="27"
                          viewBox="0 0 48 48">
                          <path fill="#FFC107"
