      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
          <div class="col-11 col-sm-9 col-md-6 col-lg-5 col-xl-4">
            ...
            <div class="bg-white p-4 p-sm-5 modern-reset-card"
              ...
              <h1 class="text-center mb-4 fs-3 fw-bold" style="color: #1f2937; font-size: 1.5rem;">
                {{ __('messages.common.forgot_password') . ' ?' }}</h1>
              ...
              <form class="form w-100" method="POST" action="{{ route('password.update') }}">
                ...
                <div class="mb-4">
                  ...
                  <input id="email" class="form-control modern-input" value="{{ old('email', $request->email) }}"
                  ...
                  @if ($errors->has('email'))
                    <div class="text-danger small mt-2" style="font-size: 13px; font-weight: 500;">
                ...
                <div class="mb-4">
                  ...
                  <div class="position-relative">
                    <input id="password" class="form-control modern-input" type="password" name="password" required
                      autocomplete="off"
                      style="padding: 8px 13px; border: 2px solid #e5e7eb; border-radius: 12px; font-size: 16px; background: #fafbfc; transition: all 0.3s ease;" />
                  </div>
                ...
                <div class="mb-4">
                  ...
                  <div class="position-relative">
                    <input class="form-control modern-input" type="password" id="password_confirmation"
                ...
                <div class=" d-flex flex-column flex-md-row gap-3">
                  <button type="submit" class="btn text-white fw-bold border-0 modern-reset-btn flex-fill"
                  ...
                  <a href="{{ route('login') }}"
                    ...
                    style="border: 2px solid #e5e7eb; border-radius: 12px; font-size: 16px; transition: all 0.3s ease; background: #ffffff; color: #374151; font-weight: 600;">
            ...
            <div class="text-center mt-3 mt-md-3 copy-right">
              <div class="copyright text-black" style="font-size: 14px;">
                ...
                <a href="{{ route('home') }}" class="font-weight-bold ms-1"
