                ...
                <div class="row">
                  ...
                  @if ($vcard->location)
                    <div class="col-sm-6">
                      <div class="contact-box d-flex align-items-center">
                        <div class="contact-icon d-flex justify-content-center align-items-center">
                          <img src="{{ asset('assets/img/vcard27/location.svg') }}" alt="" />
                        </div>
                        <div class="contact-desc">
                    ...
                    <div>
                      <div class="service-card h-100">
                        ...
                        <div class="text-center card-body p-0">
                          ...
                          <p class="card-text description-text text-gray-100 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    ...
                    <div class="col-sm-6">
                      <div class="service-card h-100">
                        ...
                        <div class="card-body text-center p-0">
                          <h3 class="card-title text-black mb-10" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            {{ ucwords($service->name) }}
                          </h3>
                          <p class="mb-0 description-text text-gray-100 text-center {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                ...
                <div class="">
                  <div class="product-card card">
                    ...
                    <div class="product-desc card-body p-3 text-center position-relative z-index-1">
                      <h3 class="text-black mb-3" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        {{ $product->name }}
                      </h3>
                  ...
                  <div>
                    <div class="testimonial-card card">
                      ...
                      <div class="card-body p-0">
                        <div class="text-center">
                          <h3 class="text-black  mb-0" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                          ...
                          <div class="d-flex gap-sm-3 gap-2 justify-content-between">
                            ...
                            <p class="desc text-gray-100 mb-0 {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}"
                              @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
      ...
      @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
        <div class="qr-code-section pt-50  position-relative">
          <div class="qr-code-main px-30">
            ...
            <div
              class="qr-code d-flex flex-column flex-sm-row justify-content-center gap-3 flex-wrap flex-sm-nowrap mx-auto align-items-center"
              @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            ...
            <div class="">
              <div class="business-hour-card row justify-content-center">
                ...
                @foreach ($businessDaysTime as $key => $dayTime)
                  <div class="col-sm-6">
                    <div class="business-hour" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            ...
            <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
              ...
              @if (empty($userSetting['hide_stickybar']))
                <div
                  ...
                  <button type="button" class="vcard27-btn-group vcard27-share vcard27-sticky-btn mb-3 px-2 py-1"><i
