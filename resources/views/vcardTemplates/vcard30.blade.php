    ...
    <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
      ...
      <div class="profile-section pt-40 px-30" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
        ...
        <div class="card d-flex flex-column gap-3 flex-sm-row align-items-sm-end align-items-center overflow-hidden">
          ...
          <div class="card-body text-center position-relative p-0 pb-3">
          ...
          <div class="d-flex flex-wrap justify-content-center">
            <div
              ...
              @foreach (getSocialLink($vcard) as $value)
                <span class="social-icon d-flex justify-content-center align-items-center text-white cursor-pointer">
                  {!! $value !!}
                </span>
              @endforeach
            </div>
                ...
                <div class="col-sm-6">
                  <div class="contact-box d-flex flex-sm-column flex-row align-items-center position-relative">
                    ...
                    <div class="contact-desc">
                      <a href="mailto:{{ $vcard->email }}" class="text-dark fw-5 word-wrap">{{ $vcard->email }}</a>
                    </div>
                  </div>
                </div>
              @endif
                      ...
                      <div class="service-card h-100 align-items-center">
                        <div class="card-img d-flex justify-content-center align-items-center mx-auto">
                          <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                            ...
                            <img src="{{ $service->service_icon }}" alt="branding" loading="lazy" class="w-100" />
                          </a>
                        </div>
                        <div class="card-body p-0 text-center">
                          ...
                          <p class="mb-0 fs-14 description-text text-white {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                      ...
                      <div class="col-sm-6 mb-sm-0 mb-40">
                        <div class="service-card h-100  align-items-center">
                          ...
                          <div class="card-body p-0 text-center">
                            ...
                            <p class="mb-0 fs-14 text-white {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
                              @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                              {!! \Illuminate\Support\Str::limit($service->description, 170, '...') !!}
                            </p>
                          </div>
                ...
                @foreach ($vcard->testimonials as $testimonial)
                  <div>
                    <div class="testimonial-card card">
                      ...
                      <div class="card-body p-0 text-center">
                        <p class="desc mb-4 fs-14 text-center text-dark {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}"
                          @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        ...
                        <div class="d-flex align-items-center justify-content-center gap-3"
                          ...
                          <h5 class="text-primary mb-0" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
      ...
      @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
        <div class="qr-code-section px-30 pt-50 position-relative">
          ...
          <div class="qr-code d-flex justify-content-center align-items-center flex-wrap flex-sm-nowrap"
            ...
            <div class="text-center ps-sm-4 ps-0">
                  ...
                  @if (!empty($vcard->privacy_policy) || !empty($vcard->term_condition))
                    <div class="col-12 mb-4">
                      ...
                      <label class="form-check-label" for="privacyPolicyCheckbox">
                        <span class="text-dark fs-14">{{ __('messages.vcard.agree_to_our') }}</span>
