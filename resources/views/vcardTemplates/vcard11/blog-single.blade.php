      ...
      <section class="blog-section">
        <div class="row">
          <div class="col-lg-12">
            <div class="blog-post mb-4">
              <div class="section-heading mb-4">
                <div class="d-flex justify-content-end text-align-end">
                  <a class="btn btn-primary" role="button" href="{{ url()->previous() }}">
                ...
                <div class="ps-4">
                  ...
                  <span class="fs-12 text-white">
                    {{ \Carbon\Carbon::parse($blogSingle->created_at)->isoFormat('Do MMMM YYYY') }}</span>
                </div>
              </div>
              <div class="mb-4">
                <div id="carouselExampleIndicators1" class="carousel slide" data-bs-ride="carousel">
                  ...
                  <div class="carousel-inner">
                    <div class="carousel-item-blog-single active">
                      <img src="{{ $blogSingle->blog_icon }}" class="w-100 h-100 rounded object-fit-cover">
            ...
            {{--                                                    class="fas fa-reply mx-2"></i> Reply</a> --}}
            {{--                                    </div> --}}
            {{--                                </div> --}}
            {{--                            </div> --}}
            {{--                        </div> --}}
          ...
          {{--                                                    class="fas fa-calendar mx-2"></i> 27 Mar 2021 </span> --}}
          {{--                                    </div> --}}
          {{--                                </div> --}}
          {{--                                <div class="last-posts d-flex "> --}}
          {{--                                    <a href="#!" class="post d-block"> --}}
          ...
          {{--                                        <span class="d-flex align-items-center fs-12 text-white"><i --}}
          {{--                                                    class="fas fa-calendar mx-2"></i> 12 May 2021 </span> --}}
          {{--                                    </div> --}}
          {{--                                </div> --}}
          {{--                                <div class="last-posts d-flex "> --}}
          {{--                                    <a href="#!" class="post d-block"> --}}
          ...
          {{--                                        <span class="d-flex align-items-center fs-12 text-white"><i --}}
          {{--                                                    class="fas fa-calendar mx-2"></i> 22 Feb 2021 </span> --}}
          {{--                                    </div> --}}
          {{--                                </div> --}}
          {{--                            </div> --}}
