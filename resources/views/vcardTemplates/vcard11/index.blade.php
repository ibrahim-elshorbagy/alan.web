                    ...
                    <div class=" d-flex mb-2">
                      ...
                      <div class="d-flex ">
                        ...
                        <div class="d-flex flex-wrap">
                          @if ($vcard->phone)
                            <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}" class="ps-2 fs-14"
            ...
            @if ($vcard->services_slider_view)
              <div class="row services-slider-view">
                @foreach ($vcard->services as $service)
                  <div>
                    <div class="service-card card my-1 h-100">
                  ...
                  <div class="col-md-6 mb-sm-5 mb-4">
                    <div class="card flex-sm-row p-sm-4 p-3 h-100">
                      ...
                      <div class="card-body p-0 ps-sm-4 pt-sm-0 pt-3">
                        <a class="text-decoration-none text-white" href="{{ $service->service_url ?? '#' }}"
                          target="_blank">
                          ...
                          {{--                                        @endphp --}}
                          <p
                            class="card-text fs-14  mb-0 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
        ...
        @if ((isset($managesection) && $managesection['products']) || empty($managesection))
          <section class="services-section pt-30">
            <div class="section-heading mb-5">
              ...
              <div class="text-end ">
                <a class="fs-6 ps-4 text-decoration-underline text-light"
                    ...
                    <div class="card flex-sm-row p-sm-4 p-3 h-100">
                      ...
                      <div class="card-body p-0 ps-sm-4 pt-sm-0 pt-3">
                        ...
                        @elseif($product->price)
                          <p class=" fs-14 pb-4 mb-0">{{ getUserCurrencyIcon($vcard->user->id) . ' ' . $product->price }}
                          </p>
                        @endif
                        <div class="pb-3">
          ...
          <section class="testimonials-section position-relative mt-4 ">
            ...
            <div class="slick-slider">
              @foreach ($vcard->testimonials as $testimonial)
                <div
                  class="col element element-1 @if ($vcard->testimonials->count() == 1) custom-margin-testimonial @endif h-100 m-0 mt-3 ">
                  ...
                  <div class="card testimonial-2card-custom  mb-3 me-4 flex-sm-row p-4 h-100">
                    ...
                    <div class="card-body p-0 ps-sm-4 pt-sm-0 pt-3">
                      ...
                      <p
                        class="card-text fs-14 {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }} mb-0">
          ...
          <nav>
            <div class="row insta-toggle">
              <div class="nav nav-tabs px-0 border-0" id="nav-tab" role="tablist">
                <button
                  class="d-flex align-items-center justify-content-center py-2 border-0 active postbtn instagram-btn text-center"
                ...
                <button
                  class="d-flex align-items-center justify-content-center py-2 border-0 instagram-btn reelsbtn text-center"
                  ...
                  <div class="client-img">
                    @if ($file->type == App\Models\Gallery::TYPE_IMAGE)
                      <a href="{{ $file->gallery_image }}" data-lightbox="gallery-images"><img
                          src="{{ $file->gallery_image }}" class="w-100 h-100 object-fit-cover rounded"></a>
                    @elseif($file->type == App\Models\Gallery::TYPE_FILE)
                      <a id="file_url" href="{{ $file->gallery_image }}" class="gallery-link gallery-file-link"
                        ...
                        @endif
                        @if ($extension == 'xls')
                          <img src="{{ asset('assets/images/xls.png') }}" class="w-100 h-100 object-fit-cover rounded">
                        @endif
                        @if ($extension == 'csv')
