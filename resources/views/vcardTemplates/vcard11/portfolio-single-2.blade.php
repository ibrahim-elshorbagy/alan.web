          ...
          <div class="row">
            <div class="col-md-4 col-sm-6 mb-4">
              <div class="portfolio-img">
                <img src="{{ asset('assets/img/vcard11/portfolio-2.jpeg') }}" class="w-100 h-100 object-fit-cover">
            ...
            <div class="col-md-4 col-sm-6 mb-4">
              <div class="portfolio-img">
                <img src="{{ asset('assets/img/vcard11/portfolio-3.jpeg') }}" class="w-100 h-100 object-fit-cover">
            ...
            <div class="col-md-4 col-sm-6 mb-4">
              <div class="portfolio-img">
                <img src="{{ asset('assets/img/vcard11/portfolio-4.jpeg') }}" class="w-100 h-100 object-fit-cover">
            ...
            <div class="col-md-4 col-sm-6 mb-4">
              <div class="portfolio-img">
                <img src="{{ asset('assets/img/vcard11/portfolio-5.jpeg') }}" class="w-100 h-100 object-fit-cover">
            ...
            <div class="col-md-4 col-sm-6 mb-4">
              <div class="portfolio-img">
                <img src="{{ asset('assets/img/vcard11/portfolio-6.jpeg') }}" class="w-100 h-100 object-fit-cover">
          ...
          <div class="col-sm-6 ">
            <div class="prev-btn d-flex border-right position-relative">
              <a href="../pages/{{ route('vcard11.portfolio-single') }}" class="fs-12 w-100 p-4"><i
                  class="fas fa-caret-left mx-2"></i><span class="text-white">Prev - Project Title</span></a>
              <div class="prev-btn-content">
                <img src="{{ asset('assets/img/vcard11/portfolio-1.jpeg') }}" class="w-100 h-100 object-fit-cover">
              </div>
            </div>
          </div>
          <div class="col-sm-6 text-end">
            <div class="next-btn d-flex position-relative">
              <a href="../pages/{{ route('vcard11.portfolio-single-2') }}" class="fs-12 w-100 p-4"><span
                  class="text-white">Next - Project Title</span><i class="fas fa-caret-right ms-2"></i></a>
