                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                      ...
                      <div class="carousel-inner">
                        <div class="carousel-item active">
                          <img src="{{ $blog->blog_icon }}" class="w-100 h-100 object-fit-cover rounded">
                        </div>
                      </div>
            ...
            <div class="col-lg-4">
              <div class="blog-right-section">
                ...
                <div class="last-post-section mb-4">
                  ...
                  @foreach ($vcard->blogs->reverse() as $blog)
                    <?php
                    $vcardBlogUrl = route('vcard.show.blog-single', ['alias' => $vcard->url_alias, 'id' => $blog->id]);
                    ?>
                    <div class="last-posts d-flex">
                      <a href="{{ $vcardBlogUrl }}" class="post d-block">
                        <img src="{{ $blog->blog_icon }}" class="w-100 h-100 object-fit-cover rounded">
                      </a>
                      @php
                      ...
                      <div class="last-post-desc ps-3">
                        <a href="{{ $vcardBlogUrl }}" class="fs-14 text-white">{{ $blog->title }}</a>
                        <span class="d-flex align-items-center fs-12 text-white"><i class="fas fa-calendar mx-2"></i>
