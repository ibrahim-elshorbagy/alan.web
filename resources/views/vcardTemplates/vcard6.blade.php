      ...
      <div class="main-bg p-0 allSection collapse show">
        <div class="head-img position-relative">
          ...
          @elseif($vcard->cover_type == 1)
            @if (strpos($vcard->cover_url, '.mp4') !== false ||
              ...
              <video height="400px" class="cover-video banner-image {{ $coverClass }}" loop autoplay playsinline
          ...
          @elseif ($vcard->cover_type == 2)
            <div class="youtube-link-6">
              <iframe
                ...
                class="cover-video banner-image {{ $coverClass }}" frameborder="0" allow="autoplay; encrypted-media"
                allowfullscreen>
              </iframe>
            </div>
          @endif
        ...
        <div class="position-relative">
          ...
          <div class="container @if ($vcard->cover_type == 2) main-profile-div @endif">
            <div class="main-profile position-relative @if ($vcard->cover_type == 2) profile-margin @endif">
                  ...
                  <div class="row d-flex mb-4 justify-content-center">
                    ...
                    <div class="col-md-8 user-details-section">
                      <div>
                        ...
                        <p><span class="small-company d-block text-light">{{ ucwords($vcard->company) }}</span>
                        </p>
                      </div>
                    ...
                    @if (checkFeature('custom-links') && $customLink->isNotEmpty())
                      <div class="custom-link-section">
                        <div class="custom-link d-flex flex-wrap justify-content-center pb-4 pt-4 w-100 ">
                    ...
                    <div class="row">
                      ...
                      @if ($vcard->alternative_email)
                        <div class="col-sm-6 mb-4">
                          <div class="card border-0 bg-transparent">
                            <div class="event-icon text-white">
                              <img src="{{ asset('/img/vcard6/alter-image.png') }}" class="img-fluid me-3"
                        ...
                        <div class="col-sm-6">
                          <div class="card service-card h-100">
                            ...
                            <div class="card-body px-0 py-3 text-white">
                              <h5 class="card-title" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                {{ ucwords($service->name) }}</h5>
                              <p class="card-text text-gray-200 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
                                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                {!! \Illuminate\Support\Str::limit($service->description, 170, '...') !!}</p>
                            </div>
                          </div>
                          ...
                          <div class="gallery-profile">
                            ...
                            @elseif($file->type == App\Models\Gallery::TYPE_FILE)
                              <a id="file_url" href="{{ $file->gallery_image }}"
                                class="gallery-link gallery-file-link" loading="lazy" target="_blank">
                        ...
                        <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                          ...
                          <div class="card  w-100 h-100 bg-transparent border-0 text-light">
                            ...
                            <div class="product-details mt-3">
                              <h4 @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>{{ $product->name }}</h4>
                              <p class="mb-2 overflow-scroll" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                {{ $product->description }}
                              </p>
                      ...
                      <div class="col-6">
                        <div class="card  w-100 h-100 bg-transparent border-0 text-light">
                          ...
                          <div class="testimonial-user d-flex justify-content-center flex-column align-center mt-3">
                            ...
                            <span class="user-designation text-center"
                              @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif></span>
                          </div>
                        </div>
                      </div>
                    @endforeach
                    ...
                    <div class="col-6 mb-2">
                      <div class="card blog-card p-4 border-0 w-100 h-100">
                        <div class="blog-image">
                          <a href="{{ $vcardBlogUrl }}">
                            <img src="{{ $blog->blog_icon }}" alt="profile" class="w-100 object-fit-contain"
                              loading="lazy" />
                          </a>
                        </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-12 mb-3 input-group">
                              <span class="input-group-text contact-icon bg-transparent border-end-0"
                                id="basic-addon1"><i class="far fa-user font-clr"></i></span>
                              <input type="text" name="name"
                                class="form-control contact-input bg-transparent border-start-0" id="name"
                            ...
                            <div class="col-12 mb-3 input-group">
                              <span class="input-group-text bg-transparent contact-icon border-end-0"
                                id="basic-addon1"><i class="far fa-envelope font-clr"></i></span>
                              <input type="text" name="email"
                                class="form-control contact-input border-start-0 bg-transparent" id="email"
                            ...
                            <div class="col-12 mb-3 input-group">
                              <span class="input-group-text bg-transparent contact-icon border-end-0"
                                id="basic-addon1"><i class="fas fa-phone font-clr"></i></span>
                              <input type="tel" name="phone"
                                class="form-control contact-input border-start-0 bg-transparent" id="phone"
                        ...
                        <div class="col-sm-6">
                          <div class="row">
                            <label for="basic-url" class="form-label mb-0">{{ __('messages.user.your_name') }}
                              <span class="text-danger">*</span></label>
                            <div class="col-12 mb-3 input-group">
                              <span class="input-group-text contact-icon bg-transparent border-start-0"
                                id="basic-addon1"><i class="far fa-user font-clr"></i></span>
                              <input type="text" name="name"
                            ...
                            <label for="basic-url" class="form-label mb-0">{{ __('messages.user.email') }}
                              <span class="text-danger">*</span></label>
                            <div class="col-12 mb-3 input-group">
                              <span class="input-group-text bg-transparent contact-icon border-start-0"
                                id="basic-addon1"><i class="far fa-envelope font-clr"></i></span>
                              <input type="text" name="email"
          ...
          <div
            ...
            <div class="sub-btn d-none">
              <div class="sub-btn-div  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
                ...
                @endif
                @if (empty($vcard->hide_stickybar))
                  <div class="{{ isset($vcard->whatsapp_share) ? 'vcard6-btn-group' : 'stickyIcon' }}">
                    <button type="button"
