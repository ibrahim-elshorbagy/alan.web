  ...
  <div class="container p-0">
    ...
    <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
      ...
      <div class="profile-section position-relative pt-40 px-30">
        <div class="card-wrapper">
          <div
            class="profile-card card overflow-hidden flex-sm-row flex-column align-items-center position-relative gap-4 justify-content-sm-start"
            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            <div
                        ...
                        <div class="card-wrapper">
                          <div class="service-card h-100">
                            ...
                            <div class="card-body">
                              ...
                              <p class="card-text description-text text-black text-center {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
                                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        ...
                        <div class="card-wrapper h-100">
                          <div class="service-card card h-100 ">
                            ...
                            <div class="card-body  text-center">
                              ...
                              <p class="description-text mb-0 text-black text-center  {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
                                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                  ...
                  <div class="testimonial-box">
                    <div class="testimonial-card">
                      ...
                      <div class="card-body p-0 text-sm-start text-center">
                        <p class="text-black desc text-center {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}"
                          @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                          ...
                          <div>
                            <h5 class="fw-5 text-primary mb-0" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                  ...
                  <div class="card-wrapper">
                    <div class="product-card card">
                      ...
                      <div class=" product-desc card-body text-center">
                        <h3 class="text-black fw-5 text-center" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                          {{ $product->name }}</h3>
                        <div class="product-amount text-primary text-decoration-underline fw-bold text-center">
                          @if ($product->currency_id && $product->price)
                            <span class="fw-6 text-primary text-decoration-underline"
      ...
      @if ($vcard->enable_contact)
        <div class="add-to-contact-section">
          <div class="text-center d-flex align-items-center justify-content-center"
            ...
            @else
              <a href="{{ route('add-contact', $vcard->id) }}" class="add-contact-btn btn btn-gradient"><i
