                                    ...
                                    <div class="card-wrapper">
                                        <div class="product-card card">
                                            ...
                                            <div class=" product-desc card-body text-center">
                                                ...
                                                <div
                                                    class="product-amount text-primary text-decoration-underline fw-bold text-center">
                                                    @if ($product->currency_id && $product->price)
                                                        <span
                                                            class="fw-6 text-primary text-decoration-underline">{{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
                                                    @elseif($product->price)
                                                        <span
                                                            class="fw-6 text-primary text-decoration-underline">{{ currencyFormat($product->price, 2, getUserCurrencyIcon($vcard->user->id)) }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
