    ...
    <div
      ...
      <div class="vcard-three__banner w-100 position-relative ">
        ...
        @if ($vcard->cover_type == 0)
          <img src="{{ $vcard->cover_url }}" class="img-fluid banner-image {{ $coverClass }}" alt="banner"
            loading="lazy" />
        @elseif($vcard->cover_type == 1)
          @if (strpos($vcard->cover_url, '.mp4') !== false ||
            ...
            <video class="cover-video img-fluid banner-image {{ $coverClass }}" loop autoplay playsinline
      ...
      <div class="vcard-three__profile-details py-3 px-3 @if ($vcard->cover_type == 2) profile-desc-margin @endif">
        ...
        <span class="profile-designation text-center d-block text-white p-2">{{ ucwords($vcard->occupation) }}</span>
        <span class="profile-designation text-center d-block text-white">{{ ucwords($vcard->job_title) }}</span>
              ...
              <div class="row g-3">
                    ...
                    <div class="card event-card p-2 h-100 border-0 flex-sm-row flex-column align-items-center">
                      ...
                      <div class="event-detail ms-sm-3 mt-sm-0 mt-4 text-start">
                        ...
                        <a href="mailto:{{ $vcard->email }}"
                          class="event-name text-center mb-0 text-white text-decoration-none">{{ $vcard->email }}</a>
                      </div>
                    </div>
                  </div>
                @endif
                @if ($vcard->alternative_email)
                  <div class="col-sm-6 col-12">
                    <div class="card event-card p-2 h-100 border-0 flex-sm-row flex-column align-items-center">
                      <span class="event-icon d-flex justify-content-center align-items-center">
                        <img src="{{ asset('assets/img/vcard3/vcard3-email.png') }}" alt="email" height="21"
                          width="28" />
                      </span>
                      <div class="event-detail ms-sm-3 mt-sm-0 mt-4 text-start">
                        <h6 class="text-white text-sm-start text-center">
                        ...
                        <a href="mailto:{{ $vcard->alternative_email }}"
                          class="event-name text-center mb-0 text-white text-decoration-none">{{ $vcard->alternative_email }}</a>
                      </div>
                    </div>
                  </div>
                @endif
                    ...
                    <div class="col-sm-6">
                      <div class="card service-card h-100">
                        ...
                        <div class="card-body pt-3 p-0">
                          ...
                          <p class="card-text text-gray-500 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            {!! \Illuminate\Support\Str::limit($service->description, 170, '...') !!}</p>
                        </div>
                      </div>
                  ...
                  <div class="col-12 h-100">
                    <div class="card testimonial-card p-3 border-0 h-100">
                      <div
                        ...
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        <img src="{{ $testimonial->image_url }}" alt="profile" class="rounded-circle ms-2"
                          loading="lazy" />
                        <div class="user-details d-flex justify-content-center flex-column ms-sm-3 mt-sm-0 mt-2 h-100">
                          <span
                            class="user-name text-white text-center  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') text-sm-end" @endif>{{ ucwords($testimonial->name) }}</span>
                                                    <span
                                                        class="user-designation
                            text-white text-sm-start text-center"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif></span>
                        </div>
                      </div>
                      <p class="review-message mb-0 text-center h-100 {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
