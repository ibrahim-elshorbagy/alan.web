              ...
              <span class="social-icon d-flex justify-content-center align-items-center position-relative">
                ...
                <div class="play-svg d-flex">
                  <svg width="50" height="50" viewBox="0 0 50 50" fill="none"
                    ...
                    <defs>
                      <linearGradient id="paint0_linear_654_3" x1="33.5" y1="40" x2="4"
                        y2="-3.68222e-06" gradientUnits="userSpaceOnUse">
                      ...
                      <div class="card-wrapper">
                        <div class="service-card h-100">
                          ...
                          <div class="card-body w-100">
                            ...
                            <p class="mb-0 text-white text-center description-text {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
                              @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
      ...
      @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
        @if (checkFeature('appointments') && $vcard->appointmentHours->count())
          <div class="pt-50 position-relative">
            ...
            <div class="appointment-section pt-60 pb-60 px-30" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    ...
                    <div class="product-card card">
                      <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                        ...
                        <div class="product-desc card-body w-100 position-relative overflow-hidden">
                          <div
                            class="d-flex justify-content-between align-items-center mb-1 flex-column gap-2 overflow-hidden">
                    ...
                    <div class="testimonial-card card">
                      ...
                      <div class="testimonial-content">
                        <div class="quote-left quote d-flex align-items-center justify-content-center">
                          <img src=" {{ asset('assets/img/vcard33/quote-left.svg') }}" alt="quote-left" />
                        </div>
                        <div class="quote-right quote d-flex align-items-center justify-content-center">
                          <img src=" {{ asset('assets/img/vcard33/quote-right.svg') }}" alt="quote-left" />
                        </div>
          ...
          <div class="card-wrapper">
            <div class="qr-code mx-auto position-relative">
              <div class="qr-content">
                <div
                  class="d-flex gap-3 align-items-center flex-wrap flex-sm-nowrap justify-content-center text-center text-sm-start"
                  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    ...
                    @if (isset($inquiry) && $inquiry == 1)
                      <div class="mb-3 mt-2">
                        <div class="wrapper-file-input">
                          ...
                          <small class="text-primary">{{ __('messages.file_supported') }}</small>
                        </div>
                        <div class="wrapper-file-section">
                          <div class="selected-files" id="selectedFilesSection" style="display: none;">
                            <h5>{{ __('messages.selected_files') }}</h5>
            ...
            <div class="map-section">
              <div class="map-content">
                ...
                <iframe width="100%" height="300px"
                  ...
                  scrolling="no" marginheight="0" marginwidth="0" style="border-radius:0 0 18px 18px;"></iframe>
              </div>
            </div>
          </div>
        @endif
