                                                    ...
                                                    <div
                                                        ...
                                                        <div class="product-amount lh-1 text-center fw-bold">
                                                            @if ($product->currency_id && $product->price)
                                                                <span
                                                                    class="product-amount text-center fw-bold text-primary">
                                                                    {{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
                                                            @elseif($product->price)
                                                                <span
                                                                    class="product-amount  text-center fw-5">{{ currencyFormat($product->price, 2, getUserCurrencyIcon($vcard->user->id)) }}</span>
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>
