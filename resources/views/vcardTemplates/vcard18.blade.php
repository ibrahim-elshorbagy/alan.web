    ...
    <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
      ...
      @if (checkFeature('social_links') && isset($vcard->socialLink) && getSocialLink($vcard))
        <div class="social-media d-flex justify-content-center pt-40 px-30 position-relative">
          ...
          <div class="social-icons  d-flex flex-wrap justify-content-center h-100 w-100 object-fit-cover fs-14">
                      ...
                      <div class="col-sm-6">
                        <div class="service-card h-100 card d-flex flex-column align-items-center"
                          ...
                          <div class="card-body text-center pb-0">
                            <h3 class="card-title fw-5 p-0" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                              {{ ucwords($service->name) }}
                            </h3>
                            <div class="description-text">
                              <p class="mb-0 text-gray-200   {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
                                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
          ...
          <div class="product-section bg-gray pt-50 px-20 position-relative">
                        ...
                        <div class="d-flex justify-content-center gap-2 flex-column">
                          ...
                          <div class="px-40">
                            @if ($product->currency_id && $product->price)
                              <span class="product-amount text-primary fw-5"
            ...
            <div class="text-center mt-5">
              <div class="text-center view-more btn-primary d-inline-flex gap-2 align-items-center">
                <a class="mb-0 fs-16" href="{{ $vcardProductUrl }}">{{ __('messages.analytics.view_more') }}</a>
              ...
              @foreach ($vcard->testimonials as $testimonial)
                <div>
                  ...
                  <div class="testimonial-card d-flex pb-1 flex-column gap-3">
                    <div class="position-relative testimonial-triangle">
                      <div class="card-body text-center">
                        <div class="quote-img quote-left-img mb-2">
                          <img src="{{ asset('assets/img/vcard18/quote-vcard18.png') }}" loading="lazy" />
                        </div>
                    ...
                    <div class="d-flex gap-2 align-items-center" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                      <div class="card-img">
                        <img src="{{ $testimonial->image_url }}" loading="lazy" />
                      </div>
                      <h3 class="fw-6 text-black mb-0" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
              ...
              @foreach ($businessDaysTime as $key => $dayTime)
                <div class="col-sm-6">
                  <div class="business-hour align-items-center">
                    ...
                    <div class="text-start d-flex gap-2" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                      <span
                ...
                <div class="col-sm-12 mx-auto">
                  <div class="position-relative">
                    ...
                    <span class="calendar-icon">
                      <img src=" {{ asset('assets/img/vcard18/calendar.svg') }}" loading="lazy" />
                    </span>
                  </div>
                </div>
              </div>
      ...
      <div class="add-to-contact-section mb-4">
        @if ($vcard->enable_contact)
          <div class="d-flex align-items-center justify-content-center"
            ...
            @else
              <a href="{{ route('add-contact', $vcard->id) }}" class="btn btn-primary add-contact-btn gap-2"><i
