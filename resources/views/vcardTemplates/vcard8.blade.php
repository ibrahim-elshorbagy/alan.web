  ...
  <div class="container p-0">
    ...
    <div
      ...
      <div class="vcard-eight__banner w-100 position-relative">
        ...
        @elseif($vcard->cover_type == 1)
          @if (strpos($vcard->cover_url, '.mp4') !== false ||
            ...
            <video height="400px" class="cover-video img-fluid banner-image position-relative {{ $coverClass }}" loop
              autoplay playsinline alt="background video" id="cover-video">
            ...
            <div class="language pt-4 me-2">
              <ul class="text-decoration-none">
                <li class="dropdown1 dropdown lang-list">
                  <a class="dropdown-toggle text-light lang-head text-decoration-none" data-toggle="dropdown"
          ...
          <div
            ...
            <div class="vcard-eight__position d-flex flex-column mx-4 position-relative">
              <div class="d-flex flex-column">
                ...
                <span class="avatar-designation text-white text-center p-1">{{ ucwords($vcard->occupation) }}</span>
                <span class="avatar-designation text-white text-center p-1">{{ ucwords($vcard->job_title) }}</span>
                <span class="avatar-company d-block text-white text-center ms-1">{{ ucwords($vcard->company) }}</span>
              </div>
            </div>
          </div>
        @endif
                  ...
                  <div class="row g-4">
                    ...
                    @if ($vcard->alternative_email)
                      <div class="col-sm-6 col-12">
                        <div
                          class="event-icon rounded-circle d-flex justify-content-center align-items-center mx-auto mb-2">
                          <img src="{{ asset('img/vcard8/alter-image.png') }}" alt="email" height="19"
                            width="25" />
                        </div>
                        <div class="event-details">
                          <span
                    ...
                    @if ($vcard->phone)
                      <div class="col-sm-6 col-12">
                        <div
                          class="event-icon rounded-circle d-flex justify-content-center align-items-center mx-auto mb-2">
                          <img src="{{ asset('img/vcard8/vcard8-phone.png') }}" alt="mobile" />
                        </div>
                        <div class="event-details">
                          <span
                    ...
                    @if ($vcard->alternative_phone)
                      <div class="col-sm-6 col-12">
                        <div
                          class="event-icon rounded-circle d-flex justify-content-center align-items-center mx-auto mb-2">
                          <img src="{{ asset('img/vcard8/alter-phone.png') }}" alt="mobile" />
                        </div>
                        <div class="event-details">
                          <span
                    ...
                    <div class="col-sm-6">
                      <div class="card service-card">
                        ...
                        <div class="card-body py-4">
                          <h5 class="card-title text-white" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            {{ ucwords($service->name) }}
                          </h5>
                          <p class="card-text text-white-50 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            {!! \Illuminate\Support\Str::limit($service->description, 170, '...') !!}</p>
                        </div>
                      </div>
                  ...
                  <a @if ($product->product_url) href="{{ $product->product_url }}" @endif target="_blank"
                    ...
                    <div class="card product-card p-3 border-0 w-100 card-height h-100">
                      <div class="product-profile">
                        <img src="{{ $product->product_icon }}" alt="profile" class="w-100 object-fit-contain"
                      ...
                      <div class="product-details mt-3">
                        ...
                        @if ($product->currency_id && $product->price)
                          <span class="text-white"
                            style="@if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') direction: rtl; text-align: right; display: block; @endif">{{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
                        @elseif($product->price)
                          <span class="text-white"
                            style="@if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') direction: rtl; text-align: right; display: block; @endif">{{ currencyFormat($product->price, 2, getUserCurrencyIcon($vcard->user->id)) }}</span>
                        @endif
                      </div>
                    </div>
                  </a>
                    ...
                    <div
                      ...
                      <div class="user-details d-flex flex-column mt-2">
                        <span class="user-name text-center"
                          @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>{{ ucwords($testimonial->name) }}</span>
                        <span class="user-designation text-center"></span>
                      </div>
                    </div>
                    <p class="review-message text-center mt-2 mx-auto {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}"
                      @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
          ...
          <nav>
            <div class="row insta-toggle">
              <div class="nav nav-tabs px-0" id="nav-tab" role="tablist">
                <button class="d-flex align-items-center justify-content-center py-2 active postbtn instagram-btn fs-2"
                ...
                <button class="d-flex align-items-center justify-content-center py-2 instagram-btn reelsbtn fs-2"
                    ...
                    <div class="card blog-card p-2 border-0 w-100 h-100 pt-5">
                      ...
                      <div class="blog-details">
                        <a href="{{ $vcardBlogUrl }}" class="text-decoration-none">
                          <h4 class=" text-center title-color p-3 mb-0 text-white">
                            {{ $blog->title }}</h4>
                        </a>
                      </div>
                    </div>
      ...
      <div class="w-100 d-flex justify-content-center  position-fixed" style="top:50%; left:0; z-index: 9999;">
        <div class="vcard-bars-btn position-relative @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') vcard-bars-btn-left @endif">
                ...
                <div class="{{ isset($vcard->whatsapp_share) ? 'vcard8-btn-group' : 'stickyIcon' }}">
                  ...
                  @if (!empty($vcard->enable_download_qr_code))
                    <a type="button"
                      ...
                      id="qr-code-btn" download="qr_code.png"><i class="fa-solid fa-qrcode fs-1"></i></a>
                  @endif
                  {{-- <a type="button"
