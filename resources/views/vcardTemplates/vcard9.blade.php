              ...
              <div class="row g-3">
                ...
                @if ($vcard->alternative_email)
                  <div class="col-sm-6 col-12">
                    <div class="card event-card px-3 py-4 h-100 border-0 flex-sm-row flex-column align-items-center">
                      <span class="event-icon d-flex justify-content-center align-items-center">
                        <img src="{{ asset('img/vcard9/vcard9-alternate-email.png') }}" alt="email"
                          height="26" width="32" />
                      </span>
                      <div class="event-detail ms-sm-3 mt-sm-0 mt-4">
                        <h6 class="text-sm-start text-center">
                      ...
                      <div class="card service-card">
                        ...
                        <div class="card-body py-4">
                          <h5 class="card-title" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            {{ ucwords($service->name) }}</h5>
                          <p class="card-text {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            {!! \Illuminate\Support\Str::limit($service->description, 170, '...') !!}</p>
                        </div>
                      </div>
                    ...
                    <div class="card testimonial-card p-3 border-0 w-100 h-100">
                      <div
                        ...
                        <div class="user-details d-flex flex-column ms-sm-3 mt-sm-0 mt-2">
                          <span
                            class="user-name text-center @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') text-sm-end" @endif>{{ ucwords($testimonial->name) }}</span>
                                                    <span class="user-designation
                            text-sm-start text-center"></span>
                        </div>
                      </div>
                      <p class="review-message mb-2 text-center mt-2 h-100 {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    ...
                    <div class="card blog-card p-2 border-0 w-100 h-100">
                      ...
                      <div class="blog-details p-3">
                        <a href="{{ $vcardBlogUrl }}" class="text-decoration-none">
                          <h4 class="text-center title-color p-3 mb-0 text-black">
                            {{ $blog->title }}</h4>
                        </a>
                      </div>
                    </div>
            ...
            <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
              ...
              @if (empty($vcard->hide_stickybar))
                <div class="{{ isset($vcard->whatsapp_share) ? 'vcard9-btn-group' : 'stickyIcon' }}">
                  <button type="button" class="vcard9-btn-group vcard9-share vcard9-sticky-btn mb-3   px-2 py-1"><i
