    ...
    <div
      ...
      <div class="profile-section pt-50 px-30 position-relative">
        ...
        <div class="profile-card bg-transparent d-flex gap-3 gap-sm-5 flex-sm-row flex-column align-items-center"
          ...
          <div
            ...
            <p class="fs-16 fw-5 lh-base text-primary mb-1 photo-title text-uppercase text-decoration-underline">
                    ...
                    <div class="details-item">
                      ...
                      <div class="detail-content">
                        ...
                        <div class="text-center position-relative z-2">
                          <a href="mailto:{{ $vcard->email }}" class="fs-14 fw-5 lh-base text-white mb-0 text-break">
                            {{ $vcard->email }}
                          </a>
                        </div>
                      </div>
                      ...
                      <div class="service-card h-100">
                        <div class="clip-img">
                          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="49" viewBox="0 0 20 49"
                            fill="none">
                            <path d="M5.09042 13.5243L3.45197 13.5243L3.45197 26.0779L5.06511 26.0779L5.09042 13.5243Z"
                              fill="#ffffff" />
                        ...
                        <div class="card-body text-center">
                          ...
                          <p class="mb-0 text-gray-100 description-text {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    ...
                    <div class="col-sm-6">
                      <div class="service-card h-100 flex-column d-flex">
                        ...
                        <div class="card-body text-center">
                          ...
                          <p class="mb-0 fs-14 text-gray-100 description-text {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            {!! \Illuminate\Support\Str::limit($service->description, 170, '...') !!}
                          </p>
                        </div>
                  ...
                  <div class="testimonial-card">
                    <div class="test position-relative z-2">
                      ...
                      <div class="test-content">
                        <h2 class="fw-semibold text-white text-decoration-underline  mb-3 text-center"
                          @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                          {{ ucwords($testimonial->name) }}
                        </h2>
                        <p class="lh-sm text-gray-100 mb-0 text-center {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}"
                          @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
      ...
      @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
        <div class="qr-section pt-50 px-30 position-relative">
          ...
          <div
            class="qr-code-wrapper d-flex justify-content-center align-items-center m-0 flex-column flex-sm-row gap-4"
            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
      ...
      @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
        <div class="v-card-section">
          <div class="position-relative pt-50 px-30">
            ...
            <p class="section-heading text-white fs-24 lh-base fw-semibold mx-auto mb-40px position-relative z-2">
        ...
        @if ($vcard->location_url && isset($url[5]))
          <div class="map-section pt-50 px-30 position-relative">
            ...
            <div class="map-content">
              <div class="content">
                <div class="d-flex gap-2 align-items-center p-2" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
              ...
              <iframe width="100%" height="300px" class="d-block"
                ...
                scrolling="no" marginheight="0" marginwidth="0" style="border-radius:0 0 5px 5px;"></iframe>
            </div>
          </div>
        @endif
