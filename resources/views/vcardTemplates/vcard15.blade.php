                    ...
                    <div class="contact-box">
                      ...
                      <div class="contact-desc">
                        <a href="tel:+{{ $vcard->alternative_region_code }} {{ $vcard->alternative_phone }}"
                          class="text-dark text-center fw-5" dir="ltr">+{{ $vcard->alternative_region_code }}
                          ...
                          <a href="{{ $service->service_url ?? 'javascript:void(0)' }}" class="text-decoration-none"
                            ...
                            <div class="service-card card h-100">
                              ...
                              <div class="card-body text-center">
                                ...
                                <p class="mb-0 text-gray description-text  {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
                                  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                          ...
                          <a href="{{ $service->service_url ?? 'javascript:void(0)' }}" class="text-decoration-none"
                            ...
                            <div class="service-card card h-100">
                              ...
                              <div class="card-body text-center">
                                ...
                                <p class="mb-0 text-gray {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
                                  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                  {!! \Illuminate\Support\Str::limit($service->description, 170, '...') !!}
                                </p>
                              </div>
                        ...
                        <div class="product-card card">
                          ...
                          <div
                            ...
                            <div class="product-title">
                              <h3 class="text-dark text-center" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                {{ $product->name }}
                              </h3>
                            </div>
            ...
            <div class="px-20">
              <div class="testimonial-slider">
                @foreach ($vcard->testimonials as $testimonial)
                  <div>
                    <div class="testimonial-card p-0" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                      <div class="card-body text-center position-relative">
                        ...
                        <div class="text-center">
                          <p class="text-gray mb-0 {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                  ...
                  <div>
                    <div class="blog-card card">
                      ...
                      <div class="card-body text-start">
                        ...
                        <div class="text-end mt-1  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') ms-0 @else ms-auto @endif">
                          <a href="{{ $vcardBlogUrl }}"
      ...
      @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
        @if ($vcard->businessHours->count())
          ...
          <div class="business-hour-section pt-50 position-relative">
            ...
            <div class="px-30">
              <div class="row justify-content-center" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                ...
                <form action="" id="enquiryForm" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    ...
                    @if (isset($inquiry) && $inquiry == 1)
                      <div class="mb-3 mt-2">
                        <div class="wrapper-file-input">
                          ...
                          </div> <small class="text-gray fw-5">{{ __('messages.file_supported') }}</small>
                        </div>
                    ...
                    <div class="col-12 text-center mt-4  d-flex justify-content-center">
                      <button class="contact-btn btn btn-primary d-flex align-items-center justify-content-center"
                        type="submit">
