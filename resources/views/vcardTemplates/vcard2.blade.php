      ...
      <div class="vcard-two__banner w-100 position-relative">
        ...
        @elseif($vcard->cover_type == 1)
          @if (strpos($vcard->cover_url, '.mp4') !== false ||
            ...
            <video class="cover-video img-fluid banner-image position-relative {{ $coverClass }}" loop autoplay
        ...
        @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
          <div class="vcard-two__event py-3 px-3 ms-3">
            ...
            @if ($vcard->alternative_email)
              <div class="event-details d-flex">
                <div class="event-image">
                  <img src="{{ asset('assets/img/vcard2/vcard2-email.png') }}" alt="email" height="20"
                    width="27" />
                </div>
                    ...
                    <div class="row">
                      <div class="col-sm-6 col-12 mb-sm-0 mb-4">
                        <div class="qr-profile d-flex justify-content-center">
                          <img src="{{ $vcard->profile_url }}" class="rounded-circle" alt="qr-profile"
                            loading="lazy" />
                        </div>
                      </div>
                      ...
                      <div class="card product-card p-3 border-0 w-100 h-100">
                        ...
                        <div class="product-details mt-3">
                          ...
                          @if ($product->currency_id && $product->price)
                            <span class="text-black product-price-{{ $product->id }}"
                ...
                @foreach ($vcard->testimonials as $testimonial)
                  <div class="col-12 p-2">
                    <div
                      ...
                      @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                      <div class="me-sm-3">
                        <p class="review-message mb-2 ms-3 text-center {{ \Illuminate\Support\Str::length($testimonial->description) > 100 ? 'more' : '' }}"
                          @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        ...
                        <div class="user-details d-flex justify-content-sm-start justify-content-center">
                          ...
                          <span class="user-designation" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif></span>
                        </div>
                      </div>
                    ...
                    <div class="card blog-card p-4 border-0 w-100 h-100 blog-block">
                      ...
                      <div class="blog-details mt-3">
                        <a href="{{ $vcardBlogUrl }}" class="text-decoration-none">
                          <h4 class="text-center text-black p-3 mb-0">
                            {{ $blog->title }}</h4>
                        </a>
                      </div>
                    </div>
                  ...
                  <div class="mb-3 mt-5 d-flex gap-1 justify-content-center align-items-center email-input">
                    <div class="w-100">
                      <input type="email" class="email-input form-control bg-dark border-dark text-light w-100"
                        ...
                        id="emailSubscription" aria-describedby="email-send">
                    </div>
