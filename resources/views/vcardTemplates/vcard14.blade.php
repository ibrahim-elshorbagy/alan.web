                                                ...
                                                <div>
                                                    <div class="service-card h-100">
                                                        ...
                                                        <div class="text-center pt-3">
                                                            ...
                                                            <p
                                                                class="card-text description-text text-white {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
                                                        ...
                                                        <div
                                                            ...
                                                            <div>
                                                                @if ($product->currency_id && $product->price)
                                                                    <span
                                                                        class="product-amount text-gradient">{{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
                                                                @elseif($product->price)
                                                                    <span
                                                                        class="product-amount text-gradient">{{ currencyFormat($product->price, 2, getUserCurrencyIcon($vcard->user->id)) }}</span>
                                                                @endif
