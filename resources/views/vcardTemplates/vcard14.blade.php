                  ...
                  @if ($vcard->phone)
                    <div class="col-sm-6">
                      <div class="contact-box">
                        ...
                        <div class="contact-desc">
                          <a href="tel:+{{ $vcard->region_code }} {{ $vcard->phone }}" class=""
                            ...
                            <div class="d-flex justify-content-center align-items-center flex-column">
                              ...
                              <div>
                                @if ($product->currency_id && $product->price)
                                  <span class="product-amount text-gradient"
                      ...
                      <div class="testimonial-card position-relative">
                        ...
                        <div class="card-body p-0">
                          <div class="text-sm-start text-center">
                            <p class="desc text-dark {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}"
                              @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            ...
                            <div class="d-flex flex-column gap-2 align-items-center justify-content-center"
                              ...
                              <h6 class="text-primary mb-0" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                  ...
                  <div>
                    <div class="blog-card">
                      ...
                      <div class="card-body d-flex flex-column justify-content-between text-start">
                        ...
                        <div class="text-end @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') ms-0 @else ms-auto @endif">
          ...
          @if (!empty($vcard->privacy_policy) || !empty($vcard->term_condition))
            <div>
              <a class="text-decoration-none text-gradient  fw-5 cursor-pointer terms-policies-btn"
                href="{{ $vcardPrivacyAndTerm }}"><span class="fs-14">{!! __('messages.vcard.term_policy') !!}</span></a>
            </div>
          @endif
        </div>
      </div>
