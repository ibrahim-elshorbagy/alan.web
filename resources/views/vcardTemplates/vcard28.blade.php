      ...
      @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
        <div class="profile-section position-relative">
          ...
          @if (checkFeature('social_links') && getSocialLink($vcard))
            <div class="social-media px-30 d-flex flex-wrap justify-content-center pt-40 position-relative">
                      ...
                      <div class="col-sm-6">
                        <div class="service-card h-100">
                          ...
                          <div class="card-body text-center p-0">
                            ...
                            <p class="mb-0 text-black text-center  {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
                              @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                ...
                <div class="">
                  <div class="product-card card">
                    ...
                    <div class="product-desc card-body p-0 text-center">
                      <h3 class="text-black fw-5 mb-3" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        {{ $product->name }}</h3>
                      <div class="amount fw-6 mb-0 text-primary lh-1">
                        @if ($product->currency_id && $product->price)
                          <div class="text-primary amount-price d-flex align-items-center gap-2 justify-content-center"
              ...
              @foreach ($vcard->blogs as $blog)
                ...
                <div>
                  <div class="blog-card card">
                    ...
                    <div class="card-body px-0 py-2" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                  ...
                  <div class="testimonial-card card">
                    ...
                    <div class="card-body p-0 pt-3 position-relative">
                      <div class="top-quote-img position-absolute">
                        <img src="{{ asset('assets/img/vcard28/quote-img.svg') }}" alt="quote" class="h-100" />
                      </div>
                      <h3 class="text-black text-center" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        {{ ucwords($testimonial->name) }}
                      </h3>
                      <p class="desc text-gray-500 mb-0 text-center {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
