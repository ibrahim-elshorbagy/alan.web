        ...
        <div class="head-img position-relative">
          ...
          @elseif($vcard->cover_type == 1)
            @if (strpos($vcard->cover_url, '.mp4') !== false ||
              ...
              <video height="400px" class="cover-video {{ $coverClass }}" loop autoplay playsinline
        ...
        <div class="mb-15">
          @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
            <div class="profile-img align-items-start top-0 @if ($vcard->cover_type == 2) profile-margin @endif">
              <img src="{{ $vcard->profile_url }}" width="150px" class="pro-img me-sm-4 rounded-circle mb-4"
                loading="lazy" />
              <div>
            ...
            <div class="about-section mb-4">
              <div class="row">
                ...
                @if ($vcard->alternative_email)
                  <div class="col-sm-6 pb-4">
                    <div class="about-details">
                      <img src="{{ asset('img/vcard5/alter-email.png') }}" class="mb-2" height="31"
                        width="40" />
              ...
              <div class="row">
                ...
                <div class="col-lg-6">
                  <div class="text-center">
                    <img src="{{ $vcard->profile_url }}" width="125px" class="qr-logo rounded-circle"
                      loading="lazy" />
                  </div>
                </div>
              </div>
                      ...
                      <div class="col-sm-6">
                        <div class="card service-card h-100">
                          ...
                          <div class="card-body pt-3 p-0">
                            <h5 class="card-title title-text" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                              {{ ucwords($service->name) }}</h5>
                            <p class="card-text text-gray-600 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
                              @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                              {!! \Illuminate\Support\Str::limit($service->description, 170, '...') !!}</p>
                          </div>
                        </div>
                          ...
                          <div class="row d-flex justify-content-between align-items-end">
                            <div class="col-lg-6">
                              <div class="d-flex align-items-center"
                                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                <img src="{{ $testimonial->image_url }}" class="me-3 testi-logo rounded-circle ms-2"
                                  loading="lazy" />
            ...
            <nav>
              <div class="row insta-toggle">
                <div class="nav nav-tabs px-0" id="nav-tab" role="tablist">
                  ...
                  <button class="d-flex align-items-center justify-content-center instagram-btn reelsbtn fs-2  py-2"
              ...
              <div class="main-contact mb-10">
                <form id="enquiryForm" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="row">
                        <label for="basic-url" class="form-label mb-0">{{ __('messages.user.your_name') }} <span
                            class="text-danger">*</span></label>
                        <div class="col-12 mb-3 input-group">
                          <span class="input-group-text bg-white contact-input border-end-0" id="basic-addon1"><i
                              class="far fa-user"></i></span>
                          <input type="text" name="name" class="form-control contact-input border-start-0"
                        ...
                        <div class="col-12 mb-3 input-group">
                          ...
                          <input type="email" name="email" class="form-control contact-input border-start-0"
                        ...
                        <div class="col-12 mb-3 input-group">
                          ...
                          <input type="tel" name="phone" class="form-control contact-input border-start-0"
            ...
            <div
              ...
              <div class="sub-btn d-none">
                <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
                  ...
                  @endif
                  @if (empty($vcard->hide_stickybar))
                    <div class="{{ isset($vcard->whatsapp_share) ? 'vcard5-btn-group' : 'stickyIcon' }}">
                      <button type="button"
