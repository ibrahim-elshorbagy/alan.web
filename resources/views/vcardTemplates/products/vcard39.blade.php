                  ...
                  <div class="product-desc d-flex justify-content-between align-items-center mt-5"
                    ...
                    <div class="product-amount fs-18">
                      @if ($product->currency_id && $product->price)
                        <span
                          class="fs-18 fw-semibold  product-price-{{ $product->id }}">{{ $product->currency->currency_icon }}{{ number_format($product->price, 2) }}</span>
                      @elseif($product->price)
                        <span
                          class="fs-18 fw-semibold  product-price-{{ $product->id }}">{{ getUserCurrencyIcon($vcard->user->id) }}{{ $product->price }}</span>
                      @endif
                    </div>
                  </div>
