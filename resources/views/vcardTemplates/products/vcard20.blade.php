  ...
  <div class="container p-0">
    <div class="vcard-twenty main-content  w-100 mx-auto content-blur allSection collapse show">
      <div class="vcard-one__product py-3 mt-0 h-100 px-30">
        <div class="d-flex gap-2 justify-content-between mb-5" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
          <div>
                ...
                <div class="product-card card mb-5 mt-0 p-4">
                  <div class="product-img card-img">
                    <a @if ($product->product_url) href="{{ $product->product_url }}" @endif target="_blank"
                      class="text-decoration-none fs-6 d-block w-100 h-100">
                      <div
