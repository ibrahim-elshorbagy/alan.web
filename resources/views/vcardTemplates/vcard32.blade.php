...
<body>
  ...
  <div class="container p-0">
    ...
    <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
      ...
      <div class="profile-section position-relative px-30 pt-40" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
        <div
                      ...
                      <div>
                        <div class="service-card">
                          ...
                          <div class="card-body text-center">
                            <h3 class="card-title text-dark" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                      ...
                      <div class="col-sm-6">
                        <div class="service-card h-100 d-flex flex-column">
                          ...
                          <div class="card-body text-center">
                            <h3 class="card-title text-dark" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                              {{ ucwords($service->name) }}</h3>
                            <p class="mb-0 description-text text-gray {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
                              @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                              {!! \Illuminate\Support\Str::limit($service->description, 170, '...') !!}
                            </p>
                          </div>
                  ...
                  <div>
                    <div class="testimonial-card card">
                      ...
                      <div class="d-flex flex-column gap-2 align-items-center">
                        ...
                        <h5 class="fw-semibold text-primary text-decoration-underline mb-2 text-center"
                          @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                          {{ ucwords($testimonial->name) }}</h5>
                      </div>
                      <div class="card-body p-0 mb-20">
                        <p class="desc text-gray mb-0 text-center fs-14 {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}"
                          @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
