        ...
        @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
          <div class=" d-flex flex-sm-row flex-column justify-content-center align-items-center">
            ...
            <div class="mx-4 mt-sm-0 mt-3">
              ...
              <span class="profile-designation text-center d-block p-1">{{ ucwords($vcard->occupation) }}</span>
              <span class="profile-designation text-center d-block p-1">{{ ucwords($vcard->job_title) }}</span>
              <p><span
                  class="profile-company d-block text-center text-secondary ms-1">{{ ucwords($vcard->company) }}</span>
              </p>
            </div>
          </div>
        @endif
              ...
              <div class="row g-3">
                ...
                @if ($vcard->alternative_email)
                  <div class="col-sm-6 col-12">
                    <div class="card event-card p-3 h-100 border-0 flex-sm-row flex-column align-items-center shadow">
                      <span class="event-icon d-flex justify-content-center align-items-center">
                        <img src="{{ asset('img/vcard10/alter-email.png') }}" alt="email" height="19"
                          width="25" />
                      </span>
                      <div class="event-detail ms-sm-3 mt-sm-0 mt-4">
                        <h6 class="event-title text-sm-start text-center">
                ...
                @if ($vcard->alternative_phone)
                  <div class="col-sm-6 col-12">
                    <div class="card event-card p-3 h-100 border-0 flex-sm-row flex-column align-items-center shadow">
                      <span class="event-icon d-flex justify-content-center align-items-center">
                        <img src="{{ asset('img/vcard10/old-typical-phone.png') }}" alt="phone" />
                      </span>
                      <div class="event-detail ms-sm-3 mt-sm-0 mt-4">
                        <h6 class="event-title text-sm-start text-center">
          ...
          <div class="vcard-ten__product pb-4 px-sm-3 px-2 position-relative mt-0">
            ...
            <div class="container">
              ...
              <div class="text-center pt-2 pb-8 mt-10">
                <a class=" text-white" href="{{ $vcardProductUrl }}">{{ __('messages.analytics.view_more') }}</a>
              </div>
            </div>
          </div>
        @endif
                    ...
                    <div class="card blog-card p-5 border-0 w-100 h-100 shadow">
                      ...
                      <div class="blog-details mt-12">
                        <a href="{{ $vcardBlogUrl }}" class="text-decoration-none">
                          <h4 class="text-center title-color p-3 text-black">
                            {{ $blog->title }}</h4>
                        </a>
                      </div>
                    </div>
        ...
        <div class="vcard-bars-btn position-relative @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') vcard-bars-btn-left @endif">
          ...
          <div class="sub-btn d-none">
            <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
              ...
              @endif
              @if (empty($vcard->hide_stickybar))
                <div class="{{ isset($vcard->whatsapp_share) ? 'vcard10-btn-group' : 'stickyIcon' }}">
                  <button type="button"
