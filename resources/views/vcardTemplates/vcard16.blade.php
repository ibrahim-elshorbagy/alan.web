          ...
          <div class="col-12">
            <div
              ...
              <div class="card-img d-flex justify-content-center align-items-center">
                <img src="{{ $vcard->profile_url }}" class="h-100 w-100 object-fit-cover" loading="lazy" />
              </div>
      ...
      <div class="px-30 pt-50 position-relative">
        ...
        @if (checkFeature('custom-links') && $customLink->isNotEmpty())
          <div class="custom-link-section">
            <div class="custom-link d-flex flex-wrap justify-content-center pt-50 gap-2 w-100 position-relative">
                    ...
                    <div class="contact-box">
                      ...
                      <div class="contact-desc">
                        <a href="tel:+ {{ $vcard->region_code }}
                                            {{ $vcard->phone }}"
                          class="text-primary mb-0 fs-14" dir="ltr">+{{ $vcard->region_code }}
                          {{ $vcard->phone }}</a>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="contact-box">
                      ...
                      <div class="contact-desc">
                        <a href="tel:+{{ $vcard->alternative_region_code }} {{ $vcard->alternative_phone }}"
                          class="text-primary mb-0 fs-14" dir="ltr">+{{ $vcard->alternative_region_code }}
        ...
        @if (checkFeature('services') && $vcard->services->count())
          <div class="our-services-section pt-50">
            ...
            <div class="services-bg">
              <img src="{{ asset('assets/img/vcard16/vector-13.png') }}" alt="" class="w-100"
                loading="lazy">
            </div>
            <div class="services">
                    ...
                    @foreach ($vcard->services as $service)
                      <div class="col-sm-6">
                        <div class="service-card card h-100 align-items-center">
                          ...
                          <div class="card-body text-center">
                            <h3 class="card-title fw-4" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                              {{ $service->name }}</h3>
                          ...
                          <div class="product-amount text-primary  fs-18">
                            @if ($product->currency_id && $product->price)
                              <span class="text-dark"
                                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') style="direction: rtl; text-align: right; display: block;" @endif>{{ $product->currency->currency_icon }}{{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
                ...
                <div class="">
                  <div class="testimonial-card">
                    ...
                    <div class="card-body p-0  text-center">
                      <h6 class="card-title mb-4 text-white" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                      ...
                      <div class="position-relative">
                        ...
                        <p class="text-gray-300 mb-4 {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}"
                          @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                          {!! $testimonial->description !!}
                        </p>
                        <div class="position-absolute quote-right">
                          <img src="{{ asset('assets/img/vcard16/quote-right.svg') }}" alt="quote-right" />
                        </div>
                      </div>
                  ...
                  @if (!empty($vcard->privacy_policy) || !empty($vcard->term_condition))
                    <div class="col-12">
                      <div class="d-flex gap-1">
                        <input type="checkbox" name="terms_condition" class="form-check-input terms-condition mt-1"
      ...
      <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
        <div class="fixed-btn-section">
          @if (empty($vcard->hide_stickybar))
            <div class="bars-btn lawyer-bars-btn @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') vcard-bars-btn-left @endif">
