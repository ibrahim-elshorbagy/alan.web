  ...
  <div class="position-relative z-index-9">
    ...
    <div class="main-content mx-auto w-100 overflow-hidden bg-gray-200 @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
      ...
      @if (((isset($managesection) && $managesection['contact_list']) || empty($managesection)) && $hasContactData)
        <div class="contact-section position-relative px-30 pt-50">
          ...
          <div class="chest-expander-img vector-bg" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            <img src="{{ asset('assets/img/vcard12/chest-expander.png') }}" alt="chest-expander" class="w-100" />
          </div>
          @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
            <div class="position-relative">
                          ...
                          <div class="card-img service-card-img">
                            <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                              ...
                              <img src="{{ $service->service_icon }}"
                                class="card-img-top service-new-image scale-hover" alt="{{ $service->name }}"
                                loading="lazy">
                            </a>
                          </div>
                          <div class="text-center">
                      ...
                      <div class="col-sm-6 mb-sm-0">
                        <div class="service-card card h-100">
                          ...
                          <div class="card-body p-0 text-center">
                            <h3 class="card-title" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                              {{ ucwords($service->name) }}
                            </h3>
                            <p class="mb-0 description-text {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
                              @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
      ...
      @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
        <div class="qr-code-section pt-50 px-30 position-relative" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
          ...
          <div>
            <div class="d-flex qr-code-box align-items-center mx-auto justify-content-center flex-column flex-sm-row">
                    ...
                    <div class="product-card card">
                      ...
                      <div class="product-desc card-body text-center">
                        <div class="product-title">
                          <h3 class="text-white" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            {{ $product->name }}</h3>
                        </div>
                    ...
                    <div class="testimonial-card h-100 bg-black position-relative px-30 pt-4 pb-4">
                      <div class="card-body d-flex flex-column justify-content-between p-0 text-center gap-3">
                        ...
                        <div class="position-relative">
                          ...
                          <p class="text-gray-100 fw-5 {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            "{!! $testimonial->description !!}"
                          </p>
                          <hr class="w-50 mx-auto text-gray-100">
                          <h5 class="name fw-5 text-white mb-3" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            ...
            <nav class="px-30">
              <div class="row insta-toggle">
                <div class="nav nav-tabs px-0 border-0 d-flex justify-content-around" id="nav-tab" role="tablist">
                  ...
                  <button class="d-flex align-items-center justify-content-center px-2 instagram-btn reelsbtn border-0"
            ...
            <div class="bussiness-hours mt-3 pt-3">
              <div class="row justify-content-center row-gap-20px">
                ...
                @foreach ($businessDaysTime as $key => $dayTime)
                  <div class="col-sm-6">
                    <div class="d-flex align-items-center gap-3 business-card overflow-hidden position-relative">
