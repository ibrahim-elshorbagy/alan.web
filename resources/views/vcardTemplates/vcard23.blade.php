    ...
    <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
      ...
      <div class="banner-section position-relative @if ($vcard->cover_type == 2) banner-img-23 @endif">
        <div class="banner-img">
          @php
            $coverClass = $vcard->cover_image_type == 0 ? 'object-fit-cover w-100' : 'object-fit-cover w-100';
          @endphp
      ...
      <div class="profile-section pt-50">
        <div class="px-30">
          <div class="profile-bg-img position-absolute">
            <img src="{{ asset('assets/img/vcard23/profile-bg1.png') }}" alt="profile-bg1" class="w-100 h-100"
              loading="lazy" />
          </div>
          <div class="card d-flex flex-sm-row align-items-center gap-3 position-relative border-0 bg-transparent">
            {{-- <div class="profile-bg-img position-absolute">
        ...
        <div class="desc text-center pt-40 px-30 fs-14">
          <p class="text-gray-100 fs-14 text-center mb-0">
            {!! $vcard->description !!}
          </p>
        </div>
        @if (checkFeature('social_links') && getSocialLink($vcard))
          <div class="social-media d-flex justify-content-center pt-40 position-relative">
            <div class="bg-vector vector-1 position-absolute">
              <img src="{{ asset('assets/img/vcard23/vector7.png') }}" alt="vector" class="w-100 h-100"
                loading="lazy" />
            </div>
        ...
        @if (
          ...
          <div class="contact-section pt-50 px-30 position-relative"
            ...
            <div class="bg-vector vector-3 position-absolute end-0 text-end">
              <img src="{{ asset('assets/img/vcard23/vector3.png') }}" alt="vector" class="w-100 h-100"
                loading="lazy" />
            </div>
        ...
        @if (checkFeature('services') && $vcard->services->count())
          <div class="our-services-section pt-50">
            <div class="bg-vector vector-4 position-absolute text-end">
              <img src="{{ asset('assets/img/vcard23/vector16.png') }}" alt="vector" class="w-100 h-100"
                loading="lazy" />
            </div>
            <div class="section-heading text-center">
        ...
        @if (checkFeature('appointments') && $vcard->appointmentHours->count())
          <div class="appointment-section pt-50 px-30">
            <div class="bg-vector vector-5 position-absolute top-0">
              <img src="{{ asset('assets/img/vcard23/vector8.png') }}" alt="vector" class="w-100 h-100"
                loading="lazy" />
            </div>
            <div class="section-heading text-center">
        ...
        @if (checkFeature('gallery') && $vcard->gallery->count())
          <div class="gallery-section pt-50 px-20 position-relative">
            <div class="bg-vector vector-6 position-absolute text-end">
              <img src="{{ asset('assets/img/vcard23/vector15.png') }}" alt="vector" class="w-100 h-100"
                loading="lazy" />
            </div>
            <div class="section-heading text-center">
      ...
      @if ((isset($managesection) && $managesection['testimonials']) || empty($managesection))
        @if (checkFeature('testimonials') && $vcard->testimonials->count())
          <div class="testimonial-section pt-50 px-20 position-relative">
            ...
            <div class="bg-vector vector-7 position-absolute">
              <img src="{{ asset('assets/img/vcard23/vector13.png') }}" alt="vector" class="w-100 h-100"
                loading="lazy" />
            </div>
            <div class="section-heading text-center">
                  ...
                  <div class="testimonial-card card">
                    ...
                    <div class="card-body p-0 pt-5 position-relative">
                      <div class="position-absolute quote-img">
                        <svg width="28" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        @if (checkFeature('products') && $vcard->products->count())
          <div class="product-section pt-50">
            <div class="bg-vector vector-8 position-absolute top-0">
              <img src="{{ asset('assets/img/vcard23/vector9.png') }}" alt="vector" class="w-100 h-100"
                loading="lazy" />
            </div>
            <div class="section-heading text-center">
                  ...
                  <div>
                    <div class="product-card card overflow-hidden">
                      ...
                      <div class="product-desc card-body p-3 text-center position-relative">
                        <div class="">
                          <h3 class="fs-18 fw-5 mb-1 text-black" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            {{ $product->name }}
                          </h3>
        ...
        @if (checkFeature('blog') && $vcard->blogs->count())
          <div class="blog-section pt-50 position-relative">
            <div class="bg-vector vector-9 position-absolute text-end">
              <img src="{{ asset('assets/img/vcard23/vector5.png') }}" alt="vector" class="w-100 h-100"
                loading="lazy" />
            </div>
            <div class="section-heading text-center">
        ...
        @if ($vcard->businessHours->count())
          ...
          <div class="business-hour-section pt-50 px-30 position-relative">
            <div class="bg-vector vector-10 position-absolute top-0">
              <img src="{{ asset('assets/img/vcard23/vector18.png') }}" alt="vector" class="w-100 h-100"
                loading="lazy" />
            </div>
            <div class="section-heading text-center">
        ...
        @if (checkFeature('iframes') && $vcard->iframes->count())
          <div class="iframe-section pt-50 position-relative">
            <div class="bg-vector vector-12 position-absolute">
              <img src="{{ asset('assets/img/vcard23/vector12.png') }}" alt="vector" class="w-100 h-100"
                loading="lazy" />
            </div>
            <div class="section-heading text-center">
      ...
      @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
        <div class="contact-us-section pt-50 px-30 position-relative">
          <div class="bg-vector vector-13 position-absolute end-0">
            <img src="{{ asset('assets/img/vcard23/vector14.png') }}" alt="vector" class="w-100 h-100"
              loading="lazy" />
          </div>
          <div class="section-heading text-center">
          ...
          @if ($vcard->location_type == 0 && ($vcard->location_url && isset($url[5])))
            <div class="map-section">
              <div class="bg-vector vector-15 position-absolute text-end">
                <img src="{{ asset('assets/img/vcard23/vector11.png') }}" alt="vector" class="w-100 h-100"
                  loading="lazy" />
              </div>
      ...
      <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
        <div class="fixed-btn-section">
          @if (empty($vcard->hide_stickybar))
            <div class="bars-btn consulting-bars-btn @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') vcard-bars-btn-left @endif">
          ...
          <div class="sub-btn d-none">
            <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
              ...
              @endif
              @if (empty($vcard->hide_stickybar))
                <div class="{{ isset($vcard->whatsapp_share) ? 'vcard23-btn-group' : 'stickyIcon' }}">
                  <button type="button" class="vcard23-btn-group vcard23-share vcard23-sticky-btn mb-3 px-2 py-1"><i
