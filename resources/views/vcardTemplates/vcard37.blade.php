...
<body>
  ...
  <div class="main-section position-relative mx-auto overflow-hidden  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
    ...
    <div
      class="introduction-section pt-50 px-30 position-relative  @if ($vcard->cover_type == 2) main-banner-video @endif"
    ...
    <div class="overflow-hidden">
                    ...
                    <div>
                      <div class="service-box bg-white w-100 mx-auto">
                        ...
                        <div class="service-content" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                          ...
                          <p class="mb-0 text-gray description-text text-center  {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                  ...
                  @foreach ($vcard->services as $service)
                    <div class="col-sm-6" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                      <div class="service-box bg-white w-100 mx-auto h-100 d-flex flex-column">
                        ...
                        <div class="service-content flex-grow-1" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                          <h6 class="card-title fw-bold text-black text-center"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            {{ ucwords($service->name) }}
                          </h6>
      ...
      @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
        @if (checkFeature('appointments') && $vcard->appointmentHours->count())
          <div class="appointment-section pt-50 px-30px" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            ...
            @foreach ($vcard->testimonials as $testimonial)
              <div>
                <div class="testimonial-box position-relative">
                  ...
                  <div>
                    <p class="text-gray fw-medium lh-base mb-3 text-center testiimonial-desc {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}"
                      @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    ...
                    <div class="d-flex justify-content-center align-items-center gap-3">
                      ...
                      <p class="fw-6 mb-0 text-black-100 lh-12 text-center text-sm-start testimonial-title @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') text-sm-end @endif"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                  ...
                  <div class="blog-box">
                    ...
                    <div class="blog-img-box mx-auto">
                      <div class="blog-img position-relative w-100 h-100 mx-auto">
                        <a href="{{ $vcardBlogUrl }}">
                          <img src="{{ $blog->blog_icon }}" alt="images" class="h-100 w-100 object-fit-cover" />
                        </a>
                      </div>
                    </div>
                    <div class="blog-content" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                      ...
                      <div class=" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') ms-0 text-start @else ms-auto text-end @endif">
                        <a href="{{ $vcardBlogUrl }}"
                          class="d-inline-flex fs-14 fw-5 gap-2 align-items-center justify-content-end ms-auto text-primary">
                          <span class=" text-decoration-underline">{{ __('messages.vcard_11.read_more') }}</span>
    ...
    <div class="d-flex justify-content-evenly z-3 w-100 bottom-0 py-1 made-by-section"
      ...
      @if (!checkFeature('advanced') || !checkFeature('advanced')->hide_branding)
        <a href="{{ url('/') }}" class="text-center text-decoration-none text-black" target="_blank">
