                    ...
                    <div class="col-sm-6 mb-4">
                      <div class="card border-0 bg-transparent h-100">
                        <div class="event-icon text-center h-100">
                          ...
                          <span class="event-title">{{ __('messages.admin.email') }}</span><br>
                  ...
                  @if ($vcard->alternative_email)
                    <div class="col-sm-6 mb-4">
                      <div class="card border-0 bg-transparent h-100">
                        <div class="event-icon text-center h-100">
                          <div>
                            <img src="{{ asset('img/vcard7/alter-image.png') }}" class="img-fluid mb-2"
                              height="33" width="34" />
                          </div>
                  ...
                  @if ($vcard->alternative_phone)
                    <div class="col-sm-6 mb-4">
                      <div class="card border-0 bg-transparent h-100">
                        <div class="event-icon text-center h-100">
                          <div>
                            <img src="{{ asset('img/vcard7/alter-phone.png') }}" class="img-fluid mb-2" />
                          </div>
                  ...
                  @if ($vcard->location)
                    <div class="col-sm-6 mb-4">
                      <div class="card border-0 bg-transparent h-100">
                        <div class="event-icon text-center h-100">
                          <div>
                            <img src="{{ asset('assets/img/vcard7/location.png') }}" class="img-fluid mb-2" />
                          </div>
                        ...
                        <div class="card service-card">
                          <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                            ...
                            <img src="{{ $service->service_icon }}"
                              class="card-img-top service-new-image  object-fit-contain" alt="{{ $service->name }}"
                              loading="lazy">
                          </a>
                      ...
                      <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                        ...
                        <div class="card shadow-product w-100 border-0 h-100">
                          ...
                          <div class="product-details mt-3">
                            ...
                            <p class="mb-2" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                              {{ $product->description }}
                            </p>
                      ...
                      <div class="card shadow-testi w-100 border-0 p-sm-4 p-3">
                        <div class="card-body p-0">
                          <div class="d-flex align-items-center testimonial-box"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            <img src="{{ $testimonial->image_url }}" class="testi-logo rounded-circle me-2"
                              loading="lazy" />
                            <div class="my-2">
                              <p class="mb-0 description-testi text-sm-start {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}"
                                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                {!! $testimonial->description !!}</p>
                              <span class="testi-footer-title"
                      ...
                      <div class="card blog-card p-2 border-0 w-100 h-100">
                        ...
                        <div class="blog-details mt-3">
                          <a href="{{ $vcardBlogUrl }}" class="text-decoration-none">
                            <h4 class=" text-center title-color text-black p-3 mb-0">
                              {{ $blog->title }}</h4>
                          </a>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="row">
                          ...
                          <label for="inputAddress" class="form-label mb-0">{{ __('messages.user.phone') }}</label>
                          <div class="col-12 mb-3 input-group">
                            <span class="input-group-text contact-icon border-end-0 bg-transparent"
                        ...
                        <div class="row">
                          ...
                          <div class="col-12 mb-3 input-group">
                            <span class="input-group-text contact-icon bg-transparent border-start-0"
                              id="basic-addon1"><i class="far fa-user"></i></span>
                            <input type="text" name="name"
                              class="form-control contact-input bg-transparent border-end-0 text-start" id="name"
                              placeholder="{{ __('messages.form.your_name') }}">
                          </div>
                          <label for="basic-url" class="form-label mb-0">{{ __('messages.user.email') }} <span
                              class="text-danger">*</span></label>
                          <div class="col-12 mb-3 input-group">
                            <span class="input-group-text contact-icon border-start-0 bg-transparent"
                              id="basic-addon1"><i class="far fa-envelope"></i></span>
                            <input type="email" name="email"
                              class="form-control contact-input border-end-0 bg-transparent text-start" id="email"
                              placeholder="{{ __('messages.form.your_email') }}">
                          </div>
                          <label for="inputAddress" class="form-label mb-0">{{ __('messages.user.phone') }}</label>
                          <div class="col-12 mb-3 input-group">
                            <span class="input-group-text contact-icon border-start-0 bg-transparent"
                              id="basic-addon1"><i class="fas fa-phone"></i></span>
                            <input type="tel" name="phone"
                              class="form-control contact-input border-end-0 bg-transparent text-start" id="phone"
                              placeholder="{{ __('messages.form.phone') }}"
                              onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,&quot;&quot;)">
                          </div>
                        </div>
          ...
          <div
            ...
            <div class="sub-btn d-none">
              <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
                ...
                @endif
                @if (empty($vcard->hide_stickybar))
                  <div class="{{ isset($vcard->whatsapp_share) ? 'vcard7-btn-group' : 'stickyIcon' }}">
                    <button type="button"
