...
<body>
  ...
  <div class="main-content position-relative @if (getLanguage($vcard->deault_language) == 'Arabic') rtl @endif">
    ...
    {{-- Profile Section --}}
    <div class="profile-section px-30 position-relative" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
    ...
    @if (checkFeature('social_links') && getSocialLink($vcard))
      <div class="social-icons pt-30 position-relative px-30">
        ...
        <ul class="ps-0 mb-0 justify-content-center flex-wrap" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
    ...
    @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
      @if (
        ...
        <div class="contact-section position-relative pt-30 px-30">
          ...
          <div class="row row-gap-30 d-flex" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
            @if ($vcard->email)
      ...
      @if (checkFeature('services') && $vcard->services->count())
        <div class="service-section position-relative pt-60 px-30">
          ...
          @if ($vcard->services_slider_view)
            <div class="service-cards" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                  ...
                  <div>
                    <div class="service-card cards">
                      ...
                      <div class="card-content text-center">
                        <h5 @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>{{ ucwords($service->name) }}</h5>
                        <p class="{{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
    ...
    @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
      @if (checkFeature('gallery') && $vcard->gallery->count())
        <div class="gallery-section position-relative pt-60 px-30">
          ...
          <div class="gallery-slider" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                ...
                <div class="gallery-img">
                  @if ($file->type == App\Models\Gallery::TYPE_IMAGE)
                    <a href="{{ $file->gallery_image }}" data-lightbox="gallery-images">
                      <img src="{{ $file->gallery_image }}" alt="img" class="w-100 h-100 object-fit-cover" />
                    </a>
                    <div class="position-absolute expand-more">
                      <a class="rounded-circle d-flex align-items-center justify-content-center rounded-full"
                        ...
                        <svg class="svg-inline--fa fa-expand text-black" aria-hidden="true" focusable="false"
                          data-prefix="fas" data-icon="expand" role="img" xmlns="http://www.w3.org/2000/svg"
                  ...
                  @elseif($file->type == App\Models\Gallery::TYPE_FILE)
                    <a id="file_url" href="{{ $file->gallery_image }}" class="gallery-link gallery-file-link"
                      ...
                      <div
                        class="gallery-item gallery-file-item w-100 h-100 d-flex align-items-center justify-content-center"
                  ...
                  @else
                    ...
                    <div class="position-absolute expand-more">
                      <a href="https://www.youtube.com/watch?v={{ YoutubeID($file->link) }}" target="_blank"
                        class="rounded-circle d-flex align-items-center justify-content-center rounded-full">
                        <svg class="svg-inline--fa fa-expand text-black" aria-hidden="true" focusable="false"
                          data-prefix="fas" data-icon="expand" role="img" xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 448 512" data-fa-i2svg="">
    ...
    @if ((isset($managesection) && $managesection['products']) || empty($managesection))
      @if (checkFeature('products') && $vcard->products->count())
        <div class="product-section position-relative pt-60 px-30">
          ...
          <div class="product-cards" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    ...
                    <a @if ($product->product_url) href="{{ $product->product_url }}" @endif target="_blank"
                      ...
                      <div class="card-content">
                        <div class="d-flex align-items-center justify-content-between gap-2">
                          <div>
                            <h5 @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>{{ $product->name }}</h5>
                            <p @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                  ...
                  <div class="testimonial-card">
                    <div class="testimonial">
                      ...
                      <div class="d-flex align-items-center justify-content-between flex-column flex-sm-row">
                        <div>
                          <h4 @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>{{ ucwords($testimonial->name) }}
                          </h4>
                        </div>
                      </div>
                    </div>
                    <div class="quote quote-left">
                      <img src="{{ asset('assets/img/vcard39/quote-left.png') }}" alt="img" />
                    </div>
                    <div class="quote quote-right">
                      <img src="{{ asset('assets/img/vcard39/quote-right.png') }}" alt="img" />
                    </div>
                  </div>
                </div>
              @endforeach
            ...
            @foreach ($vcard->blogs as $index => $blog)
              ...
              <div>
                <div class="blog-card cards border-0">
                  ...
                  <h4>
                    <a href="{{ $vcardBlogUrl }}" class="text-decoration-none">{{ $blog->title }}</a>
                  </h4>
                  <p class="description">
                    <span class="desc">
    ...
    @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
      @if ($vcard->businessHours->count())
        ...
        <div class="business-hour-section position-relative pt-60 px-30">
          ...
          <div class="row row-gap-30 justify-content-center" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
            @php
              ...
              <div>
                <div class="date-input position-relative">
                  <div class="input-group-date d-flex align-items-center position-relative">
                    ...
                    <div class="calender-icon @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
        ...
        <div @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
          <form action="" id="enquiryForm" enctype="multipart/form-data">
            ...
            <div class="row gap-10 column-gap-0 mb-30">
              ...
              <div class="col-12">
                <input type="email" placeholder="{{ __('messages.form.your_email') }}" name="email"
                  class="w-100" />
              </div>
              <div class="col-12">
                <input type="number" placeholder="{{ __('messages.form.phone') }}" name="phone"
                  onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" class="w-100" />
              </div>
              <div class="col-12">
              ...
              @if (isset($inquiry) && $inquiry == 1)
                <div class="col-12">
                  <div class="position-relative">
                    <input type="file" name="attachment" id="attachment" class="w-100" multiple hidden />
    ...
    @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
      <div class="create-vcard-section pt-60  position-relative" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
        <div class="title">
    ...
    @if ((isset($managesection) && $managesection['map']) || empty($managesection))
      @if ($vcard->location_url && isset($url[5]))
        <div class="map-location px-30 position-relative" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
          <div class="map-card">
      ...
      @if ($vcard->location_type == 1 && !empty($vcard->location_embed_tag))
        <div class="map-location px-30 position-relative" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
          <div class="map-card">
            ...
            <div class="map">
              <div
                class="embed-responsive embed-responsive-16by9 rounded overflow-hidden justify-content-center d-flex"
    ...
    {{-- Sticky Bar section --}}
    <div class="position-relative">
      <div class="sticky-btn btn-section @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
        <div class="fixed-btn-section">
          <div class="reporter-bars-btn bars-btn @if (getLanguage($vcard->default_language) == 'Arabic') vcard-bars-btn-left @endif">
          ...
          <div class="sub-btn d-none">
            <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic') sub-btn-div-left @endif">
              ...
              @if (empty($vcard->hide_stickybar))
                <div class="{{ isset($vcard->whatsapp_share) ? 'vcard39-btn-group' : 'stickyIcon' }}">
                  <button type="button" class="vcard39-btn-group vcard39-share vcard39-sticky-btn mb-3"><i
        ...
        <div class="modal-content" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
          <div class="">
            <div class="row align-items-center mt-3">
              <div class="col-10">
                <h5 class="modal-title pl-40 @if (getLanguage($vcard->deault_language) == 'Arabic') rtl @endif">
    ...
    <div class="d-flex justify-content-evenly w-100 py-2">
      @if (!checkFeature('advanced') || !checkFeature('advanced')->hide_branding)
        <a href="{{ url('/') }}" class="text-center text-decoration-none text-white" target="_blank">
