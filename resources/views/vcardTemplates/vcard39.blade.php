                                        ...
                                        <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                            ...
                                            <div class="card-content">
                                                <div class="d-flex align-items-center justify-content-between gap-2">
                                                    <div>
                                                        <h5>{{ $product->name }}</h5>
                                                        <p>{{ \Illuminate\Support\Str::limit($product->description ?? '', 50, '...') }}
                                                        </p>
                                                    </div>
                                                    <div class="price">
        ...
        <div class="position-relative">
            <div class="sticky-btn btn-section @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
                <div class="fixed-btn-section">
                    <div
                        class="reporter-bars-btn bars-btn @if (getLanguage($vcard->default_language) == 'Arabic') vcard-bars-btn-left @endif">
