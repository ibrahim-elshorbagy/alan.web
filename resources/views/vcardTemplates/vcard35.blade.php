...
<body>
  ...
  <div class="container p-0">
    ...
    <div class="main-content mx-auto w-100 overflow-hidden body-bg-black @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
      ...
      {{-- profile section --}}
      <div class="profile-section pt-40 px-30 position-relative" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
      ...
      @if (checkFeature('social_links') && getSocialLinkIcon($vcard))
        <div class="pt-50 px-30 position-relative">
          ...
          <div
            class="social-media-section social-media  d-flex gap-3 flex-wrap  justify-content-center justify-content-center"
      ...
      @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
        @if (
          ...
          <div class="contact-section position-relative pt-50 px-30">
            ...
            <div class="row align-items-center row-gap-20px" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
              @if ($vcard->email)
              ...
              @if ($vcard->dob)
                <div class="col-12 col-sm-6">
                  <div class="contact-box d-flex align-items-center">
                    ...
                    <div class="contact-desc">
                      <p class="text-white fs-14 mb-0 @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') me-1 @endif">
                        {{ $vcard->dob }}</p>
                    </div>
                  </div>
                </div>
                    ...
                    <div>
                      <div class="service-card h-100 p-1 border-gradient">
                        ...
                        <div class="card-body text-center bg-secondary">
                          ...
                          <p class="mb-0 text-gray-300 description-text {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    ...
                    @foreach ($vcard->services as $service)
                      <div class="col-sm-6">
                        <div class="service-card card d-flex flex-column align-items-center h-100 p-1 border-gradient">
                          ...
                          <div class="card-body text-center bg-secondary @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian')  @endif">
                            <h3 class="card-title fs-18 fw-5 text-primary"
                              @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                              {{ ucwords($service->name) }}
                            </h3>
                            <p class="mb-0 fs-14 description-text text-gray-300 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
                              @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                              {!! \Illuminate\Support\Str::limit($service->description, 170, '...') !!}
                            </p>
                          </div>
                        ...
                        <div class="bg-secondary p-1 rounded-10 w-100">
                          <div class="d-flex align-items-center justify-content-center gap-2 flex-column">
                            ...
                            @if ($product->currency_id && $product->price)
                              <span class="product-amount lh-1 text-center fw-bold text-primary"
      ...
      @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
        @if ($vcard->businessHours->count())
          ...
          <div class="business-hour-section pt-50 px-30 position-relative"
            ...
            <div class="row justify-content-center row-gap-20px" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
