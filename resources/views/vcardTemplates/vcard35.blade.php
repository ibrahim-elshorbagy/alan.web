                                                ...
                                                <div class="bg-secondary p-1 rounded-10 w-100">
                                                    <div
                                                        ...
                                                        @if ($product->currency_id && $product->price)
                                                            <span
                                                                class="product-amount lh-1 text-center fw-bold text-primary">{{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
                                                        @elseif($product->price)
                                                            <span
                                                                class="product-amount lh-1 text-center fw-bold text-primary">{{ currencyFormat($product->price, 2, getUserCurrencyIcon($vcard->user->id)) }}</span>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
