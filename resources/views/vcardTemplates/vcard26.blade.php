                ...
                @if ($vcard->phone)
                  <div class="col-sm-6">
                    <div class="contact-box d-flex align-items-center">
                      <div class="contact-icon d-flex justify-content-center align-items-center">
                        <div class="top-icon">
                          <img src="{{ asset('assets/img/vcard26/phone.svg') }}" loading="lazy"
                            class="first-mail" />
                        </div>
                      </div>
                      <div class="contact-desc">
                ...
                @if ($vcard->location)
                  <div class="col-sm-6">
                    <div class="contact-box d-flex align-items-center">
                      <div class="contact-icon d-flex justify-content-center align-items-center">
                        <div class="top-icon">
                          <img src="{{ asset('assets/img/vcard26/location.svg') }}" loading="lazy"
                            class="first-mail" />
                        </div>
                      </div>
                      <div class="contact-desc">
                ...
                <div>
                  <div class="testimonial-card text-center">
                    <div class="quote-img left">
                      <img src="{{ asset('assets/img/vcard26/quote-img-left-26.png') }}" alt="quote-img"
                        class="ms-auto" loading="lazy" />
                    </div>
                    <div class="quote-img right">
                      <img src="{{ asset('assets/img/vcard26/quote-img-right-26.png') }}" alt="quote-img"
                        class="ms-auto" loading="lazy" />
                    </div>
                    ...
                    <div class="product-card card h-100">
                      ...
                      <div class="product-desc align-items-center">
                        <div class="text-center d-flex flex-column gap-2">
                          <h3 class="text-black fw-5 mb-0" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            {{ $product->name }}</h3>
              ...
              @foreach ($vcard->blogs as $blog)
                ...
                <div>
                  <a href="{{ $vcardBlogUrl }}" class="d-block w-100 h-100">
                    <div class="blog-card card-1" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                      <div class="blog-img">
        ...
        @if ($vcard->location_type == 0 && ($vcard->location_url && isset($url[5])))
          <div class="px-30 pt-50 position-relative">
            <div class="bg-vector position-absolute vector-18">
              <img src="{{ asset('assets/img/vcard26/vector18.svg') }}" alt="box-img" loading="lazy" />
            </div>
            ...
            <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
              ...
              @if (empty($vcard->hide_stickybar))
                <div class="{{ isset($vcard->whatsapp_share) ? 'vcard26-btn-group' : 'stickyIcon' }}">
                  <button type="button" class="social-btn ecommerce-sub-btn mb-3 px-2 py-1 wp-btn vcard26-share"><i
