      ...
      <div class="profile-section pt-50 px-30 position-relative">
        ...
        <div class="card flex-sm-row align-items-center">
          <div class="profile-card-bg h-100">
            <img src="{{ asset('assets/img/vcard17/profile-card-bg.png') }}" class="h-100 obeject-fit-cover" />
          </div>
              ...
              @if ($vcard->phone)
                <div class="col-sm-6">
                  <div class="contact-box">
                    ...
                    <div class="contact-desc">
                      <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}" class="text-white fs-14 fw-5"
                ...
                <div>
                  <a @if ($product->product_url) href="{{ $product->product_url }}" @endif target="_blank"
                    ...
                    <div class="card product-card">
                      <div class="card-img">
                        <img src="{{ $product->product_icon }}" class="h-100 w-100 object-fit-cover"
                          loading="lazy" />
                      </div>
                  ...
                  <div class="blog-card-wrapper">
                    <div class="blog-card card" style="transform: scaleX(1) !important;">
                      ...
                      <div class="card-body">
                        ...
                        <a href="{{ $vcardBlogUrl }}" style="transform: scaleX(1) !important;"
                    ...
                    <div class="business-hour d-flex align-items-center">
                      <div class="days-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25"
                          ...
                          <defs>
                            <linearGradient id="paint0_linear_10208_971" x1="10" y1="0"
                              x2="10" y2="20" gradientUnits="userSpaceOnUse">
                              <stop stop-color="#FFAE00" />
                              <stop offset="1" stop-color="#F54200" />
                            </linearGradient>
                            <linearGradient id="paint1_linear_10208_971" x1="18.5" y1="12"
                              x2="18.5" y2="25" gradientUnits="userSpaceOnUse">
                              <stop stop-color="#FD9301" />
                              <stop offset="1" stop-color="#F64701" />
                            </linearGradient>
                            <linearGradient id="paint2_linear_10208_971" x1="18.3878" y1="13.8154"
                              x2="18.3878" y2="23.0051" gradientUnits="userSpaceOnUse">
                              <stop stop-color="#FD9301" />
                              <stop offset="1" stop-color="#F64701" />
                            </linearGradient>
                            <linearGradient id="paint3_linear_10208_971" x1="20.7971" y1="14.8916"
                              x2="20.7971" y2="15.6088" gradientUnits="userSpaceOnUse">
                              <stop stop-color="#FD9301" />
                              <stop offset="1" stop-color="#F64701" />
                            </linearGradient>
                            <linearGradient id="paint4_linear_10208_971" x1="21.9182" y1="16.2363"
                              x2="21.9182" y2="16.9536" gradientUnits="userSpaceOnUse">
                              <stop stop-color="#FD9301" />
                              <stop offset="1" stop-color="#F64701" />
                            </linearGradient>
                            <linearGradient id="paint5_linear_10208_971" x1="14.9699" y1="20.2705"
                              x2="14.9699" y2="20.9877" gradientUnits="userSpaceOnUse">
                              <stop stop-color="#FD9301" />
                              <stop offset="1" stop-color="#F64701" />
                            </linearGradient>
                            <linearGradient id="paint6_linear_10208_971" x1="16.091" y1="21.6157"
                              x2="16.091" y2="22.333" gradientUnits="userSpaceOnUse">
                              <stop stop-color="#FD9301" />
                              <stop offset="1" stop-color="#F64701" />
                            </linearGradient>
                            <linearGradient id="paint7_linear_10208_971" x1="21.8069" y1="20.3828"
                              x2="21.8069" y2="21.1001" gradientUnits="userSpaceOnUse">
                              <stop stop-color="#FD9301" />
                              <stop offset="1" stop-color="#F64701" />
                            </linearGradient>
                            <linearGradient id="paint8_linear_10208_971" x1="20.4612" y1="21.5034"
                              x2="20.4612" y2="22.2207" gradientUnits="userSpaceOnUse">
                              <stop stop-color="#FD9301" />
                              <stop offset="1" stop-color="#F64701" />
                            </linearGradient>
                            <linearGradient id="paint9_linear_10208_971" x1="15.0823" y1="15.8999"
                              x2="15.0823" y2="16.6171" gradientUnits="userSpaceOnUse">
                              <stop stop-color="#FD9301" />
                              <stop offset="1" stop-color="#F64701" />
                            </linearGradient>
                            <linearGradient id="paint10_linear_10208_971" x1="16.426" y1="14.7793"
                              x2="16.426" y2="15.4965" gradientUnits="userSpaceOnUse">
                              <stop stop-color="#FD9301" />
                              <stop offset="1" stop-color="#F64701" />
                            </linearGradient>
                            <linearGradient id="paint11_linear_10208_971" x1="19.2453" y1="15.564"
                              x2="19.2453" y2="19.0829" gradientUnits="userSpaceOnUse">
                              <stop stop-color="#FD9301" />
                              <stop offset="1" stop-color="#F64701" />
                            </linearGradient>
          ...
          <div class="appointment-section pt-50 px-30 position-relative"
            ...
            <div class="appointment">
              ...
              <div class="">
                ...
                <div class="text-center">
                  <button type="submit" class="appointmentAdd appoint-btn btn btn-gradient d-none mt-3">
