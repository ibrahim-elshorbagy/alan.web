    ...
    <div class="main-content mx-auto w-100 overflow-hidden bg-white @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
      ...
      <div class="banner-section position-relative w-100">
        <div class="banner-img @if ($vcard->cover_type == 2) h-auto @endif">
          @php
            $coverClass = $vcard->cover_image_type == 0 ? 'object-fit-cover w-100 h-100' : 'object-fit-co w-100 h-100';
          @endphp
      ...
      <div class="profile-section position-relative bg-white pt-40 px-30">
        ...
        <div class="card flex-sm-row align-items-center gap-2 gap-sm-4"
          ...
          <div class="card-body p-0 text-center @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') text-sm-end @endif">
                        ...
                        <div class="service-card h-100">
                          <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                            ...
                            <img src="{{ $service->service_icon }}"
                              class="w-100 h-100 object-fit-cover service-new-image" alt="{{ $service->name }}"
                              loading="lazy">
                          </a>
                          <div class="text-center">
                            ...
                            <p class="card-desc description-text text-gray-100 mb-0 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
                              @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                      ...
                      <div class="col-sm-6 d-flex flex-column">
                        <div class="service-card card h-100">
                          ...
                          <div class="card-body p-0 text-center">
                            <h3 class="card-title text-white mb-2" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                              {{ ucwords($service->name) }}
                            </h3>
                            <p class="card-desc mb-0 text-gray-100 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
                              @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                ...
                <div>
                  <div class="product-card card">
                    ...
                    <div class="product-desc card-body text-center p-0">
                      <h3 class="text-white card-title  mb-1" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        {{ $product->name }}</h3>
                  ...
                  <div>
                    <div class="testimonial-card">
                      ...
                      <div class="card-body position-relative px-0  text-center text-white">
                        ...
                        <h6 class="name text-white" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                          {{ ucwords($testimonial->name) }}</h6>
                        <p class="mb-2 text-gray-100 {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}"
                          @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                      ...
                      <div class="time-icon-box">
                        <div class="time-icons d-flex align-items-center justify-content-center">
                          <svg xmlns="http://www.w3.org/2000/svg"
                            class="icon icon-tabler icon-tabler-calendar-time text-primary" width="24"
        ...
        <div class="qr-code-section pt-40 px-30 pb-40 position-relative">
          ...
          <div class="qr-code mx-auto  position-relative">
            <div class="d-flex flex-sm-row flex-column gap-3 position-relative z-1 align-items-center"
              ...
              <div class=" text-center @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') text-sm-end @else text-sm-start @endif">
      ...
      <div class="d-flex justify-content-evenly py-2">
        @if (!checkFeature('advanced') || !checkFeature('advanced')->hide_branding)
          <a href="{{ url('/') }}" class="text-center text-decoration-none text-light" target="_blank">
                ...
                <div class="{{ isset($vcard->whatsapp_share) ? 'vcard17-btn-group' : 'stickyIcon' }}">
                  ...
                  @if (!empty($vcard->enable_download_qr_code))
                    <a type="button"
                      ...
                      id="qr-code-btn" download="qr_code.png"><i class="fa-solid fa-qrcode fs-4 text-white"></i></a>
                  @endif
                  {{-- <a type="button"
