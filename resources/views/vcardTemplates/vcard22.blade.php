    ...
    <div class="main-content mx-auto w-100 overflow-hidden bg-green @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
              ...
              <ul class="text-decoration-none ps-0">
                <li class="dropdown1 dropdown lang-list">
                  <a href="#" id="select-language-btn"
                    ...
                    class="dropdown-toggle lang-head text-decoration-none" data-toggle="dropdown" role="button"
      ...
      <div class="profile-section pt-40 pb-40 px-30 position-relative">
        ...
        <div class="card d-flex flex-sm-row gap-3 gap-sm-4 align-items-center">
          ...
          <div class="card-body text-center profile-details p-0 position-relative">
                ...
                <div class="gallery-img d-block">
                  ...
                  @elseif($file->type == App\Models\Gallery::TYPE_FILE)
                    <a id="file_url" href="{{ $file->gallery_image }}"
                      class="gallery-link gallery-file-link w-100 h-100 object-fit-cover" target="_blank"
                      loading="lazy">
                ...
                <div class="">
                  <div class="product-card card position-relative">
                    ...
                    <div class="product-desc card-body p-0 pt-3 text-center position-relative">
                      <h3 class="product-head fw-5 mb-2" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        {{ $product->name }}</h3>
                        ...
                        <div class="d-flex justify-content-between align-items-end">
                          <div class="d-flex flex-wrap align-items-center">
                            ...
                            <div class="profile-desc mt-3">
                              <h3 class="text-primary fs-20 mb-1" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        ...
                        <div class="text-end d-flex justify-content-end align-items-center">
                          <div class="quote-img">
                            <svg xmlns="http://www.w3.org/2000/svg" width="60" height="45"
                              viewBox="0 0 60 45" fill="CurrentColor">
                              <path
          ...
          <div class="blog-section pt-40 px-20">
            ...
            <div class="blog-slider">
              @foreach ($vcard->blogs as $blog)
                ...
                ?>
                <div>
                  <div class="blog-card overflow-hidden" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    <div class="card-img">
                      <a href="{{ $vcardBlogUrl }}">
                ...
                <div class="col-sm-6 px-custome">
                  <div class="business-hour align-items-center">
                    ...
                    <div class="text-start d-flex gap-2 gap-sm-1 gap-md-2"
                      ...
                      <span class="text-label-color">{{ $dayTime ?? __('messages.common.closed') }}</span>
                    </div>
                  </div>
                </div>
              @endforeach
          ...
          <div class="fixed-btn-section">
            ...
            <div class="sub-btn d-none">
              <div
                ...
                @endif
                @if (empty($vcard->hide_stickybar))
                  <div class="{{ isset($vcard->whatsapp_share) ? 'vcard22-btn-group' : 'stickyIcon' }}">
                    <button type="button"
            ...
            <div class="">
              ...
              <div class="text-center">
                <a href="{{ $banners->url }}" id="support-banner-btn"
                  data-button-style="{{ isset($dynamicVcard) ? $dynamicVcard->button_style : 'default' }}"
                  class="act-now  text-dark" target="_blank" data-turbo="false">{{ $banners->banner_button }} </a>
              </div>
            </div>
          </div>
        @endif
