      ...
      <div class="vcard__banner w-100 position-relative">
        ...
        @elseif($vcard->cover_type == 1)
          @if (strpos($vcard->cover_url, '.mp4') !== false ||
            ...
            <video class="cover-video banner-image {{ $coverClass }}" loop autoplay playsinline
        ...
        <div
          ...
          <div class="vcard__position d-flex flex-column mx-sm-4 mt-sm-5 mt-2">
            <div class="d-flex flex-column vcard_details">
              ...
              <span class="avatar-designation text-center p-1">{{ ucwords($vcard->occupation) }}</span>
              <span class="avatar-designation text-center ms-1">{{ ucwords($vcard->job_title) }}</span>
              ...
              @if ($vcard->alternative_email)
                <div class="col-sm-6 col-12">
                  <div
                    class="card vcard__event-card d-flex flex-column justify-content-center align-items-center border-0 p-3 h-100">
                    <span class="event-icon">
                      <img src="{{ asset('img/vcard4/alter-image.png') }}" class="img-fluid" height="22"
                        width="30" alt>
                    </span>
                  ...
                  @foreach ($vcard->testimonials as $testimonial)
                    <div class="col-6">
                      <div class="card testimonial-card h-100 border-0 w-100">
                        <img src="{{ $testimonial->image_url }}" class="testimonial-image d-block mx-auto"
                          loading="lazy" />
                  ...
                  <div class="modal-body">
                    ...
                    <form action="" method="post" id="newsLatterForm">
                      ...
                      <div
                        ...
                        <div class="w-100">
                          <input type="email" class="form-control bg-dark border-dark text-light email-input"
