    ...
    <div class="container p-0">
        ...
        <div
            ...
            <div class="profile-section mt-2 position-relative"
                ...
                <div
                    class="row @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif">
            ...
            @if ((isset($managesection) && $managesection['services']) || empty($managesection))
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-section pt-40 pb-40 px-30px mb-40px position-relative" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                    ...
                                    <div class="position-relative">
                                        {{ Form::text('date', null, [
                                            'class' =>
                                                ...
                                                (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian' ? 'text-end' : 'text-start'),
