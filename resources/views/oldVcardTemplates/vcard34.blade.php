    ...
    <div
      ...
      <div class="profile-section mt-2 position-relative" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
        <div class="px-30px">
          <div class="rotate-circle">
            <div
              ...
              <div class="rotate-text position-absolute">
                <img src="{{ asset('assets/img/oldVcardTemplate/vcard34/black-text.png') }}" alt="images"
          ...
          <div class="profile-desc">
            ...
            <p class="fs-14 fw-light lh-base text-primary mb-0 photo-title text-uppercase text-center text-sm-start">
                ...
                <div class="col-sm-6 mb-3">
                  <a href="{{ $social['url'] }}" target="_blank" class="text-decoration-none w-100">
                    <div class="social-item d-flex align-items-center text-white rounded-pill px-2 py-2 w-100">
                      <div
                        class="scoial-icon me-3 bg-white-100 rounded-circle d-flex justify-content-center align-items-center">
                        {!! $social['icon'] !!}
                      </div>
        ...
        @if (
          ...
          <div class="personal-section position-relative pt-40 px-30px overflow-hidden">
            <div class="personal-bg">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard34/personal-bg.png') }}" alt="images"
                class="img-fluid" />
            </div>
                  ...
                  @if ($vcard->email)
                    <div class="col-sm-6 mb-36 d-flex">
                      <div class="details-item w-100 d-flex">
                        <div class="text-center position-relative z-2 w-100 d-flex flex-column justify-content-center">
                          <div
        ...
        @if (checkFeature('gallery') && $vcard->gallery->count())
          <div class="gallery-section pt-40 pb-1 position-relative">
            <div class="gallery-bg position-absolute end-0 text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard34/gallery-bg.png') }}" alt="images"
                class="img-fluid" />
            </div>
            <div>
        ...
        @if (checkFeature('services') && $vcard->services->count())
          <div class="our-section pt-40 pb-40 px-30px mb-40px position-relative"
            ...
            <div class="services-bg">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard34/services-bg.png') }}" alt="images" />
            </div>
            <p class="section-heading fs-24 lh-base fw-semibold mx-auto mb-40px">
                ...
                @foreach ($vcard->services as $service)
                  <div class="col-sm-6 d-flex">
                    <div class="our-card1 d-flex flex-column w-100">
                      <div class="position-relative z-2 text-center flex-grow-1 d-flex flex-column">
                        ...
                        <p class="fs-14 lh-sm text-gray-100 mb-0 flex-grow-1 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
                          @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                          {!! \Illuminate\Support\Str::limit($service->description, 170, '...') !!}
                        </p>
                      </div>
        ...
        @if (checkFeature('products') && $vcard->products->count())
          <div class="products-section pt-40 pb-40">
            <div class="test-left position-absolute top-0">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard34/testleft.png') }}" alt="images"
                class="img-fluid" />
            </div>
            <p class="section-heading fs-24 lh-base fw-semibold mx-auto mb-40px">
        ...
        @if (checkFeature('testimonials') && $vcard->testimonials->count())
          <div class="testimonial-section pt-40 pb-2 px-30px position-relative overflow-hidden">
            <div class="testimonial-bg">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard34/testimonial-bg.png') }}" alt="images" />
            </div>
            <p class="section-heading fs-24 lh-base fw-semibold mx-auto mb-40px">
                  ...
                  <div class="testimonial-card mb-3">
                    <div class="test position-relative z-2">
                      ...
                      <div class="test-content">
                        <p class="fs-14 lh-sm text-gray-100 mb-15px text-center {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}"
                          @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
        ...
        @if (checkFeature('blog') && $vcard->blogs->count())
          <div class="blog-section position-relative pt-40">
            <div class="test-right position-absolute end-0 text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard34/testright.png') }}" alt="images"
                class="img-fluid" />
            </div>
            <p class="section-heading fs-24 lh-base fw-semibold mx-auto mb-40px">
                ...
                <div>
                  <div class="blog-card mx-auto position-relative w-100">
                    <div class="blog-img w-100">
                      <a href="{{ $vcardBlogUrl }}">
                        <img src="{{ $blog->blog_icon }}" alt="images" class="h-100 w-100 object-fit-contain" />
                      </a>
                    </div>
      ...
      @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
        @if ($vcard->businessHours->count())
          ...
          @endphp
          <div
            class="business-hour position-relative pb-30 {{ checkFeature('blog') && $vcard->blogs->count() ? 'pt-0' : 'pt-40' }}"
            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            <div class="business-right">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard34/business.png') }}" alt="images"
                class="img-fluid" />
            </div>
        ...
        @if (checkFeature('iframes') && $vcard->iframes->count())
          <div class="iframe-section pt-40">
            <div class="iframe-bg text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard34/iframe-bg.png') }}" alt="images" />
            </div>
            <p class="section-heading fs-24 lh-base fw-semibold mx-auto mb-40px">
      ...
      @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
        <div class="contact-section px-30px pt-40 pb-40" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
          <div class="contact-bg">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard34/contact-bg.png') }}" alt="images" />
          </div>
          <p class="section-heading fs-24 lh-base fw-semibold mx-auto mb-40px">
      ...
      @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
        <div class="v-card-section">
          <div class="v-bg-img position-relative pt-40 mb-60px pb-40px">
            <p class="section-heading fs-24 lh-base fw-semibold mx-auto mb-40px text-white-100 position-relative z-2">
            ...
            <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
              ...
              @if (empty($vcard->hide_stickybar))
                <div class="{{ isset($vcard->whatsapp_share) ? 'vcard34-btn-group' : 'stickyIcon' }}">
                  <button type="button" class="vcard34-btn-group vcard34-share vcard34-sticky-btn mb-3 px-2 py-1"><i
