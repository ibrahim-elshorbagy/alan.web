...
<body>
    <div class="container p-0">
        ...
        <div
            ...
            {{-- profile section --}}
            <div class="profile-section px-30 @if($vcard->cover_type == 2) profile-margin @endif" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                <div class="row">
                    <div class="col-sm-8">
            ...
            @if ((isset($managesection) && $managesection['insta_embed']) || empty($managesection))
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="">
                        <div class="section-heading left-heading mb-5 mt-5 text-white px-30"  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            ...
            @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="iframe-section pt-40 mb-3 position-relative px-30">
                        <div class="section-heading mb-5 text-white left-heading"  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
