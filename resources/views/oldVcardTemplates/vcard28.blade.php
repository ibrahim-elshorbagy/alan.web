          ...
          @elseif ($vcard->cover_type == 2)
            <div class="youtube-link-28">
              <iframe
                ...
                class="cover-video {{ $coverClass }} h-100" frameborder="0" allow="autoplay; encrypted-media"
                allowfullscreen>
              </iframe>
            </div>
          @endif
      ...
      @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
        <div class="profile-section px-30 position-relative @if ($vcard->cover_type == 2) profile-margin @endif">
          <div class="position-absolute vector-1 vector-all">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/services-bg1.png') }}" alt="images"
              class="w-100" />
          </div>
          ...
          <div class="profile-bg img-1">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/profile-bg1.png') }}" alt="bg-vector" />
          </div>
          <div class="profile-bg img-2 text-end">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/profile-bg2.png') }}" alt="bg-vector" />
          </div>
          <div
            ...
            <div class="card-body p-0 text-center @if ($vcard->cover_type == 2) profile-desc-margin @endif">
                ...
                <div class="col-sm-6 d-flex">
                  <div class="contact-box d-flex align-items-center w-100">
                    <div class="contact-icon d-flex justify-content-center align-items-center bg-blue-light">
                      <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/location.png') }}" />
                    </div>
                    <div class="contact-desc">
        ...
        @if (checkFeature('services') && $vcard->services->count())
          <div class="our-services-section pt-60 px-30">
            <div class="services-bg img-1">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/services-bg1.png') }}" alt="bg-img" />
            </div>
            <div class="services-bg img-2 text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/services-bg2.png') }}" alt="bg-img" />
            </div>
            <div class="services-bg img-3 text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/services-bg3.png') }}" alt="bg-img" />
            </div>
            <div class="section-heading">
                    ...
                    <div>
                      <div class="service-card h-100">
                        <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                          ...
                          <img src="{{ $service->service_icon }}" class="card-img-top card-img service-new-image"
                    ...
                    <div class="col-sm-6">
                      <div class="service-card h-100">
                        ...
                        <div class="card-body text-center p-0">
                          ...
                          <p class="mb-0 fs-14 text-gray-500 text-center  {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
        ...
        @if (checkFeature('appointments') && $vcard->appointmentHours->count())
          <div class="appointment-section pt-60 px-30">
            <div class="appointment-bg img-1">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/appointment-bg1.png') }}" alt="bg-img" />
            </div>
            <div class="appointment-bg img-2">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/appointment-bg2.png') }}" alt="bg-img" />
            </div>
            <div class="appointment-bg img-3 text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/appointment-bg3.png') }}" alt="bg-img" />
            </div>
            <div class="section-heading">
        ...
        @if (checkFeature('gallery') && $vcard->gallery->count())
          <div class="gallery-section pt-60 px-30">
            <div class="gallery-bg text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/gallery-bg.png') }}" alt="bg-img" />
            </div>
            <div class="section-heading">
        ...
        @if (checkFeature('products') && $vcard->products->count())
          <div class="product-section pt-60 px-3">
            <div class="product-bg img-1">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/product-bg1.png') }}" alt="bg-img" />
            </div>
            <div class="product-bg img-2 text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/product-bg2.png') }}" alt="bg-img" />
            </div>
                ...
                <div class="">
                  <div class="product-card card">
                    ...
                    <div class="product-desc card-body p-3 text-start">
                      <h3 class="text-black fs-6 fw-5 mb-2" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        {{ $product->name }}</h3>
        ...
        @if (checkFeature('testimonials') && $vcard->testimonials->count())
          <div class="testimonial-section pt-60">
            <div class="testimonial-bg img-1">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/testimonial-bg1.png') }}" alt="bg-img" />
            </div>
            <div class="testimonial-bg img-2 text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/testimonial-bg2.png') }}" alt="bg-img" />
            </div>
              ...
              @foreach ($vcard->testimonials as $testimonial)
                <div class="px-30">
                  <div class="testimonial-card card">
                    <div class="d-flex justify-content-between" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                      <div class="d-flex align-items-center gap-3">
                        ...
                        <div class="">
                          <h3 class="text-pink fs-18" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            {{ ucwords($testimonial->name) }}
                          </h3>
                        </div>
                      </div>
                      <div class="quote-img">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/quote-img.png') }}" alt="quote"
                          class="h-100" />
                      </div>
                    </div>
                    <div class="card-body p-0 pt-3">
                      <p class="desc text-gray-500 fs-12 mb-0 text-start  {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
        ...
        @if (checkFeature('blog') && $vcard->blogs->count())
          <div class="blog-section pt-60 px-3">
            <div class="blog-bg-img text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/blog-bg-img.png') }}" alt="bg-vector" />
            </div>
        ...
        @if ($vcard->businessHours->count())
          ...
          <div class="business-hour-section pt-60 px-30">
            <div class="hour-bg-img">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/hour-bg.png') }}" alt="bg-vector" />
            </div>
            <div class="section-heading">
      ...
      @if (!empty($userSetting['enable_affiliation']))
        <div class="create-vcard-section pt-60 px-30 mb-2">
          <div class="create-vcard-bg-img">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/create-vcard-bg.png') }}" alt="bg-vector" />
          </div>
          <div class="section-heading">
      ...
      @if ($vcard->enable_contact)
        <div class="add-to-contact-section">
          <div class="text-center d-flex align-items-center justify-content-center"
            ...
            @else
              <a href="{{ route('add-contact', $vcard->id) }}" class="add-contact-btn rounded-2 btn-blue"><i
      ...
      <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
        <div class="fixed-btn-section">
          @if (empty($userSetting['hide_stickybar']))
            <div class="bars-btn pet-clinic-bars-btn @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') vcard-bars-btn-left @endif">
            ...
            <div class="sub-btn-div  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
              ...
              @if (empty($userSetting['hide_stickybar']))
                <div
                  ...
                  <button type="button" class="vcard28-btn-group vcard28-share vcard28-sticky-btn mb-3 px-2 py-1"><i
