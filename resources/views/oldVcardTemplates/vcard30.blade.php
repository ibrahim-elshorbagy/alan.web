    ...
    <div class="main-content mx-auto w-100 overflow-hidden bg-green @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
          ...
          <div class="card d-flex align-items-sm-stretch align-items-center mb-20">
            <div class="position-relative">
              ...
              <div class="profile-bg img-1 text-end">
                <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/profile-bg1.png') }}" alt="bg" />
              </div>
            </div>
            <div class="card-body p-0 text-sm-start text-center">
              ...
              <div class="arrow-img">
                <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/arrow-img.png') }}" alt="arrow" />
              </div>
            </div>
          </div>
        @endif
            ...
            @if (checkFeature('social_links') && getSocialLink($vcard))
              <div
                ...
                @foreach (getSocialLink($vcard) as $value)
                  <span class="social-icon d-flex justify-content-center align-items-center text-white">
                    {!! $value !!}
                  </span>
                @endforeach
              </div>
            ...
            <div class="col-sm-6 d-flex">
              <div class="contact-box d-flex flex-sm-column flex-row align-items-center gap-2 w-100">
                ...
                <div class="contact-desc">
                  <a href="mailto:{{ $vcard->email }}" class="text-primary fw-5">{{ $vcard->email }}</a>
                </div>
              </div>
            </div>
          @endif
          ...
          @if ($vcard->phone)
            <div class="col-sm-6 d-flex">
              <div class="contact-box d-flex flex-sm-column flex-row align-items-center gap-2 w-100">
                ...
                <div class="contact-desc">
                  <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}" class="text-primary fw-5"
        ...
        @if (checkFeature('gallery') && $vcard->gallery->count())
          <div class="gallery-section pt-60">
            <div class="gallery-bg text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/gallery-bg.png') }}" alt="bg" />
            </div>
        ...
        @if (checkFeature('services') && $vcard->services->count())
          <div class="our-services-section pt-60 px-40">
            <div class="services-bg img-1">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/service-bg1.png') }}" alt="bg" />
            </div>
            <div class="services-bg img-2 text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/service-bg2.png') }}" alt="bg" />
            </div>
            <div class="section-heading text-start">
                    ...
                    <div class="col-sm-6 mb-sm-0 mb-40 mt-3">
                      <div class="card-wrapper">
                        <div class="service-card h-100">
                          <div class="card-img d-flex justify-content-center align-items-center mx-auto mb-20">
                          ...
                          <div class="card-body p-0 text-center">
                            ...
                            <p class="mb-0 fs-14 text-gray-200 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
                              @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
        ...
        @if (checkFeature('appointments') && $vcard->appointmentHours->count())
          <div class="appointment-section pt-60 px-40">
            <div class="appointment-bg text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/appointment-bg.png') }}" alt="bg" />
            </div>
        ...
        @if (checkFeature('products') && $vcard->products->count())
          <div class="product-section pt-60 px-40">
            <div class="product-bg img-1">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/product-bg1.png') }}" alt="bg" />
            </div>
            <div class="product-bg img-2 text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/product-bg2.png') }}" alt="bg" />
            </div>
            <div class="section-heading text-start">
                    ...
                    <div class="product-card card flex-row justify-content-between align-items-center gap-4"
                      ...
                      <div class="product-desc card-body p-0">
                        <div class="d-flex flex-column">
                          <div>
                            <p class="fs-14 text-gray-200 mb-1" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                              {{ $product->name }}</p>
                          </div>
                          <div>
        ...
        @if (checkFeature('testimonials') && $vcard->testimonials->count())
          <div class="testimonial-section pt-sm-3 pt-60">
            <div class="testimonial-bg img-1">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/testimonial-bg1.png') }}" alt="bg" />
            </div>
            <div class="testimonial-bg img-2 text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/testimonial-bg2.png') }}" alt="bg" />
            </div>
            <div class="section-heading text-start px-40">
              ...
              @foreach ($vcard->testimonials as $testimonial)
                <div>
                  <div class="testimonial-card card">
                    <div class="card-body p-0 text-center">
                      <p class="desc text-white mb-4 {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
        ...
        @if ($vcard->businessHours->count())
          ...
          <div class="business-hour-section pt-60 px-40">
            <div class="hour-bg img-1">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/hour-bg1.png') }}" alt="bg" />
            </div>
            <div class="hour-bg img-2 text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/hour-bg2.png') }}" alt="bg" />
            </div>
            <div class="section-heading text-start">
        ...
        @if (checkFeature('blog') && $vcard->blogs->count())
          <div class="blog-section pt-60 px-40">
            <div class="blog-bg img-1">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/blog-bg1.png') }}" alt="bg" />
            </div>
            <div class="blog-bg img-2 text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/blog-bg2.png') }}" alt="bg" />
            </div>
            <div class="section-heading text-start">
      ...
      @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
        <div class="contact-us-section pt-30  px-40 pb-30">
          <div class="contact-us-bg img-1 text-end">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/contact-us-bg1.png') }}" alt="bg" />
          </div>
          <div class="contact-us-bg img-2">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/contact-us-bg2.png') }}" alt="bg" />
          </div>
          <div class="contact-us-bg img-3 text-end">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/contact-us-bg3.png') }}" alt="bg" />
          </div>
          <div class="section-heading text-start">
      ...
      @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
        <div class="create-vcard-section pt-60 pb-3 px-40">
          <div class="create-vcard-bg text-end">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/create-vcard-bg.png') }}" alt="bg" />
          </div>
          <div class="section-heading text-start">
      ...
      <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
        <div class="fixed-btn-section">
          <div class="bars-btn taxi-bars-btn @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') vcard-bars-btn-left @endif">
          ...
          <div class="sub-btn d-none">
            <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
              ...
              @if (empty($vcard->hide_stickybar))
                <div class="{{ isset($vcard->whatsapp_share) ? 'vcard30-btn-group' : 'stickyIcon' }}">
                  <button type="button" class="vcard30-btn-group vcard30-share vcard30-sticky-btn mb-3 px-2 py-1"><i
