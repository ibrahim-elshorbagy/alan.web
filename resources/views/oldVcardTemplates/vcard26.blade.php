  ...
  <div class="container p-0">
    ...
    <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
      ...
      <div class="profile-section px-30">
        <div class="cart-img">
          <img src="{{ asset('assets/img/oldVcardTemplate/vcard26/cart.png') }}" alt="cart-img" loading="lazy" />
        </div>
        ...
        <div class="contact-section px-30 mt-4">
          ...
          @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
            <div class="row d-flex">
              @if ($vcard->email)
                <div class="col-sm-6 mb-4 pb-sm-2 d-flex">
                  <div class="contact-box d-flex align-items-center w-100">
                    <div class="contact-icon d-flex justify-content-center align-items-center me-2">
                      <img src="{{ asset('assets/img/oldVcardTemplate/vcard26/email.png') }}" loading="lazy" />
                    </div>
              ...
              @if ($vcard->phone)
                <div class="col-sm-6 mb-4 pb-sm-2 d-flex">
                  <div class="contact-box d-flex align-items-center w-100">
                    <div class="contact-icon d-flex justify-content-center align-items-center me-2">
                      <img src="{{ asset('assets/img/oldVcardTemplate/vcard26/phone.png') }}" loading="lazy" />
                    </div>
                    <div class="contact-desc">
              ...
              @if ($vcard->dob)
                <div class="col-sm-6 mb-4 pb-sm-2 d-flex">
                  <div class="contact-box d-flex align-items-center w-100">
                    <div class="contact-icon d-flex justify-content-center align-items-center me-2">
                      <img src="{{ asset('assets/img/oldVcardTemplate/vcard26/dob.png') }}" loading="lazy" />
                    </div>
                    <div class="contact-desc">
              ...
              @if ($vcard->location)
                <div class="col-sm-6 d-flex">
                  <div class="contact-box d-flex align-items-center w-100">
                    <div class="contact-icon d-flex justify-content-center align-items-center me-2">
                      <img src="{{ asset('assets/img/oldVcardTemplate/vcard26/location.png') }}" loading="lazy" />
                    </div>
                    <div class="contact-desc">
                    ...
                    <div class="product-card card">
                      ...
                      <div class="product-desc align-items-center">
                        <div class="d-flex justify-content-between align-items-center mb-1">
                          <h3 class="text-white fs-18 fw-5 mb-0" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            {{ $product->name }}</h3>
        ...
        @if (checkFeature('appointments') && $vcard->appointmentHours->count())
          <div class="appointment-section px-10 pb-5 position-relative">
            <div class="position-absolute vector-all vector-2">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard26/vector-1.png') }}" alt="images"
                class="w-100" />
            </div>
      ...
      @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
        <div class="qr-code-section pt-60 px-40">
          <div class="percentage-img2">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard26/percrentage-2.png') }}" alt="percentage-img2"
              loading="lazy" />
          </div>
          <div class="bag-img text-end">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard26/bag.png') }}" alt="bag-img" loading="lazy" />
          </div>
      ...
      @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
        <div class="contact-us-section px-30 position-relative">
          <div class="add-to-bag-img text-end">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard26/add-to-bag.png') }}" alt="add-to-bag-img"
              loading="lazy" />
          </div>
          <div class="section-heading text-center mb-40">
      ...
      @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
        <div class="create-vcard-section">
          <div class="delivery-van-img">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard26/delivery-van.png') }}" alt="delivery-van-img"
              loading="lazy" />
          </div>
      ...
      @if ($vcard->enable_contact)
        <div class="add-to-contact-section ">
          <div class="text-center d-flex align-items-center justify-content-center"
            ...
            @else
              <a href="{{ route('add-contact', $vcard->id) }}" class="add-contact-btn rounded-2 btn-secondary"><i
      ...
      <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
        <div class="fixed-btn-section">
          @if (empty($vcard->hide_stickybar))
            <div class="bars-btn retail-bars-btn  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') vcard-bars-btn-left @endif">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard26/sticky.png') }}" loading="lazy" />
            </div>
          @endif
            ...
            <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
              ...
              @if (empty($vcard->hide_stickybar))
                <div class="{{ isset($vcard->whatsapp_share) ? 'vcard21-btn-group' : 'stickyIcon' }}">
                  <button type="button" class="vcard26-btn-group vcard26-share vcard26-sticky-btn mb-3 px-2 py-1"><i
