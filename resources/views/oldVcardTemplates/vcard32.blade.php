  ...
  <div class="container p-0">
    ...
    <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
      ...
      <div class=" d-flex gap-4 flex-column px-30">
        ...
        {{-- social-media --}}
        <div class="social-media-section position-relative" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
          @if (checkFeature('social_links') && getSocialLink($vcard))
            <div class="d-flex gap-3 flex-row flex-wrap justify-content-center align-items-center">
              <div class="position-absolute vector-all vector-1">
                <img src={{ asset('assets/img/oldVcardTemplate/vcard32/vector-1.png') }} alt="images"
                  class="w-100" />
              </div>
              ...
              @if ($vcard->phone)
                <div class="col-sm-6 d-flex">
                  <div class="contact-box d-flex align-items-center w-100">
                    ...
                    <div class="contact-desc">
                      <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}" class="text-secondary fs-6 fw-5"
                    ...
                    <div class="col-sm-6">
                      <div class="service-card h-100 px-3">
                        ...
                        <div class="card-body p-0 text-start">
                          <h3 class="card-title fs-18 text-dark" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            {{ ucwords($service->name) }}</h3>
                          <p class="mb-0 fs-14 text-gray {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
                ...
                <div>
                  <div class="gallery-img">
                    @if ($file->type == App\Models\Gallery::TYPE_IMAGE)
                      <a href="{{ $file->gallery_image }}" class="d-block w-100 h-100 object-fit-cover"
                        data-lightbox="gallery-images"><img src="{{ $file->gallery_image }}" alt="profile"
                          class="w-100 h-100 object-fit-cover" loading="lazy" /></a>
                    @elseif($file->type == App\Models\Gallery::TYPE_FILE)
                      <a id="file_url" href="{{ $file->gallery_image }}"
                        class="gallery-link gallery-file-link d-block w-100 h-100 object-fit-cover" target="_blank"
                        loading="lazy">
 ...
 @endif
          ...
          @if (checkFeature('products') && $vcard->products->count())
            <div class="product-section pt-50 px-30 pb-5">
              <div class="product-bg text-end">
                <img src="{{ asset('assets/img/oldVcardTemplate/vcard32/product-bg.png') }}" alt="bg" />
              </div>
              <div class="position-absolute vector-all vector-4">
                <img src={{ asset('assets/img/oldVcardTemplate/vcard32/vector-4.png') }} alt="images"
                  class="w-100" />
              </div>
              <div class="section-heading">
                    ...
                    <a @if ($product->product_url) href="{{ $product->product_url }}" @endif target="_blank"
                      ...
                      <div class="product-card card">
                        ...
                        <div class="product-desc mt-auto">
                          <h3 class="text-dark fs-6 mb-1" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            {{ $product->name }}</h3>
                          <p class="amount fs-6 mb-0 fw-6 text-secondary">
                            @if ($product->currency_id && $product->price)
                              <span class="fs-18 fw-6 text-secondary"
          ...
          @if (checkFeature('testimonials') && $vcard->testimonials->count())
            <div class="testimonial-section px-30 pb-5">
              ...
              <div class="testimonial-bg">
                <img src="{{ asset('assets/img/oldVcardTemplate/vcard32/testimonial-bg.png') }}" alt="bg-img" />
              </div>
                  ...
                  <div>
                    <div class="testimonial-card card">
                      <div class="card-body p-0 mb-20">
                        <p class="desc text-gray fs-14 mb-0 { \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}"
                          @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian')
                          dir="rtl"
                @endif>
              ...
              <div class="d-flex gap-3 align-items-center">
                <div class="card-img testimonial-profile-img">
                  <img src="{{ $testimonial->image_url }}" class="w-100 h-100 object-fit-cover" loading="lazy" />
                </div>
                <h6 class="text-dark mb-0" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
    ...
    @if (checkFeature('blog') && $vcard->blogs->count())
      <div class="blog-section pt-50 pb-5 position-relative">
        <div class="position-absolute vector-all vector-5 text-end">
          <img src={{ asset('assets/img/oldVcardTemplate/vcard32/vector-5.png') }} alt="images" class="w-100" />
        </div>
        <div class="position-absolute vector-all vector-6">
          <img src={{ asset('assets/img/oldVcardTemplate/vcard32/vector-6.png') }} alt="images" class="w-100" />
        </div>
        <div class="section-heading">
          ...
          @foreach ($vcard->blogs as $blog)
            ...
            <div class="px-30">
              <div class="blog-card card flex-column gap-4">
                ...
                <a href="{{ $vcardBlogUrl }}">
                  <img src="{{ $blog->blog_icon }}" class="w-100 h-100 object-fit-cover card-img" loading="lazy" />
                </a>
  ...
  @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
    @if ($vcard->businessHours->count())
      ...
      @endphp
      <div
        class="business-hour-section position-relative pb-50 px-30 {{ checkFeature('blog') && $vcard->blogs->count() ? 'pt-0' : 'pt-50' }}"
        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
        <div class="position-absolute vector-all vector-7">
          <img src={{ asset('assets/img/oldVcardTemplate/vcard32/vector-7.png') }} alt="images" class="w-100" />
        </div>
        <div class="section-heading">
        ...
        <div class="business-hour-img text-end">
          <img src="{{ asset('assets/img/oldVcardTemplate/vcard32/business-hour-bg.png') }}" alt="bg-img" />
        </div>
    ...
    @if (checkFeature('iframes') && $vcard->iframes->count())
      <div class="blog-section pt-50 pb-50 position-relative">
        <div class="position-absolute vector-all vector-9">
          <img src={{ asset('assets/img/oldVcardTemplate/vcard32/vector-9.png') }} alt="images" class="w-100" />
        </div>
        <div class="section-heading">
  ...
  @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
    <div class="contact-us-section pb-40 px-40 position-relative" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
      <div class="position-absolute vector-all vector-8">
        <img src={{ asset('assets/img/oldVcardTemplate/vcard32/vector-8.png') }} alt="images" class="w-100" />
      </div>
      <div class="contact-bg-img text-end">
        <img src="{{ asset('assets/img/oldVcardTemplate/vcard32/contact-bg.png') }}" alt="bg-img" />
      </div>
      <div class="section-heading">
      ...
      <div class="contact-form">
        <form action="" id="enquiryForm" enctype="multipart/form-data">
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <input type="tel" class="form-control text-start" placeholder="{{ __('messages.form.phone') }}"
                name="phone"
    ...
    <div class="fixed-btn-section">
      ...
      <div class="sub-btn d-none">
        <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
          ...
          @endif
          @if (empty($vcard->hide_stickybar))
            <div class="{{ isset($vcard->whatsapp_share) ? 'vcard32-btn-group' : 'stickyIcon' }}">
              <button type="button" class="vcard32-btn-group vcard32-share vcard32-sticky-btn mb-3 px-2 py-1"><i
