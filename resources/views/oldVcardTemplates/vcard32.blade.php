            ...
            <div class=" d-flex gap-4 flex-column px-30">
                ...
                <div class="social-media-section position-relative" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    @if (checkFeature('social_links') && getSocialLink($vcard))
                        ...
                        <img src={{ asset ('assets/img/oldVcardTemplate/vcard32/vector-1.png') }} alt="images" class="w-100"/>
                        </div>
            ...
            @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-50 pb-50 position-relative">
                        ...
                        <img src={{ asset ('assets/img/oldVcardTemplate/vcard32/vector-2.png') }} alt="images" class="w-100"/>
                        </div>
                        <div class="position-absolute vector-all vector-3">
                        <img src={{ asset ('assets/img/oldVcardTemplate/vcard32/vector-3.png') }} alt="images" class="w-100"/>
                        </div>
                        <div class="section-heading">
            ...
            @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section pt-50 px-30 pb-5">
                        ...
                        <img src={{ asset ('assets/img/oldVcardTemplate/vcard32/vector-4.png') }} alt="images" class="w-100"/>
                        </div>
                        <div class="section-heading">
                ...
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section px-30 pb-5">
                        ...
                        <div class="quote-img text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard32/testimonial-vector-1.svg') }}" alt="bg-img" />
                        </div>
