    ...
    <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
      ...
      <div class="profile-section px-40 @if ($vcard->cover_type == 2) profile-margin @endif">
        <div class="card d-flex flex-sm-row align-items-sm-end align-items-center">
          ...
          <div class="card-body text-center pt-30">
          ...
          <div class="row">
              ...
              <div class="col-sm-6 mb-5 px-lg-4 px-sm-3">
                <div class="contact-box">
                  <div class="contact-icon d-flex justify-content-center align-items-center">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard23/email.png') }}" loading="lazy" />
                  </div>
                  <div class="contact-desc">
                    <a href="mailto:{{ $vcard->email }}" class="text-secondary fs-14 fw-5">{{ $vcard->email }}</a>
                  </div>
                </div>
              </div>
            @endif
            ...
            @if ($vcard->phone)
              <div class="col-sm-6 mb-5 px-lg-4 px-sm-3">
                <div class="contact-box">
                  <div class="contact-icon d-flex justify-content-center align-items-center">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard23/phone.png') }}" loading="lazy" />
                  </div>
                  <div class="contact-desc">
                    <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}" class="text-secondary fs-14 fw-5"
            ...
            @if ($vcard->dob)
              <div class="col-sm-6 mb-sm-0 mb-5 px-lg-4 px-sm-3">
                <div class="contact-box">
                  <div class="contact-icon d-flex justify-content-center align-items-center">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard23/dob.png') }}" loading="lazy" />
                  </div>
                  <div class="contact-desc">
            ...
            @if ($vcard->location)
              <div class="col-sm-6 px-lg-4 px-sm-3">
                <div class="contact-box">
                  <div class="contact-icon d-flex justify-content-center align-items-center">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard23/location.png') }}" loading="lazy" />
                  </div>
                  <div class="contact-desc">
        ...
        @if (checkFeature('services') && $vcard->services->count())
          <div class="our-services-section px-40 pt-60">
            <div class="services-bg-img text-center">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard23/services-bg-img.png') }}" alt="services-bg-img"
                loading="lazy" />
            </div>
                      ...
                      <div class="service-card h-100">
                        <div class="card-img mx-auto d-flex justify-content-center mb-3">
                          <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                            ...
                            target="{{ $service->service_url ? '_blank' : '' }}">
                            <img src="{{ $service->service_icon }}" alt="branding" class="h-100 w-100"
                              loading="lazy" />
                          </a>
                        </div>
          ...
          <div class="gallery-section pt-60 pb-50">
            ...
            <div class="position-relative">
              <div class="gallery-bg-img text-end">
                <img src="{{ asset('assets/img/oldVcardTemplate/vcard23/gallery-bg.png') }}" alt="gallery-bg"
                  loading="lazy" />
              </div>
        ...
        @if (checkFeature('testimonials') && $vcard->testimonials->count())
          <div class="testimonial-section pt-60 px-40 pb-30 mb-4">
            <div class="testimonial-bg-img">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard23/testimonial-bg.png') }}" loading="lazy" />
            </div>
            <div class="section-heading text-center mb-40">
                  ...
                  <div class="">
                    <div class="product-card card">
                      ...
                      <div class="product-desc card-body p-3">
                        <h3 class="text-secondary fs-18 fw-5 mb-1 text-truncate" title="{{ $product->name }}"
                          @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                          {{ $product->name }}
                        </h3>
                        <p class="mb-2 text-gray-100 fs-14" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                          {{ $product->description }}
                        </p>
        ...
        @if (checkFeature('blog') && $vcard->blogs->count())
          <div class="blog-section mt-2 pb-3 pt-60">
            <div class="blog-bg text-center">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard23/blog-bg.png') }}" alt="blog-bg" />
            </div>
            <div class="section-heading text-center mb-40">
      ...
      @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
        <div class="qr-code-section pt-60">
          <div class="qr-bg-img text-end">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard23/qr-code-bg.png') }}" alt="qr-code-bg"
              loading="lazy" />
          </div>
        ...
        <div class="fixed-btn-section">
          @if (empty($vcard->hide_stickybar))
            <div class="bars-btn consulting-bars-btn @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') vcard-bars-btn-left @endif">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard23/sticky-btn.png') }}" loading="lazy" />
            </div>
          @endif
