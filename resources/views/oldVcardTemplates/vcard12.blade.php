...
<body class="bg-primary-100">
  <div>
    ...
    @endif
    <div class="main-content mx-auto w-100 overflow-hidden bg-gray-200 @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
      {{-- Pwa support --}}
      ...
      @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
        <div class="contact-section position-relative px-30 ">
          ...
          <div class="chest-expander-img" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard12/chest-expander.png') }}" alt="chest-expander" />
          </div>
              ...
              <div class="row">
                <div class="col-sm-6 mb-40">
                  <div class="contact-box">
                    <div class="contact-icon ms-0 me-4 mx-sm-auto d-flex justify-content-center align-items-center">
                      <img src="{{ asset('assets/img/oldVcardTemplate/vcard12/email-icon.png') }}" />
                    </div>
                ...
                @if ($vcard->phone)
                  <div class="col-sm-6 mb-40">
                    <div class="contact-box">
                      <div class="contact-icon ms-0 me-4 mx-sm-auto d-flex justify-content-center align-items-center">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard12/phone.png') }}" />
                      </div>
                      <div class="contact-desc text-center">
                ...
                @if ($vcard->dob)
                  <div class="col-sm-6 mb-40">
                    <div class="contact-box">
                      <div class="contact-icon ms-0 me-4 mx-sm-auto d-flex justify-content-center align-items-center">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard12/bod-icon.png') }}" />
                      </div>
                      <div class="contact-desc text-center">
                ...
                @if ($vcard->location)
                  <div class="col-sm-6 mb-40">
                    <div class="contact-box">
                      <div class="contact-icon ms-0 me-4 mx-sm-auto d-flex justify-content-center align-items-center">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard12/location-icon.png') }}" />
                      </div>
                      <div class="contact-desc text-center">
                    ...
                    <div class="col-sm-6 mb-sm-0 mb-40 mt-4">
                      <div class="service-card card h-100">
                        <div class="card-img mb-4">
                          <a href="{{ $service->service_url ?? 'javascript:void(0)' }}" class="text-decoration-none"
                            target="{{ $service->service_url ? '_blank' : '' }}">
                            <img src="{{ $service->service_icon }}" alt="physical-fitness" class="img-fluid h-100"
                              loading="lazy" />
                          </a>
                        </div>
                        <div class="card-body p-0">
                          <h3 class="card-title fs-20 text-white" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            ...
            <div class="gallery-slider pt-3 mt-3">
              @foreach ($vcard->gallery as $file)
                ...
                @if ($file->type == App\Models\Gallery::TYPE_IMAGE)
                  <div class="">
                    <a href="{{ $file->gallery_image }}" data-lightbox="gallery-images" class="gallery-img"><img
                  ...
                  <a @if ($product->product_url) href="{{ $product->product_url }}" @endif target="_blank"
                    ...
                    <div class="product-card card">
                      <div class="product-img card-img">
                        <img src="{{ $product->product_icon }}" class="object-fit-cover h-100 w-100"
                          loading="lazy" />
                      </div>
                      <div class="product-desc card-body">
                        <div class="product-title">
                          <h3 class="text-white fs-6" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            {{ $product->name }}</h3>
                        </div>
                        <p class="fs-14 text-gray-100 mb-0 text-truncate"
                          @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>{{ $product->description }}</p>
        ...
        @if (checkFeature('testimonials') && $vcard->testimonials->count())
          <div class="testimonial-section pb-4" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            ...
            <div class=" bg-black position-relative">
              <div class="quote-img">
                <img src="{{ asset('assets/img/oldVcardTemplate/vcard12/quote-img.png') }}" class="h-100"
                  loading="lazy" />
              </div>
              <div class="bg-img">
                <img src="{{ asset('assets/img/oldVcardTemplate/vcard12/testimonial-bg.png') }}" loading="lazy" />
              </div>
              <div class="testimonial-slider px-30 pt-60 pb-30 ">
                @foreach ($vcard->testimonials as $testimonial)
                  <div class="">
                    <div class="testimonial-card h-100">
                      <div class="card-body d-flex flex-column justify-content-between p-0 text-sm-start text-center">
                        <p class="text-gray-100 fw-5 fs-14 mb-20 {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}"
                          @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        ...
                        <div class="d-flex align-items-center justify-content-sm-start justify-content-center"
                          ...
                          <div class="profile-img me-3">
                            <img src="{{ $testimonial->image_url }}" class="w-100 h-100 object-fit-cover ms-2"
                              loading="lazy">
                          </div>
                          <div class="">
                            <h6 class="name fw-5 text-white mb-0" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            ...
            <nav>
              <div class="row insta-toggle">
                <div class="nav nav-tabs px-0 border-0 d-flex justify-content-around" id="nav-tab" role="tablist">
                  ...
                  <button class="d-flex align-items-center justify-content-center py-2 instagram-btn reelsbtn border-0"
      ...
      @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
        @if ($vcard->businessHours->count())
          ...
          @endphp
          <div class="bussiness-hour-section pt-30 px-30 pb-30" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            <div class="section-heading text-center overflow-hidden">
              <h2 class="text-white mb-0 d-inline-block">
                ...
                <div class="col-8 mx-auto mb-20">
                  <div class="position-relative">
                    ...
                    <span class="calendar-icon">
                      <img src="{{ asset('assets/img/oldVcardTemplate/vcard12/calendar 1.png') }}" />
                    </span>
                  </div>
                </div>
                <div class="col-12">
      ...
      @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
        {{-- create vcard --}}
        <div class="create-vcard-section px-30 pb-30 pt-30" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
          <div class="section-heading text-center overflow-hidden">
            <h2 class="text-white mb-0 d-inline-block">
