      ...
      @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
        <div class="contact-section pt-40 pb-4 position-relative">
          <div class="position-absolute vector-all vector-3 text-end">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard14/banner-vector-3.png') }}" alt="images"
              class="w-100" />
          </div>
              ...
              <div class="row d-flex">
                  ...
                  <div class="col-sm-6 mb-40 d-flex">
                    <div class="contact-box d-flex align-items-center w-100">
                      <div class="contact-icon d-flex justify-content-center align-items-center">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard14/email.png') }}" />
                      </div>
                      <div class="contact-desc">
                        <a href="mailto:{{ $vcard->email }}" class="text-white">{{ $vcard->email }}</a>
                      </div>
                    </div>
                  </div>
                @endif
                ...
                @if ($vcard->phone)
                  <div class="col-sm-6 mb-40 d-flex">
                    <div class="contact-box d-flex align-items-center w-100">
                      <div class="contact-icon d-flex justify-content-center align-items-center">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard14/phone.png') }}" />
                      </div>
                      <div class="contact-desc">
                ...
                @if ($vcard->dob)
                  <div class="col-sm-6 mb-sm-0 mb-40 d-flex">
                    <div class="contact-box d-flex align-items-center w-100">
                      <div class="contact-icon d-flex justify-content-center align-items-center">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard14/dob-icons.png') }}" />
                      </div>
                      <div class="contact-desc">
                ...
                @if ($vcard->location)
                  <div class="col-sm-6 d-flex">
                    <div class="contact-box d-flex align-items-center w-100">
                      <div class="contact-icon d-flex justify-content-center align-items-center">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard14/location-icons.png') }}" />
                      </div>
                      <div class="contact-desc">
      ...
      @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
        <div class="qr-code-section pt-60 position-relative">
          <div class="position-absolute vector-2 vector-all">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard14/vector-qr-code-1.png') }}" alt="images"
              class="w-100" />
          </div>
        ...
        @if (checkFeature('services') && $vcard->services->count())
          <div class="our-services-section mt-5 position-relative">
            <div class="position-absolute vector-all vector-4">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard14/service-vector-4.png') }}" alt="images"
                class="w-100" />
            </div>
            <div class="section-heading-left">
                ...
                <div class="row">
                  @foreach ($vcard->services as $service)
                    <div class="col-12 mb-40">
                      <div class="service-card d-flex flex-row" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        ...
                        <div class="card-body p-0">
                          ...
                          <p class="mb-0 fs-14 text-gray-100" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                      ...
                      <div class="product-card card">
                        ...
                        <div class="product-desc card-body">
                          <div class="product-title">
                            <h3 class="text-white fs-18" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>{{ $product->name }}</h3>
                          </div>
                          <div class="product-amount" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') style="direction: rtl; text-align: right; display: block;" @endif>
        ...
        @if (checkFeature('testimonials') && $vcard->testimonials->count())
          <div class="testimonial-section pt-20 pb-40 position-relative">
            <div class="position-absolute vector-all vector-5 text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard14/testimonail-vector-5.png') }}" alt="images"
                class="w-100" />
            </div>
                    ...
                    <div class="testimonial-card position-relative">
                      ...
                      <div class="card-body p-0">
                        <div class="text-sm-start text-center">
                          <p
                            class="desc text-gray-100 {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                          ...
                          <div class="d-flex align-items-center justify-content-sm-start justify-content-center"
                            ...
                            <div class="profile-img me-3 ms-2">
                              <img src="{{ $testimonial->image_url }}" class="img-fluid h-100" loading="lazy" />
                            </div>
                            <div>
                              <h6 class="fs-6 text-white mb-0" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
        ...
        @if (checkFeature('appointments') && $vcard->appointmentHours->count())
          <div class="appointment-section pb-4 mb-2 position-relative">
            <div class="position-absolute vector-all vector-1">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard14/vector-1.png') }}" alt="images"
                class="w-100" />
            </div>
            <div class="section-heading-left">
          ...
          <div class="bussiness-hour-section mt-5">
            ...
            <div class="px-30 position-relative">
              <div class="position-absolute vector-all vector-7">
                <img src="{{ asset('assets/img/oldVcardTemplate/vcard14/business-vector-7.png') }}" alt="images"
                  class="w-100" />
              </div>
              <div class="position-absolute vector-all vector-6">
                <img src="{{ asset('assets/img/oldVcardTemplate/vcard14//businness-vector-6.png') }}" alt="images"
                  class="w-100" />
              </div>
                ...
                <form action="" id="enquiryForm" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    ...
                    <div class="col-12 d-flex justify-content-center mt-4">
                      <button class="contact-btn btn btn-gradient rounded-2 d-flex align-items-center" type="submit">
      ...
      <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
        <div class="fixed-btn-section">
          @if (empty($vcard->hide_stickybar))
            <div class="bars-btn event-bars-btn @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') vcard-bars-btn-left @endif">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard14/sticky.png') }}" loading="lazy" />
            </div>
          @endif
