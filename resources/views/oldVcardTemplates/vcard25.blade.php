    ...
    <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
      ...
      <div class="profile-section px-30 @if ($vcard->cover_type == 2) profile-margin @endif"
        ...
        <div class="profile-bg-img">
          <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/profile-bg-img.png') }}" loading="lazy" />
        </div>
        <div class="card d-flex flex-sm-row align-items-sm-start align-items-center mb-sm-4 mb-3 pb-sm-2"
          ...
          <div class="card-body text-center mt-sm-5 pt-sm-4">
            ...
            <div class="row">
              @if ($vcard->email)
                <div class="col-sm-6 mb-4 pb-sm-2 px-lg-4 px-sm-3">
                  <div class="contact-box text-center">
                    <div class="contact-icon d-flex justify-content-center align-items-center mx-auto mb-3">
                      <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/email.png') }}" loading="lazy" />
                    </div>
                    <div class="contact-desc">
                      <a href="mailto:{{ $vcard->email }}" class="text-secondary fs-6 fw-5">{{ $vcard->email }}</a>
                    </div>
                  </div>
                </div>
              @endif
              ...
              @if ($vcard->phone)
                <div class="col-sm-6 mb-4 pb-sm-2 px-lg-4 px-sm-3">
                  <div class="contact-box text-center">
                    <div class="contact-icon d-flex justify-content-center align-items-center mx-auto mb-3">
                      <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/phone.png') }}" loading="lazy" />
                    </div>
                    <div class="contact-desc">
              ...
              @if ($vcard->dob)
                <div class="col-sm-6 mb-4 pb-sm-2 px-lg-4 px-sm-3">
                  <div class="contact-box text-center">
                    <div class="contact-icon d-flex justify-content-center align-items-center mx-auto mb-3">
                      <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/dob-icon.png') }}" loading="lazy" />
                    </div>
                    <div class="contact-desc">
              ...
              @if ($vcard->location)
                <div class="col-sm-6 mb-4 pb-sm-2 px-lg-4 px-sm-3">
                  <div class="contact-box text-center">
                    <div class="contact-icon d-flex justify-content-center align-items-center mx-auto mb-3">
                      <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/location.png') }}" loading="lazy" />
                    </div>
                    <div class="contact-desc">
        ...
        @if (checkFeature('gallery') && $vcard->gallery->count())
          <div class="gallery-section pt-60 px-30 position-relative mb-5 pb-2">
            <div class="gallery-bg-img">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/gallery-bg.png') }}" alt="gallery-bg"
                loading="lazy" />
            </div>
        ...
        @if (checkFeature('services') && $vcard->services->count())
          <div class="our-services-section pt-60">
            <div class="services-bg-img">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/services-bg.png') }}" alt="services-bg-img"
                loading="lazy" />
            </div>
        ...
        @if (checkFeature('products') && $vcard->products->count())
          <div class="product-section pt-60 px-30 mb-5">
            <div class="product-bg-img text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/product-bg.png') }}" alt="product-bg-img"
                loading="lazy" />
            </div>
            <div class="section-heading text-center mb-40">
                      ...
                      <div class="product-desc align-items-center">
                        <div class="d-flex justify-content-between mb-1">
                          <h3 class="text-secondary fs-18 fw-5 mb-0"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>{{ $product->name }}
                          </h3>
                        ...
                        <p class="mb-0 text-gray-100 fs-14" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                          {{ $product->description }}
                        </p>
                      </div>
                    </div>
          ...
          <div class="testimonial-section pt-60 pb-5">
            ...
            <div class="testimonial-slider pt-60 pb-40 px-40">
              @foreach ($vcard->testimonials as $testimonial)
                <div class="">
                  <div class="testimonial-card card flex-sm-row" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    ...
                    <div class="card-body p-0 text-sm-start text-center">
                      <div class="">
                        ...
                        <h3 class="text-white fs-20 fw-6 mb-1" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                          {{ ucwords($testimonial->name) }}
                        </h3>
                        <p class="desc text-white fs-14 {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}"
                          @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
        ...
        @if (checkFeature('blog') && $vcard->blogs->count())
          <div class="blog-section pt-60 pb-5">
            <div class="blog-bg-vector1">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/blog-bg-vector1.png') }}" alt="blog-bg-vector"
                loading="lazy" />
            </div>
            <div class="blog-bg-vector2">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/blog-bg-vector2.png') }}" alt="blog-bg-vector"
                loading="lazy" />
            </div>
            <div class="section-heading text-center mb-40">
                      ...
                      <div class="col-6 d-flex align-items-center">
                        <div class="blog-vector">
                          <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/blog-vector.png') }}"
                            alt="log-vector" class="w-100 h-100 object-fit-cover" loading="lazy" />
                        </div>
        ...
        @if ($vcard->businessHours->count())
          ...
          <div class="business-hour-section pt-60 px-40 mb-5">
            <div class="business-hour-bg">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/business-hour-bg.png') }}" alt="bg-img"
                loading="lazy" />
            </div>
            <div class="section-heading text-center mb-40">
        ...
        <div class="qr-code-section pt-60 px-40">
          ...
          <div class="qr-code mx-auto position-relative">
            <div class="qr-bg-img text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/qr-code-bg.png') }}" alt="qr-bg-img"
                loading="lazy" />
            </div>
        ...
        @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
          <div class="contact-us-section pt-30 px-30 position-relative">
            <div class="contact-bg-img">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/contact-bg.png') }}" loading="lazy" />
            </div>
            <div class="section-heading text-center mb-40">
            ...
            <div class="contact-form">
              <form action="" id="enquiryForm" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="mb-3">
                      <label class="mb-1 fs-16 fw-5">{{ __('messages.sadmin_dashboard.name') }}</label>
        ...
        <div class="fixed-btn-section">
          @if (empty($vcard->hide_stickybar))
            <div
              ...
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/sticky.png') }}" loading="lazy" />
            </div>
          @endif
            ...
            <div class="sub-btn-div  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
              ...
              @if (empty($vcard->hide_stickybar))
                <div class="{{ isset($vcard->whatsapp_share) ? 'vcard25-btn-group' : 'stickyIcon' }}">
                  <button type="button" class="vcard25-btn-group vcard25-share vcard25-sticky-btn mb-3 px-2 py-1"><i
