                ...
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-60 px-30 mb-5 pb-2">
                        ...
                        <div class="appointment">
                            ...
                            <div class="row">
                                <div class="col-sm-2">
                                    <label class="mt-sm-3 mb-2" id="hourSection" style="display: none;">{{ __('messages.hour') }}:</label>
                                </div>
                                <div class="col-sm-10">
                    ...
                    <div class="business-hour-section pt-60 px-40 mb-5">
                        ...
                        <div class="business-hours" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            <div class="business-hour-vector1">
                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/business-hour-vector.png') }}" alt="vector"
                                    loading="lazy" />
                            </div>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section pt-100">
                    <div class="create-vcard-img1">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/create-vcard-img1.png') }}" alt="create-vcard-img"
                            loading="lazy" />
                    </div>
                    <div class="create-vcard-img2 text-end">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/create-vcard-img2.png') }}" alt="create-vcard-img"
                            loading="lazy" />
                    </div>
