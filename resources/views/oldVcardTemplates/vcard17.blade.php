    ...
    <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
                  ...
                  <div class="col-sm-6 mb-4">
                    <div class="contact-wrapper mb-2 bg-pink h-100">
                      <div class="contact-box h-100">
                        <div class="contact-icon d-flex justify-content-center align-items-center bg-pink mb-2">
                ...
                @if ($vcard->phone)
                  <div class="col-sm-6 mb-4">
                    <div class="contact-wrapper mb-2 bg-orange h-100">
                      <div class="contact-box h-100">
                        <div class="contact-icon d-flex justify-content-center align-items-center bg-orange mb-2">
                ...
                @if ($vcard->dob)
                  <div class="col-sm-6 mb-4">
                    <div class="contact-wrapper mb-2 bg-blue h-100">
                      <div class="contact-box h-100">
                        <div class="contact-icon d-flex justify-content-center align-items-center bg-blue mb-2">
                          <img src="{{ asset('assets/img/oldVcardTemplate/vcard17/dob-icon.png') }}"
                            class="w-100" />
                        </div>
                        <div class="contact-desc pt-2">
                ...
                @if ($vcard->location)
                  <div class="col-sm-6 mb-4">
                    <div class="contact-wrapper mb-2 bg-purple h-100">
                      <div class="contact-box h-100">
                        <div class="contact-icon d-flex justify-content-center align-items-center bg-purple mb-2">
                          <img src="{{ asset('assets/img/oldVcardTemplate/vcard17/location.png') }}"
                            class="w-100" />
                        </div>
                        <div class="contact-desc pt-2">
                  ...
                  @foreach ($vcard->services as $service)
                    <div class="col-sm-6 mb-40 d-flex">
                      <div class="service-card d-flex flex-column align-items-center gap-2 h-100 w-100"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        <div
                          class="card-img d-flex justify-content-center align-items-center me-sm-4 me-3 ms-3 flex-shrink-0">
                          <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                    ...
                    <div class="gallery-img">
                      @if ($file->type == App\Models\Gallery::TYPE_IMAGE)
                        <a href="{{ $file->gallery_image }}" data-lightbox="gallery-images"><img
                            src="{{ $file->gallery_image }}" alt="profile" class="w-100 bg-white rounded-20px"
                            loading="lazy" /></a>
              ...
              @foreach ($vcardProducts as $product)
                <div>
                  <a @if ($product->product_url) href="{{ $product->product_url }}" @endif target="_blank"
                    class="text-decoration-none fs-6 card-wrapper">
                    <div class="card product-card">
                      <div class="card-img">
                        <img src="{{ $product->product_icon }}" class="h-100 w-100 object-fit-contain"
                          loading="lazy" />
                      </div>
                      <div class="bg-primary-light card-body">
                        <div class="d-flex justify-content-between">
                          <div class="product-title">
                            <h3 class="text-primary fs-18 fw-5" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                              {{ $product->name }}</h3>
                          </div>
                          <div
                        ...
                        <p class="text-gray-300 mb-0" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    ...
                    <div class="card">
                      ...
                      <div class="card-body-wrapper">
                        <div class="card-body text-center bg-white">
                          <h4 class="text-primary fs-6" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            {{ ucwords($testimonial->name) }}</h4>
                          <p class="text-dark-300  mb-0 {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                  ...
                  <div class="blog-card-wrapper">
                    <div class="blog-card blog-1 card">
                      <div class="card-img">
                        <div class="overlay">
                          <a href="{{ $vcardBlogUrl }}">
                            <img src="{{ $blog->blog_icon }}" alt="profile" class="h-100 w-100 blog-img"
                              loading="lazy" />
                          </a>
                        </div>
                      </div>
      ...
      @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
        @if ($vcard->businessHours->count())
          ...
          @endphp
          <div class="business-hour-section pt-2 px-30 mb-3" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            <div class="section-heading text-center mb-40">
              ...
              <div class="business-hour-card mt-40">
                <div class="row">
                  ...
                  @foreach ($businessDaysTime as $key => $dayTime)
                    <div class="col-sm-6">
                      <div
                        class="business-hour d-flex flex-column align-items-center gap-2 justify-content-between mb-2">
                        <span class="days d-flex gap-2 align-items-center">
                          <div class="days-icon">
                        ...
                        <span class="text-center">{{ $dayTime ?? __('messages.common.closed') }}</span>
                      </div>
                    </div>
                  @endforeach
                </div>
          ...
          <div class="appointment-section pt-60 pb-60 px-30">
            ...
            <div class="appointment">
              ...
              <div class="">
                ...
                <div class="text-center">
                  <button type="submit" class="appointmentAdd rounded-2 appoint-btn btn btn-primary w-100 d-none">
          ...
          <div class="px-30 pt-30 pb-30 bg-primary-light">
            <div class="vcard-link-card card">
              <div class="d-flex align-items-center justify-content-center">
                <a target="_blank" href="{{ route('register', ['referral-code' => $vcard->user->affiliate_code]) }}"
      ...
      <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
        <div class="fixed-btn-section">
          @if (empty($vcard->hide_stickybar))
            <div class="bars-btn developer-bars-btn @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') vcard-bars-btn-left @endif">
            ...
            <div class="sub-btn-div  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
              ...
              @if (empty($vcard->hide_stickybar))
                <div class="{{ isset($vcard->whatsapp_share) ? 'vcard17-btn-group' : 'stickyIcon' }}">
                  <button type="button" class="vcard17-btn-group vcard17-share vcard17-sticky-btn mb-3 px-2 py-1"><i
