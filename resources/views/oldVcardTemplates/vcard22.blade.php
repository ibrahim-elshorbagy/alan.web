                ...
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section mb-5 pb-3 px-30">
                        ...
                        <div class="appointment">
                            ...
                            <div class="">
                                <label class="appoint-hour fs-18 mb-10 text-start" id="hourSection" style="display: none;">{{ __('messages.hour') }}</label>
                                    ...
                                    <div class="product-card card">
                                        ...
                                        <div class="product-desc card-body p-3">
                                            <div class="d-flex justify-content-between align-items-start mb-2">
                                                <h3 class="product-head fs-18 fw-5 mb-0 flex-grow-1 me-3 text-break" style="min-width: 0;">{{ $product->name }}</h3>
