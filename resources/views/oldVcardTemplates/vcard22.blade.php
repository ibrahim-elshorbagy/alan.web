    ...
    <div class="main-content mx-auto w-100 overflow-hidden bg-green @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
      ...
      <div class="profile-section mb-5 px-30 @if ($vcard->cover_type == 2) profile-margin @endif">
        <div class="card d-flex flex-sm-row-reverse justify-content-sm-end align-items-sm-end align-items-center mb-30">
          ...
          <div class="card-body text-center profile-details px-0">
                ...
                <div class="col-sm-6 mb-40">
                  <div class="contact-box d-flex align-items-center">
                    ...
                    <div class="contact-desc">
                      <a href="mailto:{{ $vcard->email }}" class="fw-5 contact-desc">{{ $vcard->email }}</a>
                    </div>
                  </div>
                </div>
              @endif
              ...
              @if ($vcard->phone)
                <div class="col-sm-6 mb-40">
                  <div class="contact-box d-flex align-items-center">
                    ...
                    <div class="contact-desc">
                      <a href="tel:{{ $vcard->region_code }}{{ $vcard->phone }}" class="contact-desc fw-5"
                    ...
                    <div class="col-sm-6 mb-20">
                      <div class="service-card h-100">
                        ...
                        <div class="card-body text-center p-0">
                          <h3 class="card-title fs-18 mb-10" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                  ...
                  <div class="product-card card">
                    ...
                    <div class="product-desc card-body p-3">
                      <div class="d-flex justify-content-between align-items-start mb-2">
                        <h3 class="product-head fs-18 fw-5 mb-0 flex-grow-1 me-3 text-break" style="min-width: 0;"
                          @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                          {{ $product->name }}</h3>
                        <p class="amount fs-18 mb-0 text-primary flex-shrink-0" style="min-width: max-content;"
                        ...
                        <div class="d-flex justify-content-between align-items-end"
                          ...
                          <div class="d-flex flex-wrap align-items-center">
                            ...
                            <div class="profile-desc mt-3">
                              <h3 class="text-primary fs-18 mb-1" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                {{ ucwords($testimonial->name) }}</h3>
                            </div>
                          </div>
                          <div class="quote-img d-flex justify-content-center align-items-center ms-3">
                ...
                <div class="row">
                  ...
                  @if (isset($inquiry) && $inquiry == 1)
                    <div class="mb-3 mt-3">
                      <div class="wrapper-file-input">
                        <div class="input-box" id="fileInputTrigger">
                          <h4> <i class="fa-solid fa-upload ms-2 mt-1"></i>{{ __('messages.choose_file') }}
                          </h4> <input type="file" id="attachment" name="attachment" hidden multiple />
                        </div> <small>{{ __('messages.file_supported') }}</small>
                      </div>
                      <div class="wrapper-file-section">
              ...
              <div class="">
                ...
                <div class="text-center">
                  <a href="{{ $banners->url }}" id="support-banner-btn"
                    data-button-style="{{ isset($dynamicVcard) ? $dynamicVcard->button_style : 'default' }}"
                    class="act-now  text-dark" target="_blank" data-turbo="false">{{ $banners->banner_button }}
                  </a>
                </div>
              </div>
            </div>
