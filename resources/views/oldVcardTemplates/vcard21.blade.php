    ...
    <div class="main-content mx-auto w-100 overflow-hidden bg-img @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
      ...
      <div class="profile-section px-40 @if ($vcard->cover_type == 2) profile-margin @endif">
          ...
          <div class="w-100">
            <div
              ...
              <div class="position-absolute vector-1 vector-all">
                <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/vector-1.png') }}" alt="images"
                  class="w-100" />
              </div>
              <div class="position-absolute vector-2 vector-all text-end">
                <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/vector-2.png') }}" alt="images"
                  class="w-100" />
              </div>
              <img src="{{ $vcard->profile_url }}" class="w-100 h-100 object-fit-cover main-img" loading="lazy" />
            </div>
          </div>
          <div class="card-body p-0 text-center @if ($vcard->cover_type == 2) profile-des @endif">
        ...
        <div class="social-media pt-30 d-flex flex-wrap justify-content-center position-relative">
          <div class="cherry-blossom-img position-absolute">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/cherry-blossom.png') }}" loading="lazy" />
          </div>
            ...
            <div class="row row-gap-50px d-flex">
              ...
              @if ($vcard->phone)
                <div class="col-sm-6 d-flex">
                  <div class="contact-box d-flex align-items-center w-100">
                    ...
                    <div class="contact-desc">
                      <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}" class="text-black fw-5"
              ...
              @if ($vcard->dob)
                <div class="col-sm-6 d-flex">
                  <div class="contact-box d-flex align-items-center w-100">
                    <div class="contact-icon d-flex justify-content-center align-items-center">
                      <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/dob-icon.png') }}" />
                    </div>
                    <div class="contact-desc">
              ...
              @if ($vcard->location)
                <div class="col-sm-6 d-flex">
                  <div class="contact-box d-flex align-items-center w-100">
                    <div class="contact-icon d-flex justify-content-center align-items-center">
                      <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/location.png') }}" />
                    </div>
                    <div class="contact-desc">
        ...
        @if (checkFeature('services') && $vcard->services->count())
          <div class="our-services-section px-40 pt-60">
            <div class="blossom-img">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/blossom.png') }}" loading="lazy" />
            </div>
                    ...
                    <div class="col-sm-6 mb-sm-0 mb-40 mt-40">
                      <div class="service-card card h-100 ">
                        ...
                        <div class="card-body p-0 text-center">
                          <h3 class="fs-18 fw-5 text-black mb-2" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            {{ ucwords($service->name) }}</h3>
                          <p class="card-desc mb-0 fs-14 text-gray-100  {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
        ...
        @if (checkFeature('appointments') && $vcard->appointmentHours->count())
          <div class="appointment-section pt-60 px-30">
            <div class="position-absolute vector-3 vector-all text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/vector-3.png') }}" alt="images"
                class="w-100" />
            </div>
            <div class="position-absolute vector-4 vector-all">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/vector-4.png') }}" alt="images"
                class="w-100" />
            </div>
            <div class="appointment-bg-img">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/appointment-bg-img.png') }}" loading="lazy" />
            </div>
            <div class="section-heading text-center mb-40">
        ...
        @if (checkFeature('gallery') && $vcard->gallery->count())
          <div class="gallery-section pt-60 px-3 position-relative">
            <div class="position-absolute vector-5 vector-all">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/vector-5.png') }}" alt="images"
                class="w-100" />
            </div>
            <div class="position-absolute vector-6 vector-all text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/vector-6.png') }}" alt="images"
                class="w-100" />
            </div>
            <div class="gallery-bg-img">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/gallery-bg-img.png') }}" loading="lazy" />
            </div>
            <div class="section-heading text-center mb-40">
              <h2 class="text-primary mb-0">
        ...
        @if (checkFeature('testimonials') && $vcard->testimonials->count())
          <div class="testimonial-section pt-60 px-40">
            <div class="testimonial-bg-img">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/testimonial-bg-img.png') }}" loading="lazy" />
            </div>
            <div class="section-heading text-center mb-40">
              <h2 class="text-primary mb-0">
                ...
                <div class="px-2">
                  <div class="testimonial-card">
                    <div class="card-body p-0 text-sm-start text-center">
                      <p class="text-black fs-18 mb-20 {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                      ...
                      <div class="d-flex align-items-center justify-content-sm-start justify-content-center">
                        ...
                        <div class="">
                          <h6 class="fs-6 fw-5 text-primary mb-0" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
        ...
        @if (checkFeature('products') && $vcard->products->count())
          <div class="product-section bg-gray pt-60 px-4">
            <div class="product-bg-img">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/product-bg-img.png') }}" loading="lazy" />
            </div>
            <div class="section-heading text-center mb-40">
              <h2 class="text-primary mb-0">
                  ...
                  <div class="product-card card">
                    <div class="product-img card-img">
                      <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                        target="_blank" class="text-decoration-none fs-6"><img src="{{ $product->product_icon }}"
                    ...
                    <div class=" card-body">
                      <div class="product-desc d-flex justify-content-between align-items-center">
                        <h3 class="text-black fs-18 fw-5 mb-0 me-2"
                          @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>{{ $product->name }}</h3>
                      ...
                      <p class="fs-14 text-gray-100 mb-0" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
        ...
        @if (checkFeature('blog') && $vcard->blogs->count())
          <div class="blog-section pt-30 px-40">
            <div class="blog-bg-img">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/blog-bg-img.png') }}" loading="lazy">
            </div>
            <div class="section-heading text-center mb-40">
              <h2 class="text-primary mb-0 d-inline-block">
            ...
            <div class="blog-slider">
              @foreach ($vcard->blogs as $blog)
                ...
                ?>
                <div class="slide">
                  <div class="blog-card  card flex-sm-row " @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    <div class="card-img">
                      <a href="{{ $vcardBlogUrl }}">
                        <img src="{{ $blog->blog_icon }}" class="w-100 h-100 object-fit-contain" loading="lazy" />
                      </a>
                    </div>
      ...
      @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
        @if ($vcard->businessHours->count())
          ...
          @endphp
          <div class="business-hour-section pt-40 px-40" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            <div class="hour-bg-img">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/hour-bg-img.png') }}" loading="lazy" />
            </div>
            <div class="section-heading text-center mb-40">
              <h2 class="text-primary mb-0">
      ...
      @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
        <div class="qr-code-section pt-60 px-40 position-relative">
          ...
          <div class="qr-bg-img">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/qr-code-bg-img.png') }}" loading="lazy" />
          </div>
          <div class="section-heading text-center mb-40">
            <h2 class="text-primary mb-0">
      ...
      @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
        <div class="contact-us-section px-40 pb-3">
          <div class="contact-us-bg-img">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/contact-us-bg-img.png') }}" loading="lazy" />
          </div>
          <div class="section-heading text-center mb-40">
            <h2 class="text-primary mb-0">
                    ...
                    <div class="mb-3 mt-2">
                      <div class="wrapper-file-input">
                        <div class="input-box" id="fileInputTrigger">
                          <h4> <i class="fa-solid fa-upload me-2 mb-1"></i>{{ __('messages.choose_file') }}
                ...
                <div class="row">
                  ...
                  @if (isset($inquiry) && $inquiry == 1)
                    <div class="mb-3 mt-2">
                      <div class="wrapper-file-input">
                        <div class="input-box" id="fileInputTrigger">
                          <h4> <i class="fa-solid fa-upload ms-2 mb-1"></i>{{ __('messages.choose_file') }}
                          </h4> <input type="file" id="attachment" name="attachment" hidden multiple />
                        </div> <small>{{ __('messages.file_supported') }}</small>
                      </div>
                      <div class="wrapper-file-section">
      ...
      @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
        <div class="create-vcard-section pt-30 mb-5 px-40">
          <div class="create-vcard-bg-img">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/create-vcard-bg-img.png') }}" loading="lazy" />
          </div>
      ...
      @if ($vcard->enable_contact)
        <div class="add-to-contact-section">
          <div class="text-center d-flex align-items-center justify-content-center"
            ...
            @else
              <a href="{{ route('add-contact', $vcard->id) }}" class="add-contact-btn rounded-2 btn-primary"><i
        ...
        <div class="fixed-btn-section">
          ...
          <div class="sub-btn d-none">
            <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
              ...
              @endif
              @if (empty($vcard->hide_stickybar))
                <div class="{{ isset($vcard->whatsapp_share) ? 'vcard21-btn-group' : 'stickyIcon' }}">
                  <button type="button" class="vcard21-btn-group vcard21-share vcard21-sticky-btn mb-3 px-2 py-1"><i
