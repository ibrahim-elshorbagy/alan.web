    ...
    <div class="main-content mx-auto w-100 overflow-hidden bg-green @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
      ...
      <div class="contact-section pt-60 px-40">
        ...
        <div class="section-heading">
          <div class="heading-img">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/contact-heading.png') }}" class="w-100"
              alt="img" />
          </div>
              ...
              <div class="col-sm-6 mb-40">
                <div class="contact-box d-flex align-items-center">
                  ...
                  <div class="contact-desc">
                    <a href="mailto:{{ $vcard->email }}" class="text-white fw-5">{{ $vcard->email }}</a>
                  </div>
                </div>
              </div>
            @endif
            ...
            @if ($vcard->phone)
              <div class="col-sm-6 mb-40">
                <div class="contact-box d-flex align-items-center">
                  ...
                  <div class="contact-desc">
                    <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}" class="text-white fw-5"
        ...
        @if (checkFeature('services') && $vcard->services->count())
          <div class="our-services-section pt-60 pb-40 px-40">
            <div class="services-bg img-1">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/services-bg1.png') }}" alt="bg" />
            </div>
            <div class="services-bg img-2 text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/services-bg2.png') }}" alt="bg" />
            </div>
            <div class="section-heading">
              <div class="heading-img">
                <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/services-heading.png') }}" class="w-100"
                  alt="img" />
              </div>
                    ...
                    <div class="col-sm-6 mb-sm-0 mb-40 mt-3">
                      <div class="service-card text-start h-100">
                        ...
                        <div class="card-body p-0">
                          ...
                          <p class="mb-0 fs-14 text-gray-100 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            ...
            <div class="appointment">
              ...
              <div>
                ...
                <div class="text-center">
                  <button type="submit" class="appoint-btn appointmentAdd btn btn-primary w-100 rounded-2 d-none">
        ...
        @if (checkFeature('gallery') && $vcard->gallery->count())
          <div class="gallery-section pt-60">
            <div class="gallery-bg img-1">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/gallery-bg1.png') }}" alt="bg" />
            </div>
            <div class="gallery-bg img-2 text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/gallery-bg2.png') }}" alt="bg" />
            </div>
            <div class="section-heading px-40">
              <div class="heading-img">
                <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/gallery-heading.png') }}" class="w-100"
                  alt="img" />
              </div>
              ...
              @foreach ($vcard->gallery as $file)
                ...
                <div>
                  <div class="gallery-img">
                    ...
                    @else
                      <iframe src="https://www.youtube.com/embed/{{ YoutubeID($file->link) }}" class="w-100 h-100">
                      </iframe>
                    @endif
                  </div>
                </div>
        ...
        @if (checkFeature('products') && $vcard->products->count())
          <div class="product-section pt-60 mb-10 pb-60 px-30">
            <div class="product-bg img-1">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/product-bg1.png') }}" alt="bg" />
            </div>
            <div class="product-bg img-2 text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/product-bg2.png') }}" alt="bg" />
            </div>
            <div class="section-heading px-3">
              <div class="heading-img">
                <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/product-heading.png') }}" class="w-100"
                  alt="img" />
              </div>
                  ...
                  <div class="product-card card mb-2">
                    <div class="product-img card-img">
                      <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                        target="_blank" class="text-decoration-none fs-6 object-fit-cover"><img
                          src="{{ $product->product_icon }}" class="w-100 h-100 object-fit-contain"
                          loading="lazy"></a>
                    </div>
                    <div class="product-desc card-body p-3">
                      <div class="d-flex justify-content-between align-items-center mb-1">
                        <h3 class="text-white fs-6 fw-5 mb-0" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                          {{ $product->name }}</h3>
                        <p class="amount fs-6 mb-0 fw-5 text-primary">
                          @if ($product->currency_id && $product->price)
                            <span class="fs-18 fw-6 text-purple"
        ...
        @if (checkFeature('testimonials') && $vcard->testimonials->count())
          <div class="testimonial-section pb-60 px-40">
            <div class="testimonial-bg img-1">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/testimonial-bg1.png') }}" alt="bg" />
            </div>
            <div class="section-heading px-3">
              <div class="heading-img">
                <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/testimonial-heading.png') }}" class="w-100"
                  alt="img" />
              </div>
                ...
                <div>
                  <div class="testimonial-card card">
                    ...
                    <div class="card-body p-0 text-center">
                      <p class="desc text-gray-100 fs-14  {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        {!! $testimonial->description !!}
                      </p>
                      <h3 class="text-white fs-18 mb-0" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
      ...
      @if ((isset($managesection) && $managesection['insta_embed']) || empty($managesection))
        @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
          <div class="">
            <div class="section-heading px-40">
              <div class="heading-img">
                <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/blog-heading.png') }}" class="w-100"
                  alt="img" />
              </div>
              ...
              <div class="row insta-toggle">
                <div class="nav nav-tabs border-0 px-0" id="nav-tab" role="tablist">
                  <button
                    ...
                    <svg aria-label="Posts" class="svg-post-icon x1lliihq x1n2onr6 x173jzuc stroke-none"
        ...
        @if (checkFeature('blog') && $vcard->blogs->count())
          <div class="blog-section pt-60">
            <div class="blog-bg img-1">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/blog-bg1.png') }}" alt="bg" />
            </div>
            <div class="blog-bg img-2 text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/blog-bg2.png') }}" alt="bg" />
            </div>
            <div class="section-heading px-40">
              <div class="heading-img">
                <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/blog-heading.png') }}" class="w-100"
        ...
        @if ($vcard->businessHours->count())
          ...
          <div class="business-hour-section pt-60 pb-40 px-40">
            <div class="hour-bg img-1">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/hour-bg1.png') }}" alt="bg" />
            </div>
            <div class="hour-bg img-2 text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/hour-bg2.png') }}" alt="bg" />
            </div>
            <div class="section-heading">
              <div class="heading-img">
                <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/hour-heading.png') }}" class="w-100"
                  alt="img" />
              </div>
      ...
      @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
        <div class="qr-code-section pt-40 pb-40 px-40">
          ...
          <div class="section-heading">
            <div class="heading-img">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/qr-heading.png') }}" class="w-100"
                alt="img" />
            </div>
      ...
      @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
        <div class="contact-us-section pt-60 pb-40 px-40">
          <div class="contact-us-bg img-1 text-end">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/contact-us-bg1.png') }}" alt="bg" />
          </div>
          <div class="section-heading">
            <div class="heading-img">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/contact-us-heading.png') }}" class="w-100"
                alt="img" />
            </div>
      ...
      @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
        <div class="create-vcard-section pt-40 pb-60 px-40">
          <div class="create-vcard-bg img-1">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/create-vcard-bg1.png') }}" alt="bg" />
          </div>
          <div class="create-vcard-bg img-2 text-end">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/create-vcard-bg2.png') }}" alt="bg" />
          </div>
            ...
            <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
              ...
              @if (empty($vcard->hide_stickybar))
                <div class="{{ isset($vcard->whatsapp_share) ? 'vcard29-btn-group' : 'stickyIcon' }}">
                  <button type="button" class="vcard29-btn-group vcard29-share vcard29-sticky-btn mb-3 px-2 py-1"><i
      ...
      <div class="modal-content" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
        <div class="">
          <div class="row align-items-center mt-3">
            ...
            <button type="button" aria-label="Close" class="btn btn-sm btn-icon btn-active-color-danger border-none"
