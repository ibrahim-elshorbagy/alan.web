            ...
            <div class="row">
              ...
              @if ($vcard->location)
                <div class="col-sm-6">
                  <div class="contact-box d-flex align-items-center">
                    <div class="contact-icon d-flex justify-content-center align-items-center me-3">
                      <img src="{{ asset('assets/img/oldVcardTemplate/vcard31/location.png') }}" />
                    </div>
                    <div class="contact-desc">
        ...
        @if (checkFeature('services') && $vcard->services->count())
          <div class="our-services-section pt-60 px-30">
            <div class="services-bg-img">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard31/services-bg.png') }}" alt="services-bg" />
            </div>
            <div class="section-heading">
                    ...
                    <div class="col-sm-6 mb-sm-0 mb-40 mt-4">
                      <div class="service-card h-100 text-start">
                        <div class="d-flex align-items-center mb-3">
                          ...
                          <span class="text-gray-100 mx-4">|</span>
                          <h4 class="card-title fs-6 text-secondary mb-0 text-break"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            {{ ucwords($service->name) }}
                          </h4>
                        </div>
        ...
        @if (checkFeature('products') && $vcard->products->count())
          <div class="product-section pt-60 px-4">
            <div class="product-bg-img text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard31/product-bg.png') }}" alt="product-bg" />
            </div>
                    ...
                    <div class="product-card card justify-content-end">
                      ...
                      <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                        ...
                        <div class="product-desc align-items-center desc-div">
                          ...
                          <p class="mb-0 text-gray-100 fs-12" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            {{ $product->description }}
                          </p>
                        </div>
                      </a>
                  ...
                  <div class="testimonial-card card">
                    ...
                    <div class="card-body p-0 pt-5">
                      <div class="text-center">
                        <h3 class="text-primary fs-20" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
        ...
        @if (checkFeature('blog') && $vcard->blogs->count())
          <div class="blog-section pt-60 px-3">
            <div class="blog-bg-img text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard31/blog-bg.png') }}" alt="blog-bg" />
            </div>
        ...
        @if ($vcard->businessHours->count())
          ...
          <div class="business-hour-section pt-60 mb-3">
            <div class="hour-bg-img">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard31/hour-bg.png') }}" alt="hour-bg" />
            </div>
      ...
      @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
        <div class="qr-code-section pt-60 px-30">
          <div class="qr-bg-img text-end">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard31/qr-bg-img.png') }}" alt="qr-bg" />
          </div>
          <div class="section-heading">
      ...
      <div class="btn-section cursor-pointer  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
        <div class="fixed-btn-section">
          @if (empty($vcard->hide_stickybar))
            <div class="bars-btn handyman-bars-btn @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') vcard-bars-btn-left @endif">
            ...
            <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
              ...
              @if (empty($vcard->hide_stickybar))
                <div class="{{ isset($vcard->whatsapp_share) ? 'vcard31-btn-group' : 'stickyIcon' }}">
                  <button type="button" class="vcard31-btn-group vcard31-share vcard31-sticky-btn mb-3 px-2 py-1"><i
