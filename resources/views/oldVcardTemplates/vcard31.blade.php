...
<body>
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            ...
            {{-- profile section --}}
            <div class="profile-section px-30 mb-1 @if($vcard->cover_type == 2) profile-margin @endif" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif >
                        ...
                        <div class="appointment">
                            <div class="row justify-content-center">
                                <div class="col-12">
                                    ...
                                    <label
                                        class="text-secondary fs-6 fw-5 mb-1 text-start" id="hourSection" style="display: none;">{{ __('messages.hour') }}:</label>
                                    <div class="row m-0">
                                        <div class="">
                ...
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-30 pb-60">
                        <div class="testimonial-bg-img text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard31/testimonial-bg.png') }}" alt="testimonial-bg" />
                        </div>
                        <div class="section-heading px-30">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section">
                    <div class="create-vcard-bg-img text-end">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard31/create-vcard-bg.png') }}" alt="create-vcard-bg" />
                    </div>
