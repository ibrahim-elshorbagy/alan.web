...
<body>
  <div class="container p-0">
    ...
    @endif
    <div class="main-content mx-auto w-100 overflow-hidden bg-gray-300 @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
      {{-- Pwa support --}}
      ...
      <div class="contact-section position-relative px-30 pt-30 pb-5">
        <div class="contact-bg-img">
          <img src="{{ asset('assets/img/oldVcardTemplate/vcard20/contact-bg-img.png') }}" loading="lazy" />
        </div>
        {{-- contact --}}
              ...
              <div class="row d-flex">
                  ...
                  <div class="col-sm-6 mb-30 d-flex">
                    <div class="contact-box w-100">
                      <div class="contact-icon d-flex justify-content-center align-items-center">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard20/email.png') }}" />
                      </div>
                ...
                @if ($vcard->phone)
                  <div class="col-sm-6 mb-30 d-flex">
                    <div class="contact-box w-100">
                      <div class="contact-icon d-flex justify-content-center align-items-center">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard20/phone.png') }}" />
                      </div>
                      <div class="contact-desc">
                ...
                @if ($vcard->dob)
                  <div class="col-sm-6 mb-30 d-flex">
                    <div class="contact-box w-100">
                      <div class="contact-icon d-flex justify-content-center align-items-center">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard20/dob-icon.png') }}" />
                      </div>
                      <div class="contact-desc">
                ...
                @if ($vcard->location)
                  <div class="col-sm-6 mb-30 d-flex">
                    <div class="contact-box w-100">
                      <div class="contact-icon d-flex justify-content-center align-items-center">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard20/location.png') }}" />
                      </div>
                      <div class="contact-desc">
        ...
        @if (checkFeature('gallery') && $vcard->gallery->count())
          <div class="gallery-section pt-2 px-30 pb-5">
            <div class="gallery-bg-img">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard20/gallery-bg-img.png') }}" loading="lazy" />
            </div>
        ...
        @if (checkFeature('services') && $vcard->services->count())
          <div class="our-services-section px-30 py-3">
            <div class="services-bg-img">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard20/services-bg-img.png') }}" loading="lazy" />
            </div>
                    ...
                    <div class="col-sm-6 mb-40 mt-15">
                      <div class="service-card card h-100">
                        ...
                        <div class="card-body p-0 text-center">
                          <h3 class="fs-18  text-white mb-2" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
        ...
        @if (checkFeature('testimonials') && $vcard->testimonials->count())
          <div class="testimonial-section pb-5 mb-4">
            <div class="testimonial-bg-img">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard20/testimonial-bg-img.png') }}" loading="lazy" />
            </div>
                  ...
                  <div class="px-3 py-1">
                    <div class="testimonial-card">
                      ...
                      <div class="card-body p-0  text-center text-white">
                        <h6 class="name" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                          {{ ucwords($testimonial->name) }}</h6>
                        <p class=" fs-14 mb-0 {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}"
                          @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                ...
                <div class="px-2">
                  <div class="product-card card">
                    ...
                    <div class="product-desc card-body text-center p-0">
                      <h3 class="text-white fs-18  mb-1" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        {{ $product->name }}</h3>
                      <p class="fs-14 text-gray-100 mb-1" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
        ...
        @if (checkFeature('appointments') && $vcard->appointmentHours->count())
          <div class="appointment-section pt-40 px-30 pb-5 mb-2">
            <div class="appointment-bg-img">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard20/appointment-bg-img.png') }}" loading="lazy" />
            </div>
              ...
              <div class="mb-20">
                <div class="position-relative date-input">
                  ...
                  <span class="calendar-icon">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard20/Vector.png') }}" loading="lazy" />
                  </span>
                  </span>
                </div>
              </div>
              ...
              @foreach ($vcard->blogs as $blog)
                ...
                <div class="">
                  <div class="blog-card  card">
                    <div class="card-img">
                      <a href="{{ $vcardBlogUrl }}">
                        <img src="{{ $blog->blog_icon }}" alt="profile" class="w-100 h-100 object-fit-cover"
                          loading="lazy" />
                      </a>
                    </div>
        ...
        @if ($vcard->businessHours->count())
          ...
          <div class="business-hour-section pt-40 px-30 pb-5">
            <div class="hour-bg-img">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard20/hour-bg-img.png') }}" loading="lazy" />
            </div>
            <div class="section-heading text-center mb-40 overflow-hidden">
              <h2 class=" text-white mb-1 d-inline-block">
              ...
              <div>
                ...
                @foreach ($businessDaysTime as $key => $dayTime)
                  <div
                    ...
                    <span class="me-2">{{ __('messages.business.' . \App\Models\BusinessHour::DAY_OF_WEEK[$key]) }}
                      :</span>
            ...
            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian')
              <div class="business-hours" dir="rtl">
                <div class="row m-0 justify-content-center">
                  ...
                  @foreach ($businessDaysTime as $key => $dayTime)
                    <div class="col-12">
                      <div class="mb-10 d-flex align-items-center justify-content-between justify-content-center">
                        <span
      ...
      @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
        <div class="qr-code-section pt-60 px-30">
          <div class="qr-code-bg-img">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard20/qr-code-bg-img.png') }}" loading="lazy" />
          </div>
          <div class="section-heading text-center mb-40 overflow-hidden">
            <h2 class=" text-white mb-1 d-inline-block">
      ...
      @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
        <div class="contact-us-section pt-30 px-30">
          <div class="contact-us-bg-img">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard20/contact-us-bg-img.png') }}" loading="lazy" />
          </div>
                ...
                <div class="row">
                  ...
                  @if (!empty($vcard->privacy_policy) || !empty($vcard->term_condition))
                    <div class="col-12 mb-4">
                      <input type="checkbox" name="terms_condition" class="form-check-input terms-condition required"
        ...
        <div class="fixed-btn-section">
          @if (empty($vcard->hide_stickybar))
            <div
              ...
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard20/sticky.png') }}" loading="lazy" />
            </div>
          @endif
          <div class="sub-btn d-none">
            <div class="sub-btn-div  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
              ...
              @endif
              @if (empty($vcard->hide_stickybar))
                <div class="{{ isset($vcard->whatsapp_share) ? 'vcard17-btn-group' : 'stickyIcon' }}">
                  <button type="button" class="vcard20-btn-group vcard20-share vcard20-sticky-btn mb-3 px-2 py-1"><i
