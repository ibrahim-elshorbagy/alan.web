              ...
              <div class="row d-flex">
                  ...
                  <div class="col-sm-6 mb-40 d-flex">
                    <div class="contact-box d-flex align-items-center w-100">
                      <div class="contact-icon d-flex justify-content-center align-items-center">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard15/email.png') }}" />
                      </div>
                ...
                @if ($vcard->phone)
                  <div class="col-sm-6 mb-40">
                    <div class="contact-box d-flex align-items-center">
                      <div class="contact-icon d-flex justify-content-center align-items-center">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard15/phone.png') }}" />
                      </div>
                      <div class="contact-desc">
                ...
                @if ($vcard->dob)
                  <div class="col-sm-6 mb-40 d-flex">
                    <div class="contact-box d-flex align-items-center w-100">
                      <div class="contact-icon d-flex justify-content-center align-items-center">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard15/dob-icon.png') }}" />
                      </div>
                      <div class="contact-desc">
                ...
                @if ($vcard->location)
                  <div class="col-sm-6 mb-40 d-flex">
                    <div class="contact-box d-flex align-items-center w-100">
                      <div class="contact-icon d-flex justify-content-center align-items-center">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard15/location.png') }}" />
                      </div>
                      <div class="contact-desc">
                      ...
                      <a href="{{ $service->service_url ?? 'javascript:void(0)' }}" class="text-decoration-none"
                        ...
                        <div class="service-card card h-100">
                          ...
                          <div class="card-body p-0 text-center">
                            ...
                            <p class="mb-0 fs-14 text-primary-light {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
                              @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
        ...
        @if (checkFeature('gallery') && $vcard->gallery->count())
          <div class="gallery-section pt-50 pb-40 position-relative">
            <div class="position-absolute vector-all vector-5">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard15/vector-5.png') }}" alt="images"
                class="w-100" />
            </div>
                        ...
                        <div class="product-desc card-body">
                          <div class="d-flex justify-content-between">
                            <div class="product-title">
                              <h3 class="text-primary fs-6" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                {{ $product->name }}</h3>
                            </div>
                          ...
                          <p class="fs-14 text-primary-light mb-0 text-truncate"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            {{ $product->description }}
                          </p>
                        </div>
                  ...
                  <div class="">
                    <div class="testimonial-card d-flex flex-sm-row flex-column align-items-center"
                      ...
                      <div class="card-body text-start p-0">
                        <div class="quote-img">
                          <img src="{{ asset('assets/img/oldVcardTemplate/vcard15/quote-img.png') }}" class="h-100"
                            loading="lazy" />
                        </div>
                        <div class="text-sm-start text-center">
                          <p class="text-white fs-14 {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            {!! $testimonial->description !!}
                          </p>
                          <h6 class="name mb-0" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
        ...
        @if (checkFeature('blog') && $vcard->blogs->count())
          <div class="blog-section pt-50 pb-30 position-relative">
            <div class="position-absolute vector-all vector-3">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard15/vector-3.png') }}" alt="images"
                class="w-100" />
            </div>
        ...
        @if ($vcard->businessHours->count())
          ...
          <div class="bussiness-hour-section pt-50 pb-60 position-relative">
            <div class="position-absolute vector-all vector-2 text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard15/vector-2.png') }}" alt="images"
                class="w-100" />
            </div>
                    ...
                    <div class="mb-10 d-flex align-items-center justify-content-center business-box">
                      ...
                      <div class="text-primary fs-14 time d-flex gap-2 align-items-center">
                        <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
                          <defs>
                            <linearGradient id="clockGradient" x1="0%" y1="0%" x2="100%"
                              y2="0%">
        ...
        @if (checkFeature('appointments') && $vcard->appointmentHours->count())
          <div class="appointment-section bg-primary pt-50 pb-60 position-relative">
            <div class="position-absolute vector-all vector-9 text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard15/vector-9.png') }}" alt="images"
                class="w-50" />
            </div>
      ...
      <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
        <div class="fixed-btn-section">
          @if (empty($vcard->hide_stickybar))
            <div class="bars-btn salon-bars-btn @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') vcard-bars-btn-left @endif">
          ...
          <div class="sub-btn d-none">
            <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
              ...
              @endif
              @if (empty($vcard->hide_stickybar))
                <div class="{{ isset($vcard->whatsapp_share) ? 'vcard15-btn-group' : 'stickyIcon' }}">
                  <button type="button"
