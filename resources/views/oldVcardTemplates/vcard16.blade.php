          ...
          <div class="col-12">
            <div class="card flex-sm-row @if ($vcard->cover_type == 2) profile-margin @endif">
              <div class="card-img d-flex justify-content-center align-items-center">
                <img src="{{ $vcard->profile_url }}" class="rounded-circle h-100 w-100 object-fit-cover"
                  loading="lazy" />
              </div>
        ...
        <div class="qr-code-section pt-40 pb-50 position-relative">
          ...
          <div class="px-30">
            <div class="row align-items-center flex-sm-row flex-column-reverse justify-content-center">
              <div class="col-sm-8">
                <div class="qr-code d-flex justify-content-center position-relative ms-sm-auto mx-auto mb-sm-0 mb-4">
                    ...
                    <div class="col-sm-6 mb-40">
                      <div class="service-card card h-100 align-items-center">
                        <div class="card-img d-flex justify-content-center align-items-center mb-4">
                          <a href="{{ $service->service_url ?? 'javascript:void(0)' }}" class="text-decoration-none"
                            target="{{ $service->service_url ? '_blank' : '' }}">
                            <img src="{{ $service->service_icon }}" alt="" class="object-fit-cover"
                              loading="lazy" />
                          </a>
                        </div>
                        <div class="card-body text-center p-0">
                          <h3 class="card-title fs-18 fw-4 text-primary"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            {{ $service->name }}</h3>
                          <p class="mb-0 text-gray-300 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    ...
                    <a @if ($product->product_url) href="{{ $product->product_url }}" @endif target="_blank"
                      ...
                      <div class="product-desc card-body d-flex align-items-center justify-content-between">
                        <div class="product-title">
                          <h3 class="text-primary fs-18  mb-0" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            {{ $product->name }}</h3>
                          <p class="fs-14 text-gray-300 mb-0" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            {{ $product->description }}
                          </p>
                        </div>
                ...
                <div class="">
                  <div class="testimonial-card">
                    ...
                    <div class="card-body p-0  text-center">
                      <p class="text-gray-300 mb-3 fs-14 {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
              ...
              <div class="bussiness-hour-card" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                ...
                @foreach ($businessDaysTime as $key => $dayTime)
                  <div class="mb-10 d-flex gap-2 align-items-center justify-content-between">
                    <span class="days fs-16"><i class="fa-solid fa-calendar-week text-primary me-1"></i>
