    ...
    <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
        ...
        @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
          <div
            ...
            <div class="position-absolute text-end vector-all vector-2 position-absolute">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard13/doctor-vector-2.png') }}" alt="vector-images"
                class="w-100" />
            </div>
      ...
      @if (checkFeature('social_links') && isset($vcard->socialLink) && getSocialLink($vcard))
        <div class="social-media d-flex justify-content-center position-relative mb-40 px-30">
          ...
          <div class="position-absolute text-end vector-1 position-absolute">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard13/doctor-vector-1.png') }}" alt="vector-images"
              class="w-50" />
          </div>
          <div class="position-absolute vector-all vector-4 position-absolute">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard13/doctor-vector-4.png') }}" alt="vector-images"
              class="w-100" />
          </div>
        </div>
      @endif
              ...
              <div class="row row-gap-16px d-flex">
                @if ($vcard->email)
                  <div class="col-sm-6 d-flex">
                    <div class="contact-box d-flex align-items-center justify-content-center w-100">
                      ...
                      <div class="contact-icon-box d-flex align-items-center jusrify-content-center">
                        <div class="contact-icon d-flex justify-content-center align-items-center m-auto">
                          <img src="{{ asset('assets/img//oldVcardTemplate/vcard13/email.png') }}" />
                        </div>
                      </div>
                      <div class="contact-desc mt-2">
                        <a href="mailto:{{ $vcard->email }}" class="text-primary text-break">{{ $vcard->email }}</a>
                      </div>
                    </div>
                  </div>
                @endif
                ...
                @if ($vcard->phone)
                  <div class="col-sm-6 d-flex">
                    <div class="contact-box d-flex align-items-center justify-content-center w-100">
                      ...
                      <div class="contact-icon-box d-flex align-items-center jusrify-content-center">
                        <div class="contact-icon d-flex justify-content-center align-items-center m-auto">
                          <img src="{{ asset('assets/img/oldVcardTemplate/vcard13/phone.png') }}" />
                        </div>
                      </div>
                      <div class="contact-desc mt-2">
                        <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}" class="text-primary"
                    ...
                    <div class="contact-box d-flex align-items-center justify-content-center w-100">
                      ...
                      <div class="contact-desc mt-2">
                        <a href="tel:+{{ $vcard->alternative_region_code }}{{ $vcard->alternative_phone }}"
                          class="text-primary" dir="ltr">+{{ $vcard->alternative_region_code }}
                ...
                @if ($vcard->dob)
                  <div class="col-sm-6 d-flex">
                    <div class="contact-box d-flex align-items-center justify-content-center w-100">
                      ...
                      <div class="contact-icon-box d-flex align-items-center jusrify-content-center">
                        <div class="contact-icon d-flex justify-content-center align-items-center m-auto">
                          <img src="{{ asset('assets/img/oldVcardTemplate/vcard13/dob-icon.png') }}" />
                        </div>
                      </div>
                      <div class="contact-desc mt-2">
                ...
                @if ($vcard->location)
                  <div class="col-sm-6 d-flex">
                    <div class="contact-box d-flex align-items-center justify-content-center w-100">
                      ...
                      <div class="contact-icon-box d-flex align-items-center jusrify-content-center">
                        <div class="contact-icon d-flex justify-content-center align-items-center m-auto">
                          <img src="{{ asset('assets/img/oldVcardTemplate/vcard13/location.png') }}" />
                        </div>
                      </div>
                      <div class="contact-desc mt-2">
      ...
      @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
        <div class="qr-code-section mt-4 position-relative">
          <div class="position-absolute text-end vector-all vector-5">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard13/doctor-vector-5.png') }}" alt="vector-images"
              class="w-100" />
          </div>
          <div class="position-absolute vector-all vector-6">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard13/doctor-vector-9.png') }}" alt="vector-images"
              class="w-100" />
          </div>
          <div class="section-heading position-relative text-center pb-40">
                  ...
                  @foreach ($vcard->services as $service)
                    <div>
                      <div class="service-card my-1 h-100">
                        ...
                        <div class="">
                          <a href="{{ $service->service_url ?? 'javascript:void(0)' }}" class="text-decoration-none"
                            target="{{ $service->service_url ? '_blank' : '' }}">
                      ...
                      <div class="service-card h-100">
                        <a href="{{ $service->service_url ?? 'javascript:void(0)' }}" class="text-decoration-none"
                          ...
                          <div class="card-img mb-20 mx-auto d-flex justify-content-center align-items-center">
                            <img src="{{ $service->service_icon }}" class="web-design" alt="{{ $service->name }}"
                              loading="lazy" />
                          </div>
                        </a>
                        <div class="card-body text-center p-0 mt-4">
                          <h3 class="card-title fs-18 text-white" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            {{ ucwords($service->name) }}
                          </h3>
                          <p
                            class="mb-0 fs-14 fw-light text-white {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                      ...
                      <div class="product-card">
                        <div class="d-flex">
                          <div class="product-img card-img">
                            <img src="{{ $product->product_icon }}" class="img-fluid h-100 object-fit-contain"
                              loading="lazy" />
                          </div>
                          <div class="product-desc card-body">
                            <div class="product-title">
                              <h3 class="text-black fs-18 fw-5" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>{{ $product->name }}</h3>
                            </div>
                            <p class="fs-12 text-gray-100 mb-0 fw-5" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                              {{ $product->description }}
                            </p>
                            <div class="product-amount text-primary text-center fw-5 mt-2" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') style="direction: rtl; text-align: right; display: block;" @endif>
                              @if ($product->currency_id && $product->price)
                                <span
                                  class="product-amount text-primary text-center fw-5">{{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
                              @elseif($product->price)
                                <span
                                  class="product-amount text-primary text-center fw-5">{{ currencyFormat($product->price, 2, getUserCurrencyIcon($vcard->user->id)) }}</span>
                              @endif
                            </div>
                          </div>
                        </div>
                  ...
                  <div
                    ...
                    <div class="card-body p-0">
                      ...
                      <div class="text-sm-start text-center">
                        <p
                          class="desc text-white mb-0  {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
        ...
        @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
          <div class="my-5 position-relative">
            <div class="position-absolute vector-all vector-7">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard13/doctor-vector-7.png') }}" alt="vector-images"
                class="w-100" />
            </div>
      ...
      @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
        @if (checkFeature('blog') && $vcard->blogs->count())
          <div class="blog-section position-relative pb-40 mb-4  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            <div class="position-absolute vector-all vector-8">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard13/doctor-vector-8.png') }}" alt="vector-images"
                class="w-100" />
            </div>
              ...
              @foreach ($vcard->blogs as $blog)
                ...
                <div class="">
                  <div class="blog-card mb-sm-0 mb-5 d-flex flex-sm-row-reverse flex-column-reverse"
                    ...
                    <div class="card-body text-center p-0 pe-sm-4 ms-3">
        ...
        @if ($vcard->businessHours->count())
          ...
          <div class="bussiness-hour-section pt-40 pb-40 position-relative">
            <div class="position-absolute vector-all vector-9 text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard13/doctor-vector-6.png') }}" alt="vector-images"
                class="w-100" />
            </div>
            ...
            <div class="px-30">
              <div class="bussiness-hour-card d-flex flex-column" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                @php
      ...
      @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
        <div class="contact-us-section pt-30 px-sm-4 px-3 mb-4 mx-3 mx-sm-4 position-relative">
          <div class="position-absolute vector-all vector-11 text-end">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard13/doctor-vector-10.png') }}" alt="vector-images"
              class="w-50" />
          </div>
          <div class="section-heading position-relative text-center mb-3 pb-3">
      ...
      @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
        <div class="create-vcard-section pt-40 px-30 position-relative">
          <div class="position-absolute vector-all vector-12">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard13/doctor-vector-3.png') }}" alt="vector-images"
              class="w-100" />
          </div>
          <div class="section-heading position-relative text-center mb-3 pb-3">
      ...
      <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
        <div class="fixed-btn-section">
          @if (empty($vcard->hide_stickybar))
            <div class="bars-btn hospital-bars-btn @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') vcard-bars-btn-left @endif">
            ...
            <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
              ...
              @if (empty($vcard->hide_stickybar))
                <div class="{{ isset($vcard->whatsapp_share) ? 'vcard13-btn-group' : 'stickyIcon' }}">
                  <button type="button" class="social-btn hospital-sub-btn mb-3 px-2 py-1 wp-btn vcard13-share"><i
                  ...
                  @if (!empty($vcard->enable_download_qr_code))
                    <a type="button"
                      ...
                      id="qr-code-btn" download="qr_code.png"><i class="fa-solid fa-qrcode fs-4 text-dark"></i></a>
                  @endif
                  {{-- <a type="button"
          ...
          <div class="col-12 justify-content-between social-link-modal">
            <div class="input-group">
              ...
              <span id="vcardUrlCopy{{ $vcard->id }}" class="d-none" target="_blank">
                {{ $vcardUrl }} </span>
              <button class="copy-vcard-clipboard btn btn-dark" title="Copy Link" data-id="{{ $vcard->id }}">
