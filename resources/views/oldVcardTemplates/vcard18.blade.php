  ...
  <div class="container p-0">
    ...
    <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
      <div class="banner-section @if ($vcard->cover_type == 2) vcard-yt-link-18 @endif">
        <div class="banner-img @if ($vcard->cover_type == 2) vcard-banner-18 @endif">
          ...
          @elseif($vcard->cover_type == 1)
            @if (strpos($vcard->cover_url, '.mp4') !== false ||
              ...
              <video class="  " loop autoplay muted playsinline alt="background video" id="cover-video">
        ...
        <img src="{{ asset('assets/img/oldVcardTemplate/vcard18/curve-shape.png') }}"
          class="curve-img w-100 @if ($vcard->cover_type == 2) d-none @endif" loading="lazy" />
      ...
      @endif
      <div
        class="profile-section pb-40 px-30 position-relative @if ($vcard->cover_type == 2) profile-margin @endif">
        ...
        <div class="card flex-sm-row-reverse align-items-center pt-sm-0 pt-4">
          <div
            class="card-img d-flex justify-content-center align-items-center @if ($vcard->cover_type == 2) profile-top-margin @endif">
            <img src="{{ $vcard->profile_url }}" class="w-100 h-100 rounded-circle object-fit-cover"
              loading="lazy" />
          </div>
          <div
            class="card-body text-start pt-sm-4 px-0 @if ($vcard->cover_type == 2) profile-detail @else pt-sm-5 @endif">
                  ...
                  <div class="col-md-6 mt-40 d-flex">
                    <div class="contact-box d-flex align-items-center w-100">
                      ...
                      <div class="contact-desc">
                        <a href="mailto:{{ $vcard->email }}" class=" text-gray-200">{{ $vcard->email }}</a>
                      </div>
                    </div>
                  </div>
                @endif
                ...
                @if ($vcard->phone)
                  <div class="col-md-6  mt-40 d-flex">
                    <div class="contact-box d-flex align-items-center w-100">
                      ...
                      <div class="contact-desc">
                        <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}" class="fs-14 text-gray-200"
                    ...
                    <div class="col-12 mb-3">
                      <div class="service-card card d-flex flex-row align-items-center"
                        ...
                        <div class="card-body p-0">
                          <h3 class="card-title fs-6 fw-5" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
              ...
              @foreach ($vcard->products as $product)
                <div class="">
                  ...
                  <div class="product-desc card-body">
                    ...
                    <p class="fs-14 text-gray-200 mb-0" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                ...
                <div class="px-3">
                  <div class="testimonial-card">
                    ...
                    <div class="card-body text-center p-0">
                      <h3 class="fs-20 fw-6 text-black mb-0" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                      ...
                      <div class="d-flex">
                        ...
                        <p class="card-desc fs-6 fw-4 text-gray-200 mb-0 text-center {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}"
                          @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
              ...
              @foreach ($vcard->blogs as $blog)
                ...
                <div class="px-3">
                  <div class="blog-card d-flex flex-sm-row flex-column">
                    <div class="card-img">
                      <a href="{{ $vcardBlogUrl }}">
                        <img src="{{ $blog->blog_icon }}" class="img-fluid h-100 w-100 object-fit-cover mx-auto"
                          loading="lazy"></a>
                    </div>
      ...
      @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
        @if ($vcard->businessHours->count())
          ...
          <div class="business-hour-section pt-30 px-40 pb-3">
            ...
            <div class="business-hours mt-3 business-time d-flex flex-column"
              @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
              @php
                ...
                <div class="col-sm-10 mx-auto">
                  <div class="position-relative">
                    ...
                    <span class="calendar-icon">
                      <img src=" {{ asset('assets/img/oldVcardTemplate/vcard18/calendar.png') }}" loading="lazy" />
                    </span>
                  </div>
                </div>
              </div>
              ...
              <form action="" id="enquiryForm" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-12 text-center mt-3">
                    <button class="contact-btn send-btn btn btn-primary rounded-2" type="submit">
      ...
      <div class="add-to-contact-section mb-4">
        @if ($vcard->enable_contact)
          <div class="d-flex align-items-center justify-content-center"
            ...
            @else
              <a href="{{ route('add-contact', $vcard->id) }}" class="btn btn-primary add-contact-btn  rounded-2"><i
      ...
      <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
        <div class="fixed-btn-section">
          @if (empty($vcard->hide_stickybar))
            <div class="bars-btn corporate-bars-btn  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') vcard-bars-btn-left @endif">
          ...
          <div class="sub-btn d-none">
            <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
              ...
              @endif
              @if (empty($vcard->hide_stickybar))
                <div class="{{ isset($vcard->whatsapp_share) ? 'vcard18-btn-group' : 'stickyIcon' }}">
                  <button type="button"
              ...
              <div class="modal-body">
                ...
                <form action="" method="post" id="newsLatterForm">
                  ...
                  <div class="mb-1 mt-1 d-flex gap-1 justify-content-center align-items-center email-input">
                    <div class="w-100">
                      <input type="email" class="form-control bg-dark border-dark text-light email-input w-100"
