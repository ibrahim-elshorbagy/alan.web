    ...
    <div class="main-content mx-auto w-100 position-relative overflow-hidden bg-white">
      <div class="banner-section position-relative @if ($vcard->cover_type == 2) banner-yt-section @endif">
        ...
        <div class="bg-vector @if ($vcard->cover_type == 2) d-none @endif"
          ...
          <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/banner-bg-vector.png') }}" alt="vector" />
        </div>
      </div>
      {{-- Pwa support --}}
        ...
        @if (
          ...
          <div class="contact-section pt-60 px-30" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            ...
            <div class="contact-bg img-1 text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/contact-bg-1.png') }}" alt="bg-vector" />
            </div>
            <div class="contact-bg img-2 text-start">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/contact-bg-2.png') }}" alt="bg-vector" />
            </div>
            <div class="contact-bg img-3 text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/contact-bg-3.png') }}" alt="bg-vector" />
            </div>
            ...
            <div class="row">
              <div class="col-sm-6  mb-sm-0 mb-30">
                <div class="contact-img">
                  <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/contact-img.png') }}" alt="contact"
                    class="w-100" />
                </div>
              </div>
              <div class="col-sm-6">
                ...
                @if ($vcard->location)
                  <div class="contact-box d-flex flex-sm-row flex-column align-items-center gap-3">
                    <div class="contact-icon d-flex justify-content-center align-items-center">
                      <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/location.png') }}" />
                    </div>
                    <div class="contact-desc">
        ...
        @if (checkFeature('gallery') && $vcard->gallery->count())
          <div class="gallery-section pt-60 px-30">
            <div class="gallery-bg img-1" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/gallery-bg-1.png') }}" alt="bg-vector" />
            </div>
            <div class="gallery-bg img-2">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/gallery-bg-2.png') }}" alt="bg-vector" />
            </div>
            <div class="gallery-bg img-3" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/gallery-bg-3.png') }}" alt="bg-vector" />
            </div>
                  ...
                  <div class="gallery-img">
                    @if ($file->type == App\Models\Gallery::TYPE_IMAGE)
                      <a href="{{ $file->gallery_image }}" data-lightbox="gallery-images"><img
                          src="{{ $file->gallery_image }}" alt="profile" class="w-100 h-100 object-fit-cover"
                          loading="lazy" /></a>
        ...
        @if (checkFeature('services') && $vcard->services->count())
          <div class="our-services-section pt-60">
            <div class="services-bg text-end" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/services-bg.png') }}" alt="bg-vector" />
            </div>
                    ...
                    <div>
                      <div class="service-card d-flex flex-sm-row flex-column gap-2">
                        ...
                        <div class="card-body p-0">
                          ...
                          <p class="mb-0 fs-12 text-gray-200 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                  ...
                  @foreach ($vcard->services as $service)
                    <div class="service-card card d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="card-body p-0 @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') me-3 @endif">
                        ...
                        <p class="mb-0 fs-14 text-gray-300 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
                          @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                          {!! \Illuminate\Support\Str::limit($service->description, 170, '...') !!}
                        </p>
                      </div>
        ...
        @if (checkFeature('appointments') && $vcard->appointmentHours->count())
          <div class="appointment-section pt-30" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            <div class="appointment-bg img-1">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/appointment-bg-1.png') }}" alt="bg-vector" />
            </div>
            <div class="appointment-bg img-2 text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/appointment-bg-2.png') }}" alt="bg-vector" />
            </div>
            <div class="section-heading right-heading px-30" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
              ...
              <div class="position-relative">
                <div class="row">
                  <div class="col-12 mb-4">
                    ...
                    <span class="calendar-icon" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
        ...
        @if (checkFeature('products') && $vcard->products->count())
          <div class="product-section pt-60 px-30">
            <div class="product-bg img-1" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/product-bg-1.png') }}" alt="bg-vector" />
            </div>
            <div class="product-bg img-2 text-end" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/product-bg-2.png') }}" alt="bg-vector" />
            </div>
            <div class="product-bg img-3 text-end" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/product-bg-3.png') }}" alt="bg-vector" />
            </div>
            <div class="section-heading left-heading" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    ...
                    <a @if ($product->product_url) href="{{ $product->product_url }}" @endif target="_blank"
                      ...
                      <div class="product-desc card-body">
                        <div class="d-flex align-items-center justify-content-between">
                          <h3 class="text-black fs-18 fw-5 mb-1" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            {{ $product->name }}
                          </h3>
                          <p class="amount fs-6 mb-0 fw-5 text-end text-success">
                            @if ($product->currency_id && $product->price)
                              <span class="fs-18 fw-5 text-success"
                        ...
                        <div>
                          <p class="fs-14 text-black mb-0" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            {{ $product->description }}
                          </p>
                        </div>
        ...
        @if (checkFeature('testimonials') && $vcard->testimonials->count())
          <div class="testimonial-section pt-60 px-30">
            <div class="testimonial-bg img-1" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/testimonial-bg-1.png') }}" alt="bg-vector" />
            </div>
            <div class="testimonial-bg img-2 text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/testimonial-bg-2.png') }}" alt="bg-vector" />
            </div>
            <div class="testimonial-bg img-3 text-end" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/testimonial-bg-3.png') }}" alt="bg-vector" />
            </div>
            <div class="testimonial-bg img-4" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/testimonial-bg-4.png') }}" alt="bg-vector" />
            </div>
            <div class="section-heading right-heading" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                ...
                <div>
                  <div class="testimonial-card card">
                    <div class="quote-img quote-left">
                      <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/quote-left.png') }}" alt="quote" />
                    </div>
                    ...
                    <div class="card-body p-0">
                      <p class="desc text-gray-200 fs-14 mb-3 text-center {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        {!! $testimonial->description !!}
                      </p>
                      <div class="d-flex align-items-center justify-content-sm-start justify-content-center gap-3">
                        <div class="card-img testimonial-profile-img">
                          <img src="{{ $testimonial->image_url }}" class="w-100 h-100 object-fit-cover" />
                        </div>
                        <div>
                          <h3 class="text-black fs-16 fw-5 mb-0" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
        ...
        @if (checkFeature('blog') && $vcard->blogs->count())
          <div class="blog-section pt-60">
            <div class="blog-bg-vector vector-1">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/blog-bg-1.png') }}" alt="bg-vector" />
            </div>
            <div class="blog-bg-vector vector-2 text-end" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/blog-bg-2.png') }}" alt="bg-vector" />
            </div>
            <div class="blog-bg img-1">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/blog-bg1.png') }}" alt="bg"
                class="w-100" />
            </div>
            <div class="blog-bg img-2">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/blog-bg2.png') }}" alt="bg"
                class="w-100" />
            </div>
            ...
            <div class="blog-slider pb-sm-0 pb-60 px-sm-0 px-30 @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') blog-rtl @endif">
      ...
      @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
        @if ($vcard->businessHours->count())
          ...
          @endphp
          <div class="business-hour-section pt-60 px-30" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            <div class="hour-bg img-1">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/hour-bg-1.png') }}" alt="bg-vector" />
            </div>
            <div class="hour-bg img-2">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/hour-bg-2.png') }}" alt="bg-vector" />
            </div>
      ...
      @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
        <div class="contact-us-section pt-60 px-30" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
          <div class="contact-us-bg img-1">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/contact-us-bg-1.png') }}" alt="bg-vector" />
          </div>
          <div class="contact-us-bg img-2 text-end">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/contact-us-bg-2.png') }}" alt="bg-vector" />
          </div>
          <div class="contact-us-bg img-3">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/contact-us-bg-3.png') }}" alt="bg-vector" />
          </div>
          <div class="section-heading right-heading" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            ...
            <div class="contact-form">
              <form action="" id="enquiryForm" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <input type="tel" class="form-control @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') text-end @endif"
                    ...
                    <div class="col-12 mb-4 mt-2">
                      ...
                      <label class="form-check-label" for="privacyPolicyCheckbox">
                        ...
                        <a href="{{ route('vcard.show-privacy-policy', [$vcard->url_alias, $vcard->id]) }}"
                          target="_blank" class="text-decoration-none link-info fs-6">{!! __('messages.vcard.term_and_condition') !!}</a>
      ...
      @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
        <div class="create-vcard-section pt-60 px-30" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
          <div class="create-vcard-bg img-1">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/create-vcard-bg-1.png') }}" alt="bg-vector" />
          </div>
          <div class="create-vcard-bg img-2 text-end">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/create-vcard-bg-2.png') }}" alt="bg-vector" />
          </div>
          <div class="section-heading left-heading" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
      ...
      @if ($vcard->enable_contact)
        <div class="add-to-contact-section">
          <div class="text-center d-flex align-items-center justify-content-center"
            ...
            @else
              <a href="{{ route('add-contact', $vcard->id) }}" class="add-contact-btn btn btn-warning"><i
              ...
              <div class="modal-body">
                ...
                <form action="" method="post" id="newsLatterForm"
                  ...
                  <div class="mb-1 mt-4 d-flex gap-1 justify-content-center align-items-center email-input">
                    <div class="w-100">
                      <input type="email" class="form-control bg-gray-100 border-0 text-light email-input w-100"
