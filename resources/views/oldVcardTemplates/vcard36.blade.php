        ...
        <div class="main-content mx-auto w-100 position-relative overflow-hidden bg-white">
            <div class="banner-section position-relative @if ($vcard->cover_type == 2) banner-yt-section @endif">
                <div class="banner-img @if ($vcard->cover_type == 2) banner-yt-video @endif">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/banner-img.png') }}" class="w-100 h-100 object-fit-cover"
                        alt="banner" />
                </div>
                    ...
                    <div class="appointment-section pt-30" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        ...
                        <div class="appointment px-30 pt-40 pb-40">
                            ...
                            <div class="position-relative">
                                ...
                                <div class="col-12">
                                    <label class="text-white mb-2" id="hourSection" style="display: none;">{{ __('messages.hour') }}:</label>
                                    <div class="row">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between">
                                                    ...
                                                    <p class="amount fs-6 mb-0 fw-5 text-end text-success">
                                                        @if ($product->currency_id && $product->price)
                                                            <span
                                                                class="fs-18 fw-5 text-success">{{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
                                                        @elseif($product->price)
                                                            <span
                                                                class="fs-18 fw-5 text-success">{{ currencyFormat($product->price, 2, getUserCurrencyIcon($vcard->user->id)) }}</span>
                                                        @endif
                                                    </p>
                                                </div>
                                                <div>
            ...
            <div class="vcard-bg position-relative">
                <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/vcard-bg.png') }}" alt="bg" class="w-100" />
                {{-- made by --}}
