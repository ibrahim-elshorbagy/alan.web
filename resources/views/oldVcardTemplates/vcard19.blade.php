    ...
    <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
      ...
      <div class="profile-section px-40 @if ($vcard->cover_type == 2) profile-margin @endif">
        <div class="profile-bg-img">
          <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/profile-bg-img.png') }}" loading="lazy" />
        </div>
              ...
              <div class="row d-flex">
                  ...
                  <div class="col-sm-6 mb-40 d-flex">
                    <div class="contact-box w-100">
                      <div class="contact-icon d-flex justify-content-center align-items-center">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/email-icon.png') }}" alt=""
                          loading="lazy">
                      </div>
                      <div class="contact-desc">
                        <a href="mailto:{{ $vcard->email }}" class="text-primary fs-14 fw-5">{{ $vcard->email }}</a>
                      </div>
                    </div>
                  </div>
                @endif
                ...
                @if ($vcard->phone)
                  <div class="col-sm-6 mb-40 d-flex">
                    <div class="contact-box w-100">
                      <div class="contact-icon d-flex justify-content-center align-items-start">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/phone-icon.png') }}" alt="">
                      </div>
                      <div class="contact-desc">
                        <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}" class="text-primary fs-14 fw-5"
                ...
                @if ($vcard->dob)
                  <div class="col-sm-6 mb-sm-0 mb-40 d-flex">
                    <div class="contact-box w-100">
                      <div class="contact-icon d-flex justify-content-center align-items-start">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/dob-icon.png') }}" alt="">
                      </div>
                      <div class="contact-desc">
                ...
                @if ($vcard->location)
                  <div class="col-sm-6 d-flex">
                    <div class="contact-box w-100">
                      <div class="contact-icon d-flex justify-content-center align-items-start">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/vector.png') }}" alt="">
                      </div>
                      <div class="contact-desc">
      ...
      <div class="social-media d-flex justify-content-center">
        <div class="social-bg-img1">
          <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/social-bg-img1.png') }}" loading="lazy" />
        </div>
        <div class="social-bg-img2">
          <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/social-bg-img2.png') }}" loading="lazy" />
        </div>
        ...
        @if (checkFeature('gallery') && $vcard->gallery->count())
          <div class="gallery-section pt-30 px-40 pb-3">
            <div class="gallery-bg-img">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/gallery-bg-img.png') }}" loading="lazy" />
            </div>
                  ...
                  <div class="gallery-img">
                    @if ($file->type == App\Models\Gallery::TYPE_IMAGE)
                      <a href="{{ $file->gallery_image }}" data-lightbox="gallery-images"><img
                          src="{{ $file->gallery_image }}" alt="profile" class="w-100 h-100 d-block"
                          loading="lazy" /></a>
                    ...
                    @elseif($file->type == App\Models\Gallery::TYPE_AUDIO)
                      <div class="audio-container mt-2">
                        <img src="{{ asset('assets/img/music.jpeg') }}" alt="Album Cover" style="height:155px;"
                          class="audio-image">
        ...
        @if (checkFeature('products') && $vcard->products->count())
          <div class="product-section pt-40 px-40">
            <div class="product-bg-img1">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/product-bg-img1.png') }}" loading="lazy" />
            </div>
            <div class="product-bg-img2">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/product-bg-img2.png') }}" loading="lazy" />
            </div>
                    ...
                    <div class="product-card card">
                      ...
                      <div class="product-desc card-body pt-2">
                        <h3 class="text-black fs-18 fw-5" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                          {{ $product->name }}</h3>
                        <p class="fs-14 text-gray-100 mb-3" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                          {{ $product->description }}
                        </p>
                    ...
                    <div class="col-sm-6 mb-sm-0 mb-40 mt-5">
                      <div class="service-card h-100">
                        ...
                        <div class="card-body text-center p-0 pt-2">
                          <h3 class="card-title fs-18 text-black" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            {{ ucwords($service->name) }}
                          </h3>
                          <p class="mb-0 fs-14 text-gray-100 text-center  {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                ...
                <div class="row">
                  <div class="col-12 px-2">
                    <div class="position-relative">
                      ...
                      <span class="calendar-icon pe-none"><svg width="20" height="20" viewBox="0 0 20 20"
        ...
        @if (checkFeature('blog') && $vcard->blogs->count())
          <div class="blog-section pt-40 px-40 pb-3">
            <div class="blog-bg-img1">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/blog-bg-img1.png') }}" loading="lazy" />
            </div>
                ...
                <div class="">
                  <div class="blog-card card">
                    ...
                    <div class="card-body p-2">
                      <a href="{{ $vcardBlogUrl }}">
                        <h2 class="fs-20 pt-2 mb-0 text-primary text-center blog-title">{{ $blog->title }}
                        </h2>
                      </a>
                    </div>
                  </div>
        ...
        @if (checkFeature('testimonials') && $vcard->testimonials->count())
          <div class="testimonial-section pt-40 pb-3 px-40">
            <div class="testimonial-bg-img">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/testimonial-bg-img.png') }}" loading="lazy" />
            </div>
            <div class="section-heading text-center mb-40">
                ...
                <div class="">
                  <div class="testimonial-card card">
                    ...
                    <div class="card-body p-0 pt-3">
                      ...
                      <div class="text-center">
                        <p class="desc text-black mb-3 {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}"
                          @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                          {!! $testimonial->description !!}
                        </p>
                        <h3 class="text-primary fs-20 mb-0" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
      ...
      @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
        <div class="qr-code-section pt-60 px-40">
          <div class="qr-bg-img">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/qr-bg-img.png') }}" loading="lazy" />
          </div>
      ...
      <div class="contact-us-section pt-30 px-30">
        <div class="contact-bg-img">
          <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/contact-bg-img.png') }}" loading="lazy" />
        </div>
          ...
          <div class="px-sm-3 mb-3">
            <div class="vcard-link-card card">
              <div class="d-flex align-items-center justify-content-center">
                <a href="{{ route('register', ['referral-code' => $vcard->user->affiliate_code]) }}" target="_blank"
      ...
      <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
        <div class="fixed-btn-section">
          @if (empty($vcard->hide_stickybar))
            <div class="bars-btn fashion-bars-btn  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') vcard-bars-btn-left @endif">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/sticky.png') }}" loading="lazy" />
            </div>
          @endif
          <div class="sub-btn d-none">
            <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
              ...
              @endif
              @if (empty($vcard->hide_stickybar))
                <div class="{{ isset($vcard->whatsapp_share) ? 'vcard19-btn-group' : 'stickyIcon' }}">
                  <button type="button"
          ...
          <div class="row align-items-center mt-3">
            ...
            <div class="col-2">
              <button type="button" aria-label="Close"
                class="btn btn-sm btn-icon btn-active-color-danger border-none p-1" data-bs-dismiss="modal">
