        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
                ...
                <div class="banner-img cover-img">
                    ...
                    @elseif($vcard->cover_type == 1)
                        @if (strpos($vcard->cover_url, '.mp4') !== false ||
                            ...
                            <video class="cover-video {{ $coverClass }}" loop autoplay playsinline
                    ...
                    <div class="cloud-img @if($vcard->cover_type == 2) d-none @endif">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/Cloud.png') }}" class="w-100" loading="lazy" />
                    </div>
                </div>
            </div>
            <div class="profile-section pt-60 pb-60 px-30 @if($vcard->cover_type == 2) mt-5 pt-0 @endif">
                <div class="book-img text-end">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/book.png') }}" alt="book" loading="lazy" />
                </div>
                <div class="card d-flex flex-sm-row flex-column gap-3 align-items-center" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    <div class="card-img">
            ...
            @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                <div class="contact-section pb-60 px-30 mb-3">
                    <div class="abc-img">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/abc.png') }}" alt="book" loading="lazy" />
                    </div>
                        ...
                        <div class="row d-flex">
                                ...
                                <div class="col-sm-6 mb-20 d-flex">
                                    <div class="contact-box d-flex align-items-center w-100">
                                        <div class="contact-icon d-flex justify-content-center align-items-center">
                                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/email.png') }}" loading="lazy" />
                                        </div>
                            ...
                            @if ($vcard->phone)
                                <div class="col-sm-6 mb-20 d-flex">
                                    <div class="contact-box d-flex align-items-center w-100">
                                        <div class="contact-icon d-flex justify-content-center align-items-center">
                                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/phone.png') }}" loading="lazy" />
                                        </div>
                                        <div class="contact-desc">
                            ...
                            @if ($vcard->dob)
                                <div class="col-sm-6 mb-sm-0 mb-20 d-flex">
                                    <div class="contact-box d-flex align-items-center w-100">
                                        <div class="contact-icon d-flex justify-content-center align-items-center">
                                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/dob.png') }}" loading="lazy" />
                                        </div>
                                        <div class="contact-desc">
                ...
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section px-30">
                        <div class="pencil-img1">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/pencil-img1.png') }}" alt="book"
                                loading="lazy" />
                        </div>
                        <div class="triangle-img1 text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/triangle-img1.png') }}" alt="book"
                                loading="lazy" />
                        </div>
                        <div class="section-heading text-center">
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-60 px-30">
                        <div class="one-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/one.png') }}" alt="book" loading="lazy" />
                        </div>
                        <div class="red-heart-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/red-heart.png') }}" alt="book"
                                loading="lazy" />
                        </div>
                        <div class="yellow-star-img text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/yellow-star.png') }}" alt="book" />
                        </div>
                        <div class="two-img text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/two.png') }}" alt="book" loading="lazy" />
                        </div>
                        <div class="three-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/three.png') }}" alt="book" loading="lazy" />
                        </div>
                        <div class="section-heading text-center">
                ...
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-60 px-30">
                        <div class="earth-img text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/earth.png') }}" alt="earth" loading="lazy" />
                        </div>
                        <div class="star-img text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/star.png') }}" alt="star" loading="lazy" />
                        </div>
                        <div class="section-heading text-center">
            ...
            @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section pt-60 px-3">
                        <div class="bag-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/bag.png') }}" alt="bag" loading="lazy" />
                        </div>
                        <div class="brush-img text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/brush.png') }}" alt="brush" loading="lazy" />
                        </div>
                        <div class="section-heading text-center">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="product-desc card-body p-3">
                                                        <div class="d-flex flex-column">
                                                            <h3 class="text-black fs-18 fw-5 mb-1 product-name text-truncate">
                                                                {{ $product->name }}
                                                            </h3>
            ...
            @if ((isset($managesection) && $managesection['testimonials']) || empty($managesection))
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-60">
                        <div class="clip-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/clip.png') }}" alt="clip" loading="lazy" />
                        </div>
                        <div class="color-plat-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/color-plat.png') }}" alt="color-plat"
                                loading="lazy" />
                        </div>
                        <div class="pencil-color-img text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/pencil-color.png') }}" alt="pencil-color"
                                loading="lazy" />
                        </div>
                ...
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-60 px-3">
                        <div class="paper-plane-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/paper-plane.png') }}" alt="paper-plane"
                                loading="lazy" />
                        </div>
                        <div class="cloud-vector-img text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/cloud-vector.png') }}" alt="cloud-vector"
                                loading="lazy" />
                        </div>
                ...
                @if ($vcard->businessHours->count())
                    ...
                    <div class="business-hour-section pt-60 px-30">
                        ...
                        <div class="triangle-img2 text-end mt-3">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/triangle-img2.png') }}" alt="triangle"
                                loading="lazy" />
                        </div>
                        <div class="section-heading text-center">
                        ...
                        <div class="">
                            <div class="business-hours row justify-content-center row-gap-20px" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                @php
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-60 px-30">
                    ...
                    <div class="lab-img1 text-end">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/lab-img1.png') }}" alt="lab-img" loading="lazy" />
                    </div>
                    <div class="lab-img2 text-end">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/lab-img2.png') }}" alt="lab-img" loading="lazy" />
                    </div>
                    <div class="blue-heart-img text-end">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/blue-heart.png') }}" alt="blue-heart"
                            loading="lazy" />
                    </div>
                    <div class="section-heading text-center">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section px-30 pb-1 pt-3 ">
                    <div class="crystal-img">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/crystal.png') }}" alt="crystal" loading="lazy" />
                    </div>
                    <div class="apple-img">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/apple.png') }}" alt="apple" loading="lazy" />
                    </div>
                    <div class="half-round-img text-end">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/half-round.png') }}" alt="half-round"
                            loading="lazy" />
                    </div>
                    <div class="section-heading text-center">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="">
                    <div class="create-vcard-section pt-60">
                        <div class="notes-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/notes.png') }}" alt="notes" loading="lazy" />
                        </div>
                        ...
                        <div class="ball-img text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/ball.png') }}" alt="ball" loading="lazy" />
                        </div>
            ...
            @if ($vcard->enable_contact)
                <div class="bg-img">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/main-bg.png') }}" class="w-100" loading="lazy" />
                </div>
                ...
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div
                            ...
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/sticky.png') }}" loading="lazy" />
                        </div>
                    @endif
