            ...
            <div class="row d-flex">
              ...
              @if ($vcard->location)
                <div class="col-sm-6 d-flex">
                  <div class="contact-box d-flex align-items-center w-100">
                    <div class="contact-icon d-flex justify-content-center align-items-center">
                      <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/location.png') }}" loading="lazy" />
                    </div>
                    <div class="contact-desc">
                      ...
                      <div class="service-card h-100 text-start">
                        <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                          ...
                          <img src="{{ $service->service_icon }}"
                            class="card-img-top service-new-image object-fit-cover" alt="{{ $service->name }}"
                            loading="lazy">
                        </a>
                        <div class="">
              ...
              @foreach ($vcard->testimonials as $testimonial)
                <div class="">
                  <div class="testimonial-card card d-flex flex-sm-row-reverse flex-column justify-content-center"
                    ...
                    <div class="card-body p-0 pe-sm-3 text-center ms-3">
                      <div class="">
                        <div class="profile-desc mt-3">
                          <h3 class="text-black fs-18 mb-0 fw-6" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
