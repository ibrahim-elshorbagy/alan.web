...
<body>
  <div class="container p-0">
    ...
    <div
      ...
      {{-- profile section --}}
      <div
        class="profile-section px-40 pb-4 position-relative @if ($vcard->cover_type == 2) profile-margin @endif"
        ...
        <div class="card d-flex flex-sm-row gap-4 mb-4">
          <div class="card-img position-relative">
            ...
            <div class="profile-bg">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard33/headphone.png') }}" alt="bg-img" />
            </div>
          </div>
      ...
      {{-- social-media --}}
      <div class="social-media-section px-40 position-relative" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            ...
            <div class="row d-flex">
              ...
              @if ($vcard->location)
                <div class="col-sm-6 d-flex">
                  <div class="contact-box d-flex align-items-center w-100">
                    <div class="contact-icon d-flex justify-content-center align-items-center">
                      <img src="{{ asset('assets/img/oldVcardTemplate/vcard33/location.png') }}" />
                    </div>
                    <div class="contact-desc">
      ...
      @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
        <div class="gallery-section pt-60 position-relative">
          <div class="gallery-bg text-end">
            <img src="{{ asset('assets/img/oldVcardTemplate/vcard33/gallery-bg.png') }}" alt="bg-img" />
          </div>
        ...
        @if (checkFeature('products') && $vcard->products->count())
          <div class="product-section pt-60 px-4 position-relative">
            <div class="product-bg">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard33/product-bg.png') }}" alt="bg-img" />
            </div>
            <div class="section-heading mb-5 text-center text-white">
        ...
        @if (checkFeature('testimonials') && $vcard->testimonials->count())
          <div class="testimonial-section pt-60 px-40 position-relative">
            <div class="position-absolute vector-all vector-3 text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard33/vector-3.png') }}" alt="images"
                class="w-100" />
            </div>
            <div class="position-absolute vector-all vector-4">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard33/vector-4.png') }}" alt="images"
                class="w-100" />
            </div>
            <div class="section-heading mb-5 text-center text-white">
                ...
                <div>
                  <div class="testimonial-card card">
                    ...
                    <div class="card-body p-0 text-center">
                      <h3 class="text-white fs-18 mb-10" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
        ...
        @if (checkFeature('blog') && $vcard->blogs->count())
          <div class="blog-section pt-60 position-relative">
            <div class="position-absolute vector-all vector-5 text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard33/vector-5.png') }}" alt="images"
                class="w-100" />
            </div>
            <div class="section-heading mb-5 text-center text-white">
        ...
        @if ($vcard->businessHours->count())
          ...
          <div class="business-hour-section pt-60 pb-60 px-40 position-relative">
            <div class="position-absolute vector-all vector-6 text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard33/vector-6.png') }}" alt="images"
                class="w-100" />
            </div>
            <div class="section-heading mb-5 text-center text-white">
      ...
      @if ($vcard->enable_contact)
        <div class="add-to-contact-section">
          <div class="text-center d-flex align-items-center justify-content-center"
            ...
            @else
              <a href="{{ route('add-contact', $vcard->id) }}" class="add-contact-btn rounded-4 btn btn-gradient"><i
              ...
              @if (empty($vcard->hide_stickybar))
                <div class="{{ isset($vcard->whatsapp_share) ? '' : 'stickyIcon' }}">
                  <div class="vcard33-sticky-btn mb-3">
                    <button type="button" class="vcard33-btn-group vcard33-share">
                      ...
                      <svg width="23" height="25" viewBox="0 0 23 25" fill="none"
                        ...
                        <defs>
                          <linearGradient id="paint0_linear_4098_698" x1="13.9113" y1="-8.95833" x2="-3.15673"
                  ...
                  @if (!empty($vcard->enable_download_qr_code))
                    <div class="vcard33-sticky-btn">
                      <a type="button" class="vcard33-btn-group d-flex justify-content-center  align-items-center "
