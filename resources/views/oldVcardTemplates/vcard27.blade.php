      ...
      <div class="profile-section pt-sm-4">
        @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
          <div class="px-30 position-relative">
            <div class="profile-bg-img img-1">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/services-bg-img1.png') }}" alt="bg-img"
                loading="lazy" />
            </div>
            <div class="profile-bg-img img-2 text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/services-bg-img2.png') }}" alt="bg-img"
                loading="lazy" />
            </div>
            <div
              ...
              <div class="card-body p-0 text-center margin-top-34">
        ...
        <div class="profile-bg pt-80 pb-60 px-30">
          <div class="text-light text-center profile-desc">
            ...
            <div
              class="text-light text-center profile-desc @if ($vcard->cover_type == 2) profile-des-margin-top @endif">
        ...
        <div class="contact-section pt-30 pb-30 px-30">
          ...
          @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
            ...
            <div class="row align-items-center">
                  ...
                  @if ($vcard->email)
                    <div class="contact-box d-flex align-items-center mb-3">
                      <div class="contact-icon d-flex justify-content-center align-items-center">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/email.png') }}" alt="" />
                      </div>
                  ...
                  @if ($vcard->phone)
                    <div class="contact-box d-flex align-items-center mb-3">
                      <div class="contact-icon d-flex justify-content-center align-items-center bg-blue">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/phone.png') }}" alt="" />
                      </div>
                      <div class="contact-desc">
                  ...
                  @if ($vcard->dob)
                    <div class="contact-box d-flex align-items-center mb-3">
                      <div class="contact-icon d-flex justify-content-center align-items-center bg-green">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/dob.png') }}" alt="" />
                      </div>
                      <div class="contact-desc">
                  ...
                  @if ($vcard->location)
                    <div class="contact-box d-flex align-items-center">
                      <div class="contact-icon d-flex justify-content-center align-items-center bg-pink">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/location.png') }}" alt="" />
                      </div>
                      <div class="contact-desc">
              ...
              <div class="col-sm-5">
                <div class="pet-img">
                  <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/contact-img.png') }}" alt="pet"
                    class="w-100" />
                </div>
              </div>
            </div>
          ...
          @if (checkFeature('appointments') && $vcard->appointmentHours->count())
            <div class="appointment-section pt-30 pb-60 px-30">
              <div class="appointment-bg img-1">
                <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/appointment-bg-img1.png') }}" alt="bg-img"
                  loading="lazy" />
              </div>
              <div class="appointment-bg img-2 text-end">
                <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/appointment-bg-img2.png') }}" alt="bg-img"
                  loading="lazy" />
              </div>
              <div class="section-heading">
              ...
              <div class="appointment">
                ...
                <div>
                  ...
                  <div class="text-center">
                    <button type="submit" class="appointmentAdd btn btn-secondary send-msg-btn w-100 d-none">
                    ...
                    <div class="product-card card">
                      ...
                      <div class="product-desc card-body p-3">
                        <div class="d-flex justify-content-between align-items-center mb-1">
                          <h3 class="text-black fs-18 fw-5 mb-0" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            {{ $product->name }}
                          </h3>
                          <p class="amount fs-18 mb-0 fw-6 text-gradient">
                            @if ($product->currency_id && $product->price)
                              <span class="fs-18 text-secondary"
          ...
          @if (checkFeature('testimonials') && $vcard->testimonials->count())
            <div class="testimonial-section">
              <div class="testimonial-bg img-1">
                <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/testimonial-bg-img1.png') }}" alt="bg-img"
                  loading="lazy" />
              </div>
              <div class="testimonial-bg img-2 text-end">
                <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/testimonial-bg-img2.png') }}" alt="bg-img"
                  loading="lazy" />
              </div>
                    ...
                    <div class="py-1 px-sm-4">
                      <div class="testimonial-card card px-30">
                        ...
                        <div class="card-body p-0 pt-3">
                          <div class="text-center">
                            <h3 class="text-black fs-20 mb-0" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                              {{ ucwords($testimonial->name) }}</h3>
                            <div class="d-flex gap-sm-3 gap-2 justify-content-center">
                              <div class="quote-left">
                                <img src="{{ asset('assets/img/vcard27/quote-left.png') }}" alt="quote" />
                              </div>
                              ...
                              <div class="quote-right mt-auto">
                                <img src="{{ asset('assets/img/vcard27/quote-right.png') }}" alt="quote" />
                              </div>
                            </div>
                          </div>
                        </div>
          ...
          @if (checkFeature('blog') && $vcard->blogs->count())
            <div class="blog-section pt-30 pb-30 px-3 mt-5">
              <div class="blog-bg-img">
                <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/blog-bg-img.png') }}" alt="bg-img"
                  loading="lazy" />
              </div>
              <div class="section-heading px-3">
        ...
        @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
          <div class="qr-code-section pt-30 px-30">
            <div class="qr-code-bg-img text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/qr-code-bg-img.png') }}" alt="bg-img"
                loading="lazy" />
            </div>
            <div class="section-heading">
            ...
            <div
              class="qr-code d-flex flex-column gap-3 justify-content-center align-items-center flex-wrap mb-30 mx-auto"
              @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
        ...
        @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
          <div class="contact-us-section pt-60 px-30 pb-60">
            <div class="contact-us-bg-img">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/contact-us-bg.png') }}" alt="bg-img"
                loading="lazy" />
            </div>
            <div class="contact-bg-img img-1">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/contact-bg-img1.png') }}" alt="bg-img"
                loading="lazy" />
            </div>
            <div class="contact-bg-img img-2 text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/contact-bg-img2.png') }}" alt="bg-img"
                loading="lazy" />
            </div>
            <div class="section-heading">
                  ...
                  <form action="" id="enquiryForm" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      ...
                      <div class="col-12 text-center">
                        <button class="send-btn btn btn-secondary send-msg-btn contact-btn" type="submit">
        ...
        @if (!empty($userSetting['enable_affiliation']))
          <div class="create-vcard-section px-30 mb-5">
            <div class="create-vcard-bg-img text-end">
              <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/create-vcard-bg.png') }}" alt="bg-img"
                loading="lazy" />
            </div>
            <div class="section-heading">
        ...
        <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
          <div class="fixed-btn-section">
            @if (empty($userSetting['hide_stickybar']))
              <div class="bars-btn pet-shop-bars-btn @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') vcard-bars-btn-left @endif">
            ...
            <div class="row align-items-center mt-3">
              ...
              <div class="col-2 p-0">
                <button type="button" aria-label="Close"
                  class="btn btn-sm btn-icon btn-active-color-danger border-none p-3" data-bs-dismiss="modal">
              ...
              <div class="row">
                ...
                <div class="col-1 p-1">
                  <svg xmlns="http://www.w3.org/2000/svg" class="arrow" class="arrow" version="1.0"
                    height="16px" viewBox="0 0 512.000000 512.000000" preserveAspectRatio="xMidYMid meet">
                    <g transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)" fill="#000000"
                      stroke="none">
                      <path
                        d="M1277 4943 l-177 -178 1102 -1102 1103 -1103 -1103 -1103 -1102 -1102 178 -178 177 -177 1280 1280 1280 1280 -1280 1280 -1280 1280 -178 -177z" />
