                        ...
                        <div class="">
                            <div class="business-hour-card">
                                ...
                                @foreach ($businessDaysTime as $key => $dayTime)
                                    <div class="mb-3">
                                        <div class="business-hour d-flex justify-content-between align-items-center" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                            <span
